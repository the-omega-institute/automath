...
OUTPUT_NAME = "check_2501_13175_density_extended_stage4_output.json"

A_VALUE = sp.Rational(2)
B0_VALUE = sp.Rational(1)
B1_VALUE = sp.Rational(0)
# Stage-4 extension: bump to 400 to firm up Stage-3 N/log N fit.
TARGET_MAX_N = 400
MIN_PASS_N = 300
...
def main() -> int:
    ...
    if not recurrence_ok:
        ...
        if max_n >= MIN_PASS_N and points:
            ...
            output = {
                ...
                "verdict": "PASS_DENSITY_EXTENDED_N400",
            }
        else:
    ...
    return 0 if output["verdict"] == "PASS_DENSITY_EXTENDED_N400" else 1
