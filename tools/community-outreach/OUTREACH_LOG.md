...
| Israel (bytepro.ai) — single-prompt ceiling × structural invariants | Email (hello@bytepro.ai, from e1327962@u.nus.edu); source: SAIR Zulip endorsement-ask thread (2026-04-19) → escalated to direct email 2026-04-30 | sent 2026-05-13 — replied to his Set A confirmation with fixed prompt schema for `fr-001`–`fr-022`, fixed Template label set, and Set B placement for `fr-023`/`fr-024`; waiting for harness validation before running Set A baseline | Automath repo link | — | 2026-05-13 |
...
| Aradhya Goel (arXiv:2604.17847) — Sophie Germain × Fibonacci totient small-Pisano certificate | Email (aradhyag24@iitk.ac.in, from e1327962@u.nus.edu) | sent 2026-05-12 — shared finite certificate for all odd primes q>50000 with pi(q)<=200 in the computed slice having S(q)=empty; framed as not a proof of Conjecture 4.4 and asked about collaboration on extending/packaging the certificate | Automath/Omega link + offer to send research note/results.json | 8/10 | 2026-05-12 |
| Daniel Carter — finite Sidon diameter b_inf exact-rational verifier audit | Email (dc65@princeton.edu, from e1327962@u.nus.edu) | sent 2026-05-12 — private audit of the public Tao/Carter decimal tuple; framed as singleton exact-rational certificate gap, not a refutation; asked for higher-precision tuple / interval convention / post-comment verifier and offered collaboration on a reproducible certificate note | Automath/Omega link + exact obstruction summary | 9/10 | 2026-05-12 |
| Tolmetes (Tolmeton on GH, ORCID 0009-0008-1784-9883) — co-author proposal on the-omega-institute/automath#38 | GitHub issue comment | replied 2026-05-05 — Tolmetes accepted standalone short note 2026-05-04 + working title `Carry Defects as Discrete Curvature Witnesses`; we locked publication frame, deferred author-list (disclosed two collaborators on our side → three-way), confirmed §07/§08/appE out of scope, ETDS primary, propose moving drafting to email post-#38 closure | — | — | 2026-05-05 |
...
| the-omega-institute/automath #38 — Tolmetes acceptance reply: lock standalone frame + working title + scope ledger + defer authorship + §07/§08/appE clarification | GitHub issue comment | [comment](https://github.com/the-omega-institute/automath/issues/38#issuecomment-4404764733) | 2026-05-05 |
...
| Heath Sanchez (SAIR Zulip) — all forum replies handled in-thread | SAIR Zulip | thread closed in-Zulip, no follow-up needed | 2026-04-18 |
| Israel Cazares SAIR Zulip endorsement ask | SAIR Zulip → escalated to bytepro.ai email | thread closed in-Zulip; same person continued via direct email (see Active row) | 2026-04-19 |
