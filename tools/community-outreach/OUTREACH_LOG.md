...
| Israel (bytepro.ai) — single-prompt ceiling × structural invariants | Email (hello@bytepro.ai); source: SAIR Zulip endorsement-ask thread (2026-04-19) → escalated to direct email 2026-04-30 | replied 2026-05-05 — Israel accepted collab 2026-05-06 (received late); answered his 3 Qs (held-out subset labeling plan, template-attribution stability via CRT distance buckets, COLM 2026 primary venue / arXiv backup); committed to ~150–300 labeled items week 1 + read his Zenodo SAIR PDF + send Lean pointers | — | — | 2026-05-05 |
