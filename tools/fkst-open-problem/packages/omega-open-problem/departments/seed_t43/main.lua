...
function pipeline(_)
  raise("omega_proposal", {
    ...
    expected_artifact = "A claim-state JSON record plus a source-obligation ledger; no theorem claim unless every source replay obligation is closed.",
    source_refs = {
