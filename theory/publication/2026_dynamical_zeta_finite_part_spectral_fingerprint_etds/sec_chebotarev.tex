...
infrastructure. The genuinely new ingredient begins when the
determinant data are pushed to the primitive level by Adams--M\"obius
inversion.
...
\begin{remark}[On the twisted spectral-gap hypothesis]
  ...
  constants. In this sense it marks the boundary between formal
