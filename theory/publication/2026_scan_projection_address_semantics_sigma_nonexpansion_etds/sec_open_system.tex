...
This section applies the weighted boundary transfer theorem to the
principal setting of the paper: first-entry residue events of Markov
holes.  The boundary matrix becomes the killed transfer matrix, and the
finite-observation exponent becomes the escape rate.  The study of
escape rates through holes in dynamical systems originates with
