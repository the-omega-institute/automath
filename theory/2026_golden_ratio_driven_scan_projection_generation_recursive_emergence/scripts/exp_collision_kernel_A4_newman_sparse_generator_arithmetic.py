...
def _write_tex(path: Path, *, disc_K: int, r1: int, r2: int, unit_rank: int, decomp: Dict[int, List[PrimeIdealData]]) -> None:
    ...
    lines.append(rf"(2)&=\mathfrak p_2^{{{P2.e}}},\qquad {_ideal(r'\mathfrak p_2', 2, th)},\\")
    lines.append(rf"(7)&=\mathfrak p_7^{{{P7_lin.e}}}\mathfrak q_7,\qquad {_ideal(r'\mathfrak p_7', 7, P7_lin.gen_latex)},\qquad {_ideal(r'\mathfrak q_7', 7, Q7.gen_latex)},\\")
    lines.append(rf"(23)&=\mathfrak p_{{23}}^{{{P23_lin.e}}}\mathfrak a_{{23}}\mathfrak b_{{23}}\mathfrak c_{{23}},\\")
    lines.append(rf"&\qquad {_ideal(r'\mathfrak p_{23}', 23, P23_lin.gen_latex)},\qquad {_ideal(r'\mathfrak a_{23}', 23, A23.gen_latex)},\\")
    lines.append(
        rf"&\qquad {_ideal(r'\mathfrak b_{23}', 23, Q23[0].gen_latex)},\qquad {_ideal(r'\mathfrak c_{23}', 23, Q23[1].gen_latex)},\\"
    )
    lines.append(rf"(1151)&=\mathfrak p_{{1151}}^{{{P1151_lin.e}}}\mathfrak b_{{1151}}\mathfrak c_{{1151}}\mathfrak d_{{1151}},\\")
    lines.append(rf"&\qquad {_ideal(r'\mathfrak p_{1151}', 1151, P1151_lin.gen_latex)},\\")
    lines.append(
        rf"&\qquad {_ideal(r'\mathfrak b_{1151}', 1151, Q1151[0].gen_latex)},\qquad {_ideal(r'\mathfrak c_{1151}', 1151, Q1151[1].gen_latex)},\qquad {_ideal(r'\mathfrak d_{1151}', 1151, Q1151[2].gen_latex)}."
    )
