...
\end{proof}
\leanverified{paper\_ostrowski\_metallic\_two\_rule\_normalization}
...
\)，即所述估计。证毕。
\end{proof}
\leanverified{paper\_ostrowski\_metallic\_truncation\_mismatch\_limit}
...
\end{proof}
\leanverified{paper\_ostrowski\_metallic\_propagation\_tail\_variance}
