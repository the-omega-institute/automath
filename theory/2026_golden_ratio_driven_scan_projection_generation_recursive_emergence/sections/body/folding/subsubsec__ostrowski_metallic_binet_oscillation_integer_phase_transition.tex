...
\leanpartial{paper\_metallic\_sample\_penalty\_integer\_threshold\_lambertw}{the monotonicity reduction to \(\beta(N)=\log N/N\) is routine, but this round does not yet contain a certified numeric/interval proof of the audited cutoff \(\beta(189)<\beta_{\ZZ}<\beta(188)\)}
