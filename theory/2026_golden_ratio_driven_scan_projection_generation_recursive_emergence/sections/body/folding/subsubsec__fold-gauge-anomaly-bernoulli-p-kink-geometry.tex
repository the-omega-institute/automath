...
\end{enumerate}
\leanverified{gStar}
\leanverified{gStar\_half}
\leanverified{qPoly}
\leanverified{qPoly\_half\_neg}
\leanverified{qPoly\_three\_quarters\_pos}
\leanverified{hPoly}
\leanverified{hPoly\_three\_quarters\_neg}
\leanverified{hPoly\_four\_fifths\_pos}
\leanverified{paper\_fold\_gauge\_anomaly\_bernoulli\_p\_kink\_unique\_max}
\end{proposition}
\begin{proof}
