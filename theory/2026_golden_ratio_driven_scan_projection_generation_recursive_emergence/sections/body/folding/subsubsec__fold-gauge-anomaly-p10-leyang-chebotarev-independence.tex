...
\leanpartial{paper\_fold\_gauge\_anomaly\_p10\_h\_explicit\_densities}{the current repository definition \texttt{jointIrreducibleRencontresDensity} gives \((1/10)\cdot !19/19!\) at \(r=0\), not \((1/10)\cdot (1/19)\), so the final displayed equality is false in this model}
