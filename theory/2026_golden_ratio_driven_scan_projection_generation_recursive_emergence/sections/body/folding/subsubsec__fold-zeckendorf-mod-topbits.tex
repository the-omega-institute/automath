...
\end{cases}
\]
\leanverified{Omega/Folding/MaxFiberTwoStep.lean:550}{hiddenBitCount\_even\_closed}
\leanverified{Omega/Folding/MaxFiberTwoStep.lean:560}{hiddenBitCount\_odd\_closed}
\leanverified{Omega/Folding/MaxFiberTwoStep.lean:712}{complement\_hiddenBitCount}
\leanverified{Omega/Folding/MaxFiberTwoStep.lean:732}{hiddenBitCount\_lt\_pow}
\leanverified{Omega/Folding/MaxFiberTwoStep.lean:740}{hiddenBitCount\_pos}
\end{theorem}
...
\]
\leanpartial{Omega/Folding/FiberWeightCountComplement.lean:11}{weightCongruenceCount\_complement}{条件 m≥2，r≤F\_{m+1}-2；互易恒等式 f\_m(r)=a\_m(r)+a\_m(M\_m+r) 未形式化}
\leanverified{Omega/Folding/FiberWeightCountComplement.lean:42}{fiberMultiplicity\_complement}
\end{proposition}
