...
m=\Omega(2^n).
\]
\leanverified{paper_spg_boundary_cycle_audit_query_lower_bound_package}
\end{theorem}
\begin{proof}
...
证毕。
\leanpartial{paper\_spg\_boundary\_cycle\_audit\_query\_lower\_bound}{仅 span 严格子空间形式；显式非零泛函 $\eta$ 构造待后轮}
