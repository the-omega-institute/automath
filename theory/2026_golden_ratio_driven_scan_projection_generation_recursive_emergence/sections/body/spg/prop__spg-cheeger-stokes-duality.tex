...
\)。
合并两侧即得结论。证毕。
\leanverified{paper\_spg\_cheeger\_stokes\_duality\_seeds}
\leanverified{paper\_spg\_cheeger\_stokes\_duality\_package}
\leanverified{paper\_spg\_cheeger\_stokes\_duality}
\end{proof}
...
\leanverified{paper\_spg\_cube\_linfty\_primitive\_boundary\_rigidity}
\end{proof}

\begin{corollary}[一个实现极小常数的显式原始]\label{cor:spg-cube-linfty-primitive-explicit-minimizer}
\leanverified{paper\_spg\_cube\_linfty\_primitive\_explicit\_minimizer}
令
\[
\eta_\star
:=
