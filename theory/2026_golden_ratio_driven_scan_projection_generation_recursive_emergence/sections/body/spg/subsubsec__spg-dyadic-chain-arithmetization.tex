...
\leanverified{paper\_spg\_dyadic\_squareclass\_chain\_complex}
\end{proof}
...
\begin{enumerate}
  ...
  \item \textbf{（体积读出的 Lipschitz 控制）}
        ...
        \]
\end{enumerate}
\leanverified{paper\_spg\_godel\_boundary\_gcd\_lipschitz\_stability}
\end{theorem}
\begin{proof}
...
\end{proof}
\leanverified{paper\_spg\_godel\_stokes\_distance\_dimension\_stability}
...
\leanverified{paper\_spg\_dyadic\_boundary\_syndrome\_fillability}
\end{corollary}
\begin{proof}
...
\leanverified{paper\_spg\_linear\_time\_bulk\_decode\_from\_boundary}
\end{theorem}
\begin{proof}
...
\leanverified{paper\_spg\_integer\_bulk\_decode\_or\_cycle\_certificate}
\end{theorem}
\begin{proof}
...
\end{proof}
\leanverified{paper\_spg\_boundary\_godel\_moment\_readout}

\input{thm__spg-boundary-godel-finite-moment-completeness}
...
\end{proof}
\leanverified{paper\_spg\_godel\_moment\_robust\_gcd\_bound}
...
\end{enumerate}
\leanverified{paper\_spg\_dyadic\_boundary\_image\_ldpc}
\end{theorem}
\begin{proof}
\textbf{(1)}
...
\end{proof}
\leanverified{paper\_spg\_dyadic\_boundary\_image\_min\_distance}
