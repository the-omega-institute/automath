...
\leanpartial{paper\_bdry\_symmetric\_group\_sign\_twisted\_label\_d2}{the stated equivalence is false in Lean because chiTwistedBinaryLabelExists already holds for d=0 and d=1; the d=2 uniqueness-up-to-flip part is formalized}
...
\leanpartial{paper\_bdry\_orientation\_local\_system\_w1\_alternating\_reduction}{requested Lean signature quantifies over arbitrary Prop inputs with no hypotheses, so the equivalences are not derivable as stated}
