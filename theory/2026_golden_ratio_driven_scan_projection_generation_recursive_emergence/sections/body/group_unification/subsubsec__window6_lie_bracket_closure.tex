...
\leanpartial{paper\_modp\_independence\_lift}{Skipped in R1876 after three repair attempts; the intended gcd-normalized proof is mathematically sound but the Lean formalization remained blocked on coercion-heavy matrix entry normal forms.}
...
\leanverified{paper\_window6\_pullback\_bracket\_from\_operator\_envelope}
\end{proof}
