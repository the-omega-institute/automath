...
\leanverified{paper\_window6\_push\_envelope\_certificate\_upgrade}
...
\leanverified{paper\_window6\_intrinsic\_bracket\_finite\_integer\_reduction}
\begin{enumerate}
  \item \textbf{反对称约束：}
  \(
  C_{ab}^{c}+C_{ba}^{c}=0
...
\leanverified{paper\_window6\_intrinsic\_bracket\_modp\_lift\_criterion}
...
给出。组合即得。证毕。
\end{proof}
\leanverified{paper\_window6\_intrinsic\_bracket\_theoremization\_pipeline}
