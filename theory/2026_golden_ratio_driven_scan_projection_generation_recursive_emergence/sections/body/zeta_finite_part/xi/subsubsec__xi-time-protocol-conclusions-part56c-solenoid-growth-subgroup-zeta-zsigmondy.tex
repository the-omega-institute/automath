...
\begin{corollary}[单位情形的拓扑熵仅由有理尺度 \texorpdfstring{$\max\{|a|,|b|\}$}{max\{|a|,|b|\}} 决定]\label{cor:xi-localized-solenoid-unit-entropy-max-scale}\leanverified{paper\_xi\_localized\_solenoid\_unit\_entropy\_max\_scale}
