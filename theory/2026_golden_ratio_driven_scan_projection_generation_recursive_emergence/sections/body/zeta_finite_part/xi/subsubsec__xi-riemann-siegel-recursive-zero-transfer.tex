...
\leanverified{paper\_xi\_rouche\_taylor\_zero\_transfer}
...
\leanverified{paper\_xi\_riemann\_siegel\_attraction\_rate}
...
\begin{proposition}[相邻截断层的零点收缩：零点序列在 \texorpdfstring{$m$}{m} 上形成可控 Cauchy]\label{prop:xi-riemann-siegel-adjacent-level-zero-homotopy}\leanverified{paper\_xi\_riemann\_siegel\_adjacent\_level\_zero\_homotopy}
