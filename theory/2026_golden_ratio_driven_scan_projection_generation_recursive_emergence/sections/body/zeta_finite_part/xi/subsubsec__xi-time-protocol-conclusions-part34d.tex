...
\leanverified{paper\_xi\_leyang\_cardano\_numerator\_divisor\_visibility}
...
\leanverified{paper\_xi\_leyang\_norm\_one\_unit\_explicit\_3torsion}
在 \(K(H_{\mathrm{LY}})\) 中定义
\[
...
\begin{theorem}[循环三次无分歧覆盖的 Kummer 规范形]\label{thm:xi-leyang-kummer-c3-etale-normal-form}\leanverified{paper\_xi\_leyang\_kummer\_c3\_etale\_normal\_form}
在 \(K=\QQ(\sqrt{-3})\) 上考虑扩张
\[
...
\leanverified{paper\_xi\_leyang\_cardano\_chebyshev\_linearization\_z}
...
\leanverified{paper\_xi\_leyang\_chebyshev\_normal\_form\_and\_discriminant\_recovery}
定义
\[
...
\leanverified{paper\_xi\_leyang\_ty\_three\_branch\_profile}
将
\[
