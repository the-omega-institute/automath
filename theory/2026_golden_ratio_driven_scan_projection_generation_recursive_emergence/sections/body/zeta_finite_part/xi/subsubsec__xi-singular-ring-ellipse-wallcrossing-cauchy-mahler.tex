...
证毕。
\end{proof}
\input{cor__xi-ellipse-wallcrossing-unit-staircase-universality}
...
\input{conj__xi-foldbin-delta-measure-sqrt-edge-bridge}
...
\leanverified{paper\_xi\_joukowsky\_ellipse\_mahler\_green}
...
\leanverified{paper\_xi\_joukowsky\_ellipse\_defect\_nonnegativity\_interval\_limit}
