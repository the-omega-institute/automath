...
\begin{theorem}[时间边界上的 Patterson--Sullivan 共形密度维数公式]\label{thm:xi-time-part9q-patterson-sullivan-boundary-dimension}
...
\begin{theorem}[边界零点原理与 dyadic 逼近给出的零点禁逸与跟踪]\label{thm:xi-time-part9q-dyadic-boundary-zero-no-escape}
