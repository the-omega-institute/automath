...
\leanverified{paper\_xi\_logistic\_hellinger\_gram\_determinant}
...
\leanverified{paper\_xi\_logistic\_multiclass\_map\_error}
...
\leanverified{paper\_xi\_logistic\_mutual\_information\_low\_resolution}
...
\leanverified{paper\_xi\_logistic\_fisher\_information\_deficit}
仍取
\(
p(s)=\frac{1}{\kappa}\sum_{j=1}^{\kappa}\phi(s-\sigma_j)
...
\leanverified{paper\_xi\_logistic\_boundary\_mass\_error}
...
\leanverified{paper\_xi\_logistic\_depth\_design\_law}
\end{proof}
