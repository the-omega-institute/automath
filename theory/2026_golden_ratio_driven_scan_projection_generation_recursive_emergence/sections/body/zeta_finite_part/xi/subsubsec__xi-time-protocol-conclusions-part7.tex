...
\leanverified{paper\_xi\_kms\_code12\_discrete\_modular\_scale\_group}
...
\leanverified{paper\_xi\_kms\_code12\_connes\_t\_invariant}
...
\leanverified{paper\_xi\_kms\_code12\_type\_rigidity}
在定理 \ref{thm:xi-kms-code12-discrete-modular-scale-group} 的设定下，
...
\leanverified{paper\_xi\_fold\_microblock\_centralizer\_strong\_density}
...
\leanverified{paper\_xi\_constant\_bias\_inversion\_b\_eps}
...
\leanverified{paper\_xi\_foldbin\_shannon\_deficit\_constant\_closed\_form}
...
\leanverified{paper\_xi\_foldbin\_renyi\_deficit\_spectrum\_closed\_form}
...
\leanverified{paper\_xi\_foldbin\_entropy\_rate\_rigidity}
...
\leanverified{paper\_xi\_strong\_converse\_exponent\_below\_critical\_rate}
...
\leanverified{paper\_xi\_kms\_transfer\_operator\_spectral\_gap\_explicit}
...
\leanverified{paper\_xi\_finite\_truncation\_spectrum\_converges}
...
\leanverified{paper\_xi\_phi\_rigidity\_from\_kms\_entropy\_density}
...
\begin{theorem}[可见--微观二层语义的同一化：重建阈值＝模尺度缺口＝最大纤维指数]\label{thm:xi-threshold-modular-gap-maxfiber-equivalence}\leanverified{paper\_xi\_threshold\_modular\_gap\_maxfiber\_equivalence}
