...
\end{proof}
\leanverified{paper\_ramanujan\_phase\_lift\_principle}
...
\leanverified{paper\_xi\_hilbert\_polya\_cmv}
...
\leanverified{paper\_xi\_cmv\_stabilization\_infinite}
...
\input{con__xi-cmv-finite-window-freeze}
...
\begin{proposition}[Sturm--Jacobi 规范化：\texorpdfstring{$P_L$}{PL} 的自伴三对角实现]\leanverified{paper\_xi\_hilbert\_polya\_jacobi}\label{prop:xi-hilbert-polya-jacobi}
...
\leanverified{paper\_xi\_strip\_forbidden\_real}
...
\leanverified{paper\_xi\_scale\_mellin\_zero\_density\_upper}
...
\leanverified{paper\_xi\_scale\_mellin\_bessel\_kernel}
取参数 \(x_0>0\)，并定义偶权核
\[
