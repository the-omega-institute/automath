...
\leanverified{paper\_xi\_hellinger\_kernel\_rkhs\_volume}
...
\leanverified{paper\_xi\_hellinger\_gram\_first\_variation\_equilibrium}
...
\leanverified{paper\_xi\_hellinger\_energy\_functional\_strict\_convexity}
定义连续能量泛函
\[
...
\leanverified{paper\_xi\_hellinger\_gram\_inverse\_checkerboard}
...
\leanverified{paper\_xi\_hellinger\_kernel\_andreief\_loggas}
...
\begin{theorem}[碰撞常数的 Hankel 封口：簇化缩放下 \texorpdfstring{$\det G$}{det G} 的 confluent Vandermonde 因子化]\label{thm:xi-hellinger-gram-collision-hankel-constant}\leanverified{paper\_xi\_hellinger\_gram\_collision\_hankel\_constant}
...
\leanverified{paper\_xi\_hellinger\_gram\_cluster\_conditioning\_exponent}
...
\leanverified{paper\_xi\_hellinger\_toeplitz\_symbol\_poisson}
...
\leanverified{paper\_xi\_hellinger\_toeplitz\_inverse\_localization}
...
\leanverified{paper\_xi\_hellinger\_toeplitz\_bandwidth\_sharpness}
...
\leanverified{paper\_xi\_hellinger\_toeplitz\_szego\_thermo\_limit}
...
\leanverified{paper\_xi\_hellinger\_toeplitz\_heine\_szego\_cue}
