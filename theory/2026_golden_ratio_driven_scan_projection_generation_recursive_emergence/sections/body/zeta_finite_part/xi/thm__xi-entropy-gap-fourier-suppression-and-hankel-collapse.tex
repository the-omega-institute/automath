...
\end{proof}
\leanpartial{paper\_xi\_negative\_block\_spectrum\_spike\_and\_shallow\_bound}{The current \texttt{XiHankelSpikeSingularSpectrumData} API does not record nonnegativity of the tail singular values, so the squared tail bound is underdetermined.}
