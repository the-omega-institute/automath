...
\]
\leanverified{paper\_xi\_time\_part9ob\_escort\_lastbit\_bernoulli\_fdiv}
...
2\arcsin(\varphi^{-1}).
\]
\leanverified{paper\_xi\_time\_part9ob\_escort\_fisher\_total\_length}
\end{theorem}
\begin{proof}
...
\leanverified{paper\_xi\_time\_part9ob\_escort\_quantile\_phase\_diagram}
对任意 \(q\ge 0\)，令
\[
W_m^{(q)}\sim \pi_{m,q},
\]
...
\leanverified{paper\_xi\_time\_part9ob\_escort\_loginfo\_cumulants\_negative\_skew}
...
\leanverified{paper\_xi\_time\_part9ob\_escort\_surprisal\_two\_level\_quantization}
对任意 \(q\ge 0\)，令
\[
W_m^{(q)}\sim \pi_{m,q},
\qquad
