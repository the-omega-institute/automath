...
\leanpartial{paper\_xi\_binary\_jump\_semidirect\_abelianization\_coinvariants}{the requested Lean signature quantifies over bare propositions rather than proofs, so \texttt{paper\_xi\_binary\_jump\_semidirect\_abelianization\_coinvariants} is not derivable without extra hypotheses.}
