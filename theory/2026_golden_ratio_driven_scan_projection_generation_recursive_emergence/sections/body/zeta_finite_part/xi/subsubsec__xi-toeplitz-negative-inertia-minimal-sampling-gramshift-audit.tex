...
\leanverified{paper\_xi\_gram\_shift\_positive\_pencil\_node\_spectrum}
...
\leanverified{paper\_xi\_gramshift\_padic\_effective\_precision}
...
\input{para__xi-gramshift-padic-resolution-bad-primes}
...
\leanverified{paper\_xi\_toeplitz\_diskpole\_scan\_node\_antiholomorphic\_conjugacy}
取 \(\Delta>0\)。
...
\end{proposition}
\leanverified{paper\_xi\_gramshift\_charpoly\_as\_phi\_image\_of\_diskpoles}
\begin{proof}
...
\leanverified{paper\_xi\_scan\_fingerprint\_antiholomorphic\_functional\_of\_diskpoles}
...
\leanverified{paper\_xi\_node\_spectrum\_noise\_stability}
...
\leanverified{paper\_xi\_defect\_entropy\_forces\_negative\_block\_mass}
