...
\leanverified{paper\_xi\_bulk\_curvature\_mass\_quantization}
...
\leanverified{paper\_xi\_bulk\_boundary\_speed\_matching\_scale\_bracketing}
...
\leanverified{paper\_xi\_bulk\_curvature\_probability\_moments}
...
\leanverified{paper\_xi\_bulk\_curvature\_mgf\_factorization\_zeta\_tower}
...
\leanverified{paper\_xi\_gamma\_stripped\_depth\_spectrum\_imaging}
\end{proof}

\begin{corollary}[曲率上界与 Lipschitz 速度极限：bulk 尺度响应的统一封口]\label{cor:xi-bulk-curvature-max-lipschitz}
\leanverified{paper\_xi\_bulk\_curvature\_max\_lipschitz}
...
\leanverified{paper\_xi\_scale\_coherence\_collision\_vandermonde}
...
\leanverified{paper\_xi\_scale\_coherence\_kernel\_zeta\_taylor}
...
\leanverified{paper\_xi\_depth\_spectrum\_majorization\_convex\_order}
设两组深度谱对数坐标
\(
