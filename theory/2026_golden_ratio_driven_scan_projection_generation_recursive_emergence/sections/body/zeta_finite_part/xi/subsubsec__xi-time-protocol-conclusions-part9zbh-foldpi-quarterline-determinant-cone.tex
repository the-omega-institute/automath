...
\leanverified{paper\_xi\_time\_part9zbh\_foldpi\_centered\_completion\_factorization}
记
\[
L:=\log\varphi,
\qquad
...
\leanverified{paper\_xi\_time\_part9zbh\_foldpi\_stieltjes\_log\_derivative\_criterion}
RH 成立，当且仅当存在正纯点测度
\[
\nu_{\mathrm{RH}}
=
...
\leanverified{paper\_xi\_time\_part9zbh\_foldpi\_completely\_monotone\_log\_slope}
若 RH 成立，定义
\[
\Lambda_\varphi(u)
:=
...
\leanverified{paper\_xi\_time\_part9zbh\_foldpi\_positive\_trace\_class\_rh}
...
\leanverified{paper\_xi\_time\_part9zbh\_foldpi\_arithmetic\_spectral\_decoupling}
