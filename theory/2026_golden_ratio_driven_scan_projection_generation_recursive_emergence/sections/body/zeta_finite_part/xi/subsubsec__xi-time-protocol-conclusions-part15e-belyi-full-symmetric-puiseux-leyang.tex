...
\leanverified{paper\_xi\_terminal\_belyi\_full\_symmetric\_cover}
设 \(r\ge 2\) 为整数，并定义
\[
...
\leanverified{paper\_xi\_j\_sextic\_discriminant\_s6\_regular}
以上记号下成立：
\begin{enumerate}
  \item 判别式存在完全显式分解
  \[
...
\leanverified{paper\_xi\_terminal\_belyi\_adjustable\_exponent\_maximal\_galois}
...
\leanverified{paper\_xi\_leyang\_hankel\_pencil\_dominant\_zeros}
\end{theorem}
\begin{proof}
...
\leanverified{paper\_xi\_leyang\_nearest\_conjugate\_pair\_discriminant\_estimator}
...
\leanverified{paper\_xi\_leyang\_exponential\_rate\_sharpness}
...
\leanverified{paper\_xi\_leyang\_hankel\_singular\_slope\_detects\_moduli}
...
\leanverified{paper\_xi\_leyang\_reconstruction\_stability\_under\_noise}
