...
\leanverified{paper\_xi\_time\_part62d\_collision\_rh\_resultant\_template}
\end{proof}
...
\]
出现。证毕。
\leanverified{paper\_xi\_time\_part62d\_atomic\_two\_step\_witt\_rankone\_collapse}
\end{proof}
...
\]
证毕。
\leanverified{paper\_xi\_time\_part62d\_seven\_two\_step\_branch\_loops\_single\_atom\_finitepart\_shift}
\end{proof}
