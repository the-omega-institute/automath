...
\begin{theorem}[window-\texorpdfstring{$6$}{6} 的 \texorpdfstring{$0$}{0}--\texorpdfstring{$1$}{1}--\texorpdfstring{$2$}{2} moment 在 involutive algebra 中的实现]\leanverified{paper\_xi\_time\_part9z\_window6\_moment\_involutive\_algebra\_realization}\label{thm:xi-time-part9z-window6-moment-involutive-algebra-realization}
...
\leanverified{paper\_xi\_time\_part9z\_window6\_fixed\_sector\_distinct\_collision}
有精确恒等式
\[
...
\leanverified{paper\_xi\_time\_part9z\_window6\_threeatom\_renyi\_spectrum}
令
\[
p_6(w):=\frac{d_6(w)}{64}
\qquad (w\in X_6)
...
\leanverified{paper\_xi\_time\_part9z\_window6\_stieltjes\_capacity\_duality}
