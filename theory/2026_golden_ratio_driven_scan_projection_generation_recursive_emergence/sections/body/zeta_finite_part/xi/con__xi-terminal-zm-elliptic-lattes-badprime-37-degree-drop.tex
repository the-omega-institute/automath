...
\leanverified{paper\_xi\_terminal\_zm\_elliptic\_full\_order\_torsion\_mod37\_collapse}
设
\[
E:\ Y^{2}=X^{3}-X+\tfrac14,
\qquad
...
\]
\end{corollary}
\leanverified{paper\_xi\_terminal\_zm\_badprime37\_square\_root\_holographic\_compression}
\begin{proof}
