...
\leanverified{paper\_xi\_terminal\_zm\_stokes\_amplitude\_square\_cubic\_rigidity}
...
\leanverified{paper\_xi\_terminal\_zm\_stokes\_b2\_quadratic\_resolvent}
\end{corollary}
\begin{proof}
...
\end{equation}
\leanverified{paper\_xi\_terminal\_zm\_stokes\_t\_elliptic\_branch\_coordinate}
\end{theorem}
\begin{proof}[证明要点]
...
\end{proof}
\leanverified{paper\_xi\_terminal\_zm\_stokes\_hidden\_square\_rational\_inversion}
...
\end{proof}
\leanverified{paper\_xi\_terminal\_zm\_stokes\_lambda\_critical\_rational\_in\_t}

\begin{theorem}[Stokes 幅值的六次代数度与极小多项式]\label{thm:xi-terminal-zm-stokes-amplitude-degree6-minpoly}
\leanverified{paper\_xi\_terminal\_zm\_stokes\_amplitude\_degree6\_minpoly}
