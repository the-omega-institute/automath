...
\leanverified{paper\_xi\_godel\_leyang\_two\_phase\_coexistence\_window}
...
\leanverified{paper\_xi\_leyang\_logshift\_two\_spectrum}
...
\end{theorem}
\leanverified{paper\_xi\_leyang\_jordan\_logshift}
\begin{proof}
...
\leanverified{paper\_xi\_leyang\_puiseux\_zero\_scaling}
设 \(z_c\in\CC\)。
...
\leanverified{paper\_xi\_leyang\_identify\_jordan\_gap\_from\_zeros}
...
\leanverified{paper\_xi\_leyang\_crossratio\_projective\_fingerprint\_complete}
...
\begin{theorem}[由两枚有限体积零点反演度量因子与混合位移]\label{thm:xi-leyang-invert-metric-and-shift-from-two-zeros}\leanverified{paper\_xi\_leyang\_invert\_metric\_and\_shift\_from\_two\_zeros}
