...
\leanverified{paper\_xi\_basepoint\_scan\_leverage\_gap\_universal\_xminus2\_tail}
...
\leanverified{paper\_xi\_basepoint\_scan\_doptimal\_last\_step\_weight\_free}
\end{corollary}
\begin{proof}
由命题 \ref{prop:xi-basepoint-scan-gram-determinant-schur-increment}，
\(
