...
\end{proof}
\leanverified{paper\_xi\_binomial\_toeplitz\_two\_endpoint\_pole\_inversion}

\begin{theorem}[稀疏 Toeplitz 见证的尺度--深度交换律]\label{thm:xi-binomial-toeplitz-scale-depth-exchange}
\leanverified{paper\_xi\_binomial\_toeplitz\_scale\_depth\_exchange}
...
\leanverified{paper\_xi\_binomial\_toeplitz\_constant\_depth\_under\_quadratic\_redshift}
...
\leanverified{paper\_xi\_binomial\_toeplitz\_comoving\_delta\_scale\_law}
