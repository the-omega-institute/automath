...
\]
\leanverified{four\_times\_eq\_two\_times\_two}
\leanverified{pow\_four\_e\_eq\_pow\_e\_pow\_four}
\leanverified{pow\_four\_e\_eq\_pow\_sq\_sq}
\leanverified{valuation\_H\_sq\_eq\_K}
\leanverified{valuation\_K\_eq\_four\_vJ}
\leanverified{paper\_xi\_unweighted\_rigidity\_quartic\_ideal\_pordering}
\end{proposition}
\begin{proof}
