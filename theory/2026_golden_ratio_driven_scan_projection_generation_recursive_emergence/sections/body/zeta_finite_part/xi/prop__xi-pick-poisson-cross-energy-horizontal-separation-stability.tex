...
\leanverified{paper\_xi\_pick\_poisson\_cross\_energy\_horizontal\_separation\_bound}
...
\exp\!\Bigl(\kappa\delta+\frac{2\kappa(\kappa-1)\delta}{\sinh(d_{\min}-2\delta)}\Bigr).
\]
\leanverified{paper\_xi\_pick\_poisson\_energy\_stability\_away\_from\_collision}
\end{theorem}
\begin{proof}
