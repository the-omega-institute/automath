...
\leanverified{paper\_xi\_window6\_sm\_envelope\_center\_2torsion\_obstruction}
设 \(G\) 为紧连通 Lie 群，满足
\[
...
\leanverified{paper\_xi\_window6\_ps\_faithful\_canonical\_descent\_unique}
设
\[
...
\leanverified{paper\_xi\_window6\_ps\_to\_sm\_center2\_kernel}
设
\[
...
\begin{corollary}[boundary 三层 uplift 的二值外置下界]\label{cor:xi-bdry-uplift-three-layer-needs-one-bit}\leanverified{paper\_xi\_bdry\_uplift\_three\_layer\_needs\_one\_bit}
...
\leanverified{paper\_xi\_window6\_lr\_swap\_canonical\_center\_mod}
