...
\end{proof}
\leanverified{paper\_xi\_time\_part9x\_fixed\_resolution\_stokes\_godel\_strong\_completeness}
...
代入第一式即可。证毕。
\end{proof}
\leanverified{paper\_xi\_time\_part9x\_screen\_completion\_cost\_sharp\_area\_law}

\begin{theorem}[瞬态壳与周期谱的严格正交]\label{thm:xi-time-part9x-transient-shell-periodic-spectrum-orthogonality}
\leanverified{paper\_xi\_time\_part9x\_transient\_shell\_periodic\_spectrum\_orthogonality}
...
\leanverified{paper\_xi\_time\_part9x\_nonabelian\_artin\_channel\_quotient\_erasure}
...
\leanverified{paper\_xi\_time\_part9x\_abelianized\_certificate\_strict\_insufficiency}
