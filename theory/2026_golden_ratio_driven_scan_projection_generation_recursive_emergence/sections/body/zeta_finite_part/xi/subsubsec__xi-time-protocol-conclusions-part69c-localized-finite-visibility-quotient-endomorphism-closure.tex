...
\begin{corollary}[有限指数子群格与 \(S\)-自由整除格的反同构及其子群 \texorpdfstring{$\zeta$}{zeta} 函数]\label{cor:xi-time-part69c-localized-finite-index-lattice-zeta}\leanverified{paper\_xi\_time\_part69c\_localized\_finite\_index\_lattice\_zeta}
