...
\begin{theorem}[principal compression 的 \texorpdfstring{$(2n-1)$}{(2n-1)} 阶精确矩保持]\label{thm:xi-time-part9zbi-principal-compression-exact-moments}\leanverified{paper\_xi\_time\_part9zbi\_principal\_compression\_exact\_moments}
对每个 \(n\ge 1\)，定义
\[
