...
\leanverified{paper\_xi\_endpoint\_heat\_probe\_monotone\_limit\_gap}
对 \(a_N\) 有单调性与极限
...
\leanverified{paper\_xi\_endpoint\_heat\_probe\_dyadic\_exponent\_readout}
...
\leanverified{paper\_xi\_endpoint\_heat\_probe\_powerlaw\_coefficient\_extraction}
在定理 \ref{thm:xi-endpoint-heat-probe-powerlaw-leading} 的假设下，令
\[
D_N:=N^{p}(a_N-a_{2N}).
\]
...
\leanverified{paper\_xi\_endpoint\_heat\_probe\_adaptive\_extrapolation}
在定理 \ref{thm:xi-endpoint-heat-probe-powerlaw-leading} 的假设下，令
\[
...
\leanverified{paper\_xi\_endpoint\_probe\_finite\_hankel\_rank\_finite\_conjugate\_pairs}
