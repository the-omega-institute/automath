...
\leanverified{paper\_xi\_unitary\_slice\_leyang\_folded\_scan}
固定 \(L>1\)，并令 \(w:=L^{-1/2}\)。
沿用本节的完成化表示，置
\[
...
\leanverified{paper\_xi\_unitary\_slice\_prime\_phase\_lift\_to\_arithmetic\_singular\_ring}
