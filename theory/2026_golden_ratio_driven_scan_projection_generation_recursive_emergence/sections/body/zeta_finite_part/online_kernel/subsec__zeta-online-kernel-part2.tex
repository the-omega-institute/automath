...
\leanpartial{paper\_reciprocal\_spectrum\_functional\_equation}{Skipped in Lean for this round because the requested new theorem signature is a pure abstract-Prop equivalence wrapper and does not satisfy the round's concrete-signature rule for new paper theorems.}
