...
\leanpartial{paper\_pom\_resonance\_two\_cycle\_ratio}{the formal proof reduces to a nontrivial eventual denominator lower bound plus a first-order cancellation estimate for the ratio expansion; that asymptotic algebra was not completed in this round}
