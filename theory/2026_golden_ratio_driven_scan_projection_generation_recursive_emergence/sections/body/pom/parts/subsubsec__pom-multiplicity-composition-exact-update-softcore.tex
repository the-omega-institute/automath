...
\leanverified{paper\_pom\_multiplicity\_composition\_cut\_density}
...
\leanverified{paper\_pom\_multiplicity\_composition\_palm\_size\_bias}
...
\leanverified{paper\_pom\_multiplicity\_composition\_replica\_explicit\_eigs}
在命题 \ref{prop:pom-multiplicity-composition-replica-softcore-transfer} 的整数 \(q\ge 1\) 设定下，
令
\[
