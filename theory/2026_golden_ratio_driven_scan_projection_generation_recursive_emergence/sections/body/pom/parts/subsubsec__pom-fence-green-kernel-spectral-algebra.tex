...
\leanverified{paper\_pom\_kk\_sine\_product\_sum}
\end{corollary}
\begin{proof}
...
\leanverified{paper\_pom\_csc\_moments\_bernoulli}
对整数 \(r\ge 1\) 定义
\[
...
\leanverified{paper\_pom\_lk\_heat\_kernel\_bessel}
定义热迹
\(
...
的恒等式给出。证毕。
\end{proof}
\leanverified{paper\_pom\_lk\_normalized\_zeta\_odd\_projection}

\begin{corollary}[连续极限的严格匹配：ND 行列式极限与 \texorpdfstring{\(t/4\)}{t/4} 的唯一尺度]\label{cor:pom-Lk-continuum-ND-det-cosh}
\leanverified{paper\_pom\_lk\_continuum\_nd\_det\_cosh}
...
\leanverified{paper\_pom\_lk\_continuum\_nd\_det\_cosh\_locally\_uniform}
