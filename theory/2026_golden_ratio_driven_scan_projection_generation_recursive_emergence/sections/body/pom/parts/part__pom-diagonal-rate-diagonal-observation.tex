...
\input{sections/body/pom/parts/part__pom-diagonal-rate-sturm-cauchy-resolvent-sst}
...
并约去公共因子即可。证毕。
\end{proof}
\leanverified{paper\_pom\_diagonal\_rate\_diagonal\_laguerre\_determinant}
...
\end{corollary}
\leanverified{paper\_pom\_diagonal\_rate\_diagonal\_determines\_spectrum}
...
\end{proof}
\leanverified{paper\_pom\_diagonal\_rate\_euler\_diagonal\_identity}
...
\]
\leanverified{paper\_pom\_diagonal\_rate\_diagonal\_log\_feedback}
\end{proposition}
\begin{proof}
