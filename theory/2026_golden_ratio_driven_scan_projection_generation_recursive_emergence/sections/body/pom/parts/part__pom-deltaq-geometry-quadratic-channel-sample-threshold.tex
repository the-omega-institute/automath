...
\begin{enumerate}
  ...
  \]
\end{enumerate}
\leanpartial{paper\_pom\_deltaq\_quadratic\_observable\_max\_exponent}{the supplied Lean signature omits a positivity assumption on \texttt{r}, so the bound fails for negative \texttt{r}.}
\end{proposition}
\begin{proof}
...
\leanverified{paper\_pom\_deltaq\_sample\_complexity\_threshold}
