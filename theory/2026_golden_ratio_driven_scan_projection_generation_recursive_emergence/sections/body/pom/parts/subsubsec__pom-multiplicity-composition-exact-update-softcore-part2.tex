...
\end{proof}
\leanverified{paper\_pom\_replica\_softcore\_second\_exceptional\_eigenvalue\_asymptotics}

\begin{theorem}[谱隙比率的指数律与对数分离速率]\label{thm:pom-replica-softcore-gap-ratio-log-separation}
\leanverified{paper\_pom\_replica\_softcore\_gap\_ratio\_log\_separation}
令 \(\rho_q\) 与 \(\nu_q\) 如上，则
...
\leanverified{paper\_pom\_replica\_softcore\_doob\_reversible\_markov\_corr}
\end{theorem}
\begin{proof}[证明要点]
...
\leanverified{paper\_pom\_replica\_softcore\_tensor\_eigenbasis}
令
\(
...
\leanverified{paper\_pom\_replica\_softcore\_exceptional\_charpoly\_linear\_coefficient}
...
\leanverified{paper\_pom\_replica\_softcore\_second\_exceptional\_eigenvector\_localization}
