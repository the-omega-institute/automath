...
\leanpartial{paper\_pom\_microcanonical\_fold\_bayes\_success\_near\_complete\_uniform}{the requested Lean signature quantifies over arbitrary predicates \texttt{nearCompleteScale}, \texttt{strictlyPositive}, and \texttt{nearCompleteUniformApprox}, so the conclusion needs an extra concrete comparison hypothesis to be derivable.}
