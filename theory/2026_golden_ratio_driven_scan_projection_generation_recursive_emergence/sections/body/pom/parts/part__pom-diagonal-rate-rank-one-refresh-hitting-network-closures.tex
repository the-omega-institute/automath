...
\input{sections/body/pom/parts/para__pom-diagonal-rate-refresh-strong-stationary-separation}
...
\leanpartial{paper\_pom\_diagonal\_rate\_refresh\_commute\_effective\_resistance}{The current Lean signature is false when \texttt{pi} vanishes, so additional nonvanishing hypotheses are required.}
...
\leanverified{paper\_pom\_diagonal\_rate\_refresh\_laplacian\_pdet}
...
\leanverified{paper\_pom\_diagonal\_rate\_diagonal\_determines\_commute}
