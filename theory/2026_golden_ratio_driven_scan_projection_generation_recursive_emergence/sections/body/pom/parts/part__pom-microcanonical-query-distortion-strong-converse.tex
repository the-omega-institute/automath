...
\end{proof}
\leanverified{paper\_pom\_microcanonical\_query\_distortion\_strategy\_invariant\_posterior}

\begin{proposition}[查询—失真任务的充分统计]\label{prop:pom-microcanonical-query-distortion-sufficient-statistic}
\leanverified{paper\_pom\_microcanonical\_query\_distortion\_sufficient\_statistic}
...
\leanverified{paper\_pom\_microcanonical\_query\_distortion\_failure\_exponent}
...
\leanverified{paper\_pom\_microcanonical\_query\_distortion\_critical\_window\_clt}
在定理 \ref{thm:pom-microcanonical-query-distortion-strong-converse-plane} 的设定下，
...
\leanverified{paper\_pom\_diagonal\_rate\_zero\_threshold\_collision}
...
\leanverified{paper\_pom\_diagonal\_rate\_explicit\_param\_and\_derivative}
...
\leanverified{paper\_pom\_query\_distortion\_zero\_bit\_corridor}
在定理 \ref{thm:pom-microcanonical-query-distortion-strong-converse-plane} 的设定下，
...
\leanverified{paper\_pom\_query\_distortion\_zero\_bit\_threshold\_auditable}
...
\leanverified{paper\_pom\_diagonal\_rate\_frechet\_derivative\_scaling\_potential}
...
\leanverified{paper\_pom\_microcanonical\_query\_distortion\_critical\_window\_variance\_psi}
