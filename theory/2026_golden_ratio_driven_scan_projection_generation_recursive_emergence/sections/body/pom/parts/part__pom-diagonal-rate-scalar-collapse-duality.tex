...
\end{proof}
\leanverified{paper\_pom\_diagonal\_rate\_scalar\_collapse\_rate}
...
\end{proof}
\leanverified{paper\_pom\_diagonal\_rate\_two\_layer\_quartic}

\begin{proposition}[有限层情形的代数相图：奇点集合有限且具 Puiseux 展开]\label{prop:pom-diagonal-rate-finite-layer-algebraic-phase-diagram}
\leanverified{paper\_pom\_diagonal\_rate\_finite\_layer\_algebraic\_phase\_diagram}
...
\leanverified{paper\_pom\_diagonal\_rate\_scaling\_duality}
...
\leanverified{paper\_pom\_diagonal\_rate\_rate\_curve\_identifiability}
...
\leanverified{paper\_pom\_diagonal\_rate\_two\_curve\_identifiability}
...
\leanverified{paper\_pom\_diagonal\_rate\_reconstruct\_w\_from\_rate\_curve}
