...
\leanpartial{paper\_pom\_two\_axis\_separation}{the requested Lean signature quantifies over bare propositions rather than proofs, so \texttt{paper\_pom\_two\_axis\_separation} is not derivable without extra hypotheses.}
