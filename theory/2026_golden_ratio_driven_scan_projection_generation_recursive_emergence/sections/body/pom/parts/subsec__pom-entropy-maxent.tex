...
\leanpartial{paper\_pom\_kl\_defect\_identity}{the current Lean signature omits the nonnegativity/probability hypotheses used by the paper statement; with only a fixed marginal, the displayed KL-entropy identity is false in this repository state}
