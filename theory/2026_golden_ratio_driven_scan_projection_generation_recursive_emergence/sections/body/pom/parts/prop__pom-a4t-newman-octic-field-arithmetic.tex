...
\leanpartial{paper\_pom\_a4t\_newman\_linear\_response\_constant}{The current Lean signature omits the hypothesis \(\mathcal Z_4(z_\star)=0\); with \(z_\star=2\) the stated implication is false.}
