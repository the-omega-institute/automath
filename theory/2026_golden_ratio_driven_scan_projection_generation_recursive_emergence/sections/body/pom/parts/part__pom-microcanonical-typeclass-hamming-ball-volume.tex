...
\leanverified{paper\_pom\_typeclass\_hamming\_ball\_volume\_variational}
...
\leanverified{paper\_pom\_typeclass\_hamming\_ball\_unique\_maximizer\_exponential\_family}
...
\]
\leanverified{paper\_pom\_microcanonical\_partial\_inversion\_threshold}
\end{theorem}
\begin{proof}
...
\leanverified{paper\_pom\_typeclass\_diagonal\_coupling\_scalarization}
\end{theorem}
\begin{proof}
...
\leanverified{paper\_pom\_typeclass\_dual\_derivative}
\end{theorem}
\begin{proof}
将对角质量约束写为
\(
