...
\leanpartial{paper\_pom\_sufficient\_statistic\_injective\_degeneracy\_classification}{给定 Lean 签名仅保留算术前提 \(2^{d_x} \le d_m\)，而遗漏正文所用的路径分量闭式；因此 \((d_x,d_m)=(0,2)\) 与 \((1,3)\) 已成反例，需补回论文中的闭式/稳定类型假设后方可形式化}
