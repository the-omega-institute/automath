...
\begin{theorem}[\texorpdfstring{$\omega$}{omega}-层外置与有限秩线性化的双重阻断]\label{thm:conclusion-omega-support-finite-rank-double-obstruction}
...
\begin{theorem}[projective ghost 塔的全积分刚性]\label{thm:conclusion-projective-ghost-total-integral-rigidity}
