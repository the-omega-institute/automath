...
\begin{theorem}[连通 Lie 通道的有限前缀因子化与零信息率]\label{thm:conclusion-connected-lie-prefix-factorization-zero-rate}\leanverified{paper\_conclusion\_connected\_lie\_prefix\_factorization\_zero\_rate}
设
\[
