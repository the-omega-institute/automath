...
\leanpartial{paper\_conclusion\_prime\_register\_worst\_modulus\_mixing\_lower\_bound}{the current Lean signature allows pairwise-coprime composite moduli; these hypotheses do not force a register modulus at least \(\mathrm{nthPrime}(k)\)}
