...
\leanverified{paper\_conclusion\_oracle\_hotlayer\_all\_renyi\_collapse}
...
\leanverified{paper\_conclusion\_oracle\_macrospectrum\_complete\_implementation\_opaque}
固定分辨率 \(m\)，记
\[
\Omega_m=\{0,1\}^m,
\qquad
...
\end{theorem}
\leanverified{paper\_conclusion\_oracle\_complete\_spectral\_sideinfo\_nohelp}
\begin{proof}
