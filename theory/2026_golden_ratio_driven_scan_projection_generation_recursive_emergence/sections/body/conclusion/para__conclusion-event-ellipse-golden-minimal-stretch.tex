...
\leanpartial{paper\_conclusion\_event\_ellipse\_golden\_minimal\_stretch}{this round kept only the existing \(T=1\) golden-ratio core; the full event-word matrix minimization proof was not completed}
...
\leanpartial{paper\_event\_ellipse\_golden\_minimal\_stretch\_T1}{仅 T=1 代数核 + 黄金比特征多项式恒等式；一般 T 的 Perron--Frobenius 单调性留后轮}
