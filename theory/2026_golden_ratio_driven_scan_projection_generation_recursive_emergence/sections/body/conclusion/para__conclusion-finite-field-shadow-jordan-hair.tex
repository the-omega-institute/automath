...
\leanpartial{paper\_conclusion\_resonance\_z2\_unipotent\_complete\_parity}{the requested Lean signature is false in the current repository state because it quantifies over arbitrary \texttt{S\_nil} and \texttt{S\_unip} with no annihilation or periodicity hypotheses}
