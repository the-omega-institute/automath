...
\[
\gamma\longmapsto \argmax_{2\le q\le Q}\bigl((q-1)\gamma-\beta_q\bigr)
\]
完全由压缩证书
\[
...
\[
q-1\in\argmax_{t\in[1,Q-1]}\bigl(t\gamma-\Lambda(t)\bigr).
\]
则必有
\[
q\in K_Q.
...
这表明 \(q\) 在离散优化问题
\[
\argmax_{2\le p\le Q}\bigl((p-1)\gamma-\beta_p\bigr)
\]
...
\[
\argmax_{2\le r\le Q}\bigl((r-1)\gamma-\beta_r\bigr)
\]
中，\(q\) 成为最优阶的充要条件正是
\[
