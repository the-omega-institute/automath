...
\begin{corollary}[深尾查询制度的双参数对数律]\label{cor:conclusion-bayes-deep-tail-two-parameter-log-law}\leanverified{paper\_conclusion\_bayes\_deep\_tail\_two\_parameter\_log\_law}
