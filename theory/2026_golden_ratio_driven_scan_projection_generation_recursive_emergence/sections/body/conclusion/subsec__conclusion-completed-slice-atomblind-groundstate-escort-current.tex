...
\leanverified{paper\_conclusion\_realinput40\_completed\_slice\_atomblind\_finitepart\_visible}
...
\leanverified{paper\_conclusion\_zeckendorf\_euler\_lowjet\_completion\_doubleblind}
固定分辨率 \(m\)，并记
\[
F:=F_{m+2}.
\]
...
\leanverified{paper\_conclusion\_binfold\_renyi2\_uniformity\_obstruction\_from\_resonance}
