...
\end{equation}
\leanverified{paper\_conclusion\_prime\_register\_godel\_orbit\_superexp\_loglaw}
\end{theorem}
\begin{proof}
令 \(c_{n,k}:=[z^k]\,f(z)^n\)。
...
\input{thm__conclusion-onedim-max-coefficient-entropy-profile}

\begin{corollary}[双对数线性化与参数可识别性]\label{cor:conclusion-godel-orbit-identifiability}
\leanverified{paper\_conclusion\_godel\_orbit\_identifiability}
...
\input{prop__conclusion-godel-divisibility-tower}

\begin{proposition}[轨道整数的极端光滑性]\label{prop:conclusion-godel-orbit-extreme-smoothness}
\leanverified{paper\_conclusion\_godel\_orbit\_extreme\_smoothness}
