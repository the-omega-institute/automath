...
\leanverified{paper\_conclusion\_elliptic\_t5\_elimination\_discriminant\_squareclass}
设
\[
...
\leanverified{paper\_conclusion\_elliptic\_t5\_full\_chebotarev\_splitting\_table}
...
\leanverified{paper\_conclusion\_elliptic\_t5\_linear\_factor\_conditional\_density\_mod5}
...
\begin{corollary}[\texorpdfstring{$T_5$}{T5} 的分解奇偶谱唯一恢复二次分辨子域]\label{cor:conclusion-elliptic-t5-parity-spectrum-recovers-qsqrt5}\leanverified{paper\_conclusion\_elliptic\_t5\_parity\_spectrum\_recovers\_qsqrt5}
...
\leanverified{paper\_conclusion\_elliptic\_t5\_real\_root\_signature}
