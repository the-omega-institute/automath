...
\leanverified{paper\_conclusion\_fixedresolution\_first\_2sm\_sufficiency}
有限数据
\[
...
\leanverified{paper\_conclusion\_fixedresolution\_moment\_ratio\_topgap}
定义相邻矩比
\[
...
\end{proof}
\leanverified{paper\_conclusion\_fixedresolution\_principal\_hankelnull\_finite\_determinacy}

\begin{theorem}[统一 Hankel 秩界等价于有限谱字母表]\label{thm:conclusion-fixedresolution-uniform-hankel-rank-alphabet}
\leanverified{paper\_conclusion\_fixedresolution\_uniform\_hankel\_rank\_alphabet}
