...
\leanpartial{paper\_conclusion\_half\_entropy\_forbidden\_band}{the liminf comparison needed to transfer the Fibonacci subsequence limit to the exact window-normalized count sequence is still unfinished}
