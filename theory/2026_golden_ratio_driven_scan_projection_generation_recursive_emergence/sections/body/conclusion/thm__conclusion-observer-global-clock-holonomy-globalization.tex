...
[\omega(\mathfrak U,\tau)]\neq 0
\)
矛盾。定理 \ref{thm:prefix-site-cech-null-gerbe} 在此只起补充说明作用：同一非平凡 Čech-\(H^2\) 障碍还可被提升为 gerbe 的非中性化证书，但把这一 stack-层失败读回原始对象层中的“无全局时钟”所真正使用的仍是命题 \ref{prop:null-as-h2-obstruction}。证毕。
\end{proof}
...
\leanverified{paper\_conclusion\_time\_dilation\_comparison\_channel\_only}
...
\end{proposition}
\leanverified{paper\_conclusion\_global\_terminal\_state\_forces\_global\_primitive\_spectrum}
\begin{proof}
