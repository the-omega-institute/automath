...
\leanverified{paper\_conclusion\_schur\_signature\_parseval\_simplex}
...
\leanverified{paper\_conclusion\_pressure\_fan\_collapses\_to\_character\_simplex\_cells}
...
\leanverified{paper\_conclusion\_pure\_phase\_nearest\_vertex\_exponential\_decodability}
若 \(R_{\max}(p)=\{\nu^\ast\}\)，并记
\[
\Delta_q:=\min_{\mu\neq \nu}|v_\mu-v_\nu|_2>0,
\]
...
\end{proof}
\leanverified{paper\_conclusion\_hook\_channel\_generating\_polynomial\_factorization}

\begin{theorem}[纯相极限中非平凡 hook 通道的无损恢复性]\label{thm:conclusion-pure-phase-hook-family-complete-recovery}
\leanverified{paper\_conclusion\_pure\_phase\_hook\_family\_complete\_recovery}
定义 hook 归一化签名
\[
h_{m,q}(k):=
\frac{T_{q,(q-k,1^k)}(m)}
