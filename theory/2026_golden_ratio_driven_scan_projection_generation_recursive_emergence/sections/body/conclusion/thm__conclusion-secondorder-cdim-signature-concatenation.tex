...
\leanverified{gamma\_subadditive}
\leanverified{gamma\_add\_comm}
\leanverified{kink\_sum}
\leanverified{kink\_sum\_small}
\leanverified{b\_comp\_bound}
\leanverified{subadditive\_of\_pointwise}
\leanverified{paper\_conclusion\_second\_order\_cdim\_signature}
\end{theorem}
\begin{proof}
