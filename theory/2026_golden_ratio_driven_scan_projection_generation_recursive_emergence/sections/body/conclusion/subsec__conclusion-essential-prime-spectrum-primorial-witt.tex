...
\leanverified{paper\_conclusion\_lee\_yang\_essential\_odd\_primes}
...
\leanverified{paper\_conclusion\_primorial\_axis\_dimension\_law}
设
\[
p_k^\#:=\prod_{i=1}^{k}p_i
\]
...
\leanverified{paper\_conclusion\_primorial\_axis\_second\_order}
...
\leanverified{paper\_conclusion\_prime\_budget\_axis\_lambert}
设
\[
...
\leanverified{paper\_conclusion\_godel\_logarithmic\_dimension\_tax}
设 prime-register
\[
...
\end{enumerate}
\leanverified{paper\_conclusion\_bigwitt\_godel\_multiplicative}
\end{proposition}
\begin{proof}
对有理数的唯一素因子分解给出
\[
...
\input{sections/body/conclusion/thm__conclusion-bigwitt-budget-fv-undecidable-split.tex}
