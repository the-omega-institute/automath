...
\leanverified{paper\_conclusion\_chi2\_recovers\_full\_power\_divergence\_family}
取 \(\alpha=2\)。则
\[
\boxed{\;
D_{f_2}^\infty
...
\leanverified{paper\_conclusion\_binfold\_anomaly\_ledger\_vs\_nearlossless\_budget\_exponential\_separation}
对每个分辨率 \(m\)，定义
\[
