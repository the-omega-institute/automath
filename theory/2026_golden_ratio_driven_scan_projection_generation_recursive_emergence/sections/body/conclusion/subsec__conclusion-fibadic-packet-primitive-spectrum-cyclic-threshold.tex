...
\leanverified{paper\_conclusion\_fibadic\_observable\_conductor\_depth\_transfer}
...
\leanverified{paper\_conclusion\_fibadic\_depth\_packet\_onepoint\_jet\_certificate}
对每个 \(d>1\)，成立
\[
\Pi_d(1)>1
\iff
...
的直接重述。证毕。
\end{proof}
\leanverified{paper\_conclusion\_fibadic\_cyclic\_receiver\_thin\_exceptional\_sector}
