...
\begin{corollary}[faithful boundary-aware 解码器必须接入 genuinely non-\texorpdfstring{$F_8$}{F8} 的 \texorpdfstring{$2$}{2}-primary 通道]\label{cor:conclusion-window6-boundary-f8-rational-observable-decoder-fails}\leanverified{paper\_conclusion\_window6\_boundary\_f8\_rational\_observable\_decoder\_fails}
