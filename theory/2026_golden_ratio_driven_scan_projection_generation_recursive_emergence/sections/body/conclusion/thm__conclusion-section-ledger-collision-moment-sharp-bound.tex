...
\leanpartial{paper\_conclusion\_section\_ledger\_collision\_moment\_q2\_explicit}{Lean 目标签名缺少论文所需的范围条件 \(c\in[1/n,1]\)；仓库中已存在带该条件的有效形式化 \texttt{collisionMoment\_q2\_explicit}。}
