...
\input{thm__conclusion-algebraic-ldp-affine-covering-dfinite}
...
\end{proof}
\leanverified{paper\_conclusion\_multiscale\_stokes\_energy\_l2\_reconstruction}
...
\leanverified{paper\_conclusion\_nonabelian\_dyadic\_stokes\_certificate}
...
\leanverified{paper\_conclusion\_nonabelian\_stokes\_bianchi\_cube\_certificate}
设 \(G\subset \mathrm{GL}_N(\mathbb C)\) 为矩阵李群，\(\mathfrak g\) 为其李代数，\(\|\cdot\|\) 为算子范数。
令
\[
...
\leanverified{paper\_conclusion\_nonabelian\_bianchi\_dyadic\_audit\_threshold}
...
\leanverified{paper\_conclusion\_uniform\_grid\_quantized\_stokes\_poincare\_scale}
...
\leanverified{paper\_conclusion\_onequarter\_cross\_category\_rigidity}
常数
\[
\frac14
\]
...
\leanverified{paper\_conclusion\_leyang\_jensen\_stokes\_variational}
...
\leanverified{paper\_conclusion\_stokes\_random\_sampling\_certificate}
