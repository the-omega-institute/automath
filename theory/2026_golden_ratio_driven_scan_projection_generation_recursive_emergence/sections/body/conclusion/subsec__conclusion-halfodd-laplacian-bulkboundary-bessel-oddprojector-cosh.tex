...
\leanverified{paper\_conclusion\_lk\_bulk\_boundary\_quadratic\_tilt}
当 \(k\to\infty\) 时，
\[
\nu_k\Rightarrow \nu_\infty,
\qquad
...
\leanverified{paper\_conclusion\_lk\_hard\_edge\_lift}
...
\leanverified{paper\_conclusion\_lk\_fixed\_index\_hard\_edge}
对每个固定 \(p\ge 1\)，成立
\[
...
-2F'(t)-\frac12F''(t).
\]
\leanverified{paper\_conclusion\_lk\_boundary\_heat\_as\_bulk\_differential}
\end{corollary}
...
\leanverified{paper\_conclusion\_lk\_normalized\_zeta\_odd\_projector}
\end{theorem}
...
\leanverified{paper\_conclusion\_lk\_normalized\_zeta\_residue\_quarter}
函数
\[
...
\leanverified{paper\_conclusion\_lk\_nd\_determinant\_zero\_tracking}
定义
\[
...
\leanverified{paper\_conclusion\_lk\_first\_zero\_monotone\_approach}
定义
\[
...
\binom{2r}{r}.
\]
\leanverified{paper\_conclusion\_lk\_normalized\_trace\_moments\_central\_binomial}
\end{corollary}
...
\leanverified{paper\_conclusion\_halfodd\_mixed\_boundary\_spectrum\_fourfold\_rigidity}
设
\[
