...
\leanverified{paper\_conclusion\_halting\_alpha\_algebraic\_form}
...
\leanverified{paper\_conclusion\_halting\_dimension\_binary\_law}
沿用上述记号。
则
\[
\dim_H(K_{D_{M,x}})=
...
\leanverified{paper\_conclusion\_halting\_measure\_atomic\_branch}
沿用上述记号。
...
\leanverified{paper\_conclusion\_halting\_walsh\_breakpoint}
\end{theorem}
...
\leanverified{paper\_conclusion\_halting\_langlands\_parameter\_degeneration\_barrier}
...
\leanverified{paper\_conclusion\_halting\_ledger\_defect\_kink}
