...
\leanverified{paper\_conclusion\_foldbin\_s3\_vs\_s2\_threehalves\_exponential\_dilution}
设 \(r_2\) 与 \(r_3\) 分别为多项式
\[
x^3-2x^2-2x+2,
\qquad
...
|K_m|\to\infty.
\]
\leanverified{paper\_conclusion\_foldbin\_sufficient\_spectral\_certificate\_must\_widen}
\end{corollary}
