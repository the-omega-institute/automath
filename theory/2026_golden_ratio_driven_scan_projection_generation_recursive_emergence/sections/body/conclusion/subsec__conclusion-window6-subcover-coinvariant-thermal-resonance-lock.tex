...
\leanverified{paper\_conclusion\_window6\_hidden\_coinvariant\_gorenstein\_package}
...
\input{thm__conclusion-window6-sixframe-center-coinvariant-thermal-lock}

\input{thm__conclusion-window6-minshell-cubical-affine-stratification}
