...
\leanverified{paper\_conclusion\_mellin\_dirichlet\_master\_kernel\_two\_layer\_rigidity}
...
\leanverified{paper\_conclusion\_arithmetic\_sharp\_threshold\_vs\_continuous\_minimality\_split}
固定分辨率 \(m\)，记
\[
...
\leanverified{paper\_conclusion\_oddwindow\_full\_inversion\_evenwindow\_rankone\_parity\_blindmode}
记
\[
M:=F_{m+2},
\qquad
...
\leanverified{paper\_conclusion\_zero\_sparsity\_nonuniformity\_localbias\_faithfulness}
设
\[
...
\leanverified{paper\_conclusion\_freezing\_dual\_bitrate\_phase\_transition}
\end{proof}
