...
\leanverified{paper\_conclusion\_smith\_loss\_profile\_young\_duality}
...
\leanverified{paper\_conclusion\_smith\_kernel\_dirichlet\_euler\_rational\_local\_factors}
...
\leanverified{paper\_conclusion\_smith\_local\_zeta\_complete\_invariant}
...
\leanverified{paper\_conclusion\_smith\_normalized\_kernel\_dirichlet\_torsion\_equivalence}
...
\leanverified{paper\_conclusion\_smith\_kernel\_zeta\_free\_pole\_finite\_euler\_deformation}
...
\input{thm__conclusion-smith-normalized-kernel-average-order}

\begin{theorem}[Smith 亏损轮廓族的完全分类]\label{thm:conclusion-smith-loss-profile-family-classification}
\leanverified{paper\_conclusion\_smith\_loss\_profile\_family\_classification}
固定整数 \(m\le n\)。对一族函数
\[
f_p:\NN_{\ge 0}\to \NN
\qquad (p\in\mathbb P),
...
\input{thm__conclusion-smith-ramanujan-shadow-localzeta-cutoff}
