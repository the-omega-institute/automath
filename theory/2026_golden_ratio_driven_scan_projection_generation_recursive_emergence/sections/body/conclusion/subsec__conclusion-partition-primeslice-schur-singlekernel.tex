...
故 \(\eta\) 已由原子像完全决定。证毕。
\end{proof}
\leanpartial{paper\_conclusion\_partition\_primeslice\_minimal\_uniqueness}{The current Lean signature cannot determine diagonal labels because the partition support omits diagonal edges.}

\input{sections/body/conclusion/cor__conclusion-partition-primeslice-divisibility-valuation-paircount.tex}
...
\input{sections/body/conclusion/cor__conclusion-partition-squarefree-zero-temp-gibbs-collapse.tex}
...
\input{thm__conclusion-schur-gap-nonhook-resonance-rigidity}
