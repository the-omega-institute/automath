...
\]
\leanverified{wdim}
\leanverified{wdim\_zero\_zero}
\leanverified{wdim\_u\_linear}
\leanverified{wdim\_amalgamated}
\leanverified{wdim\_amalgamated\_trivial}
\leanverified{paper\_cdim\_orthogonal\_amalgamated\_wdim}
\end{theorem}
\begin{proof}
由正交假设，存在分解
\[
