...
\leanverified{paper\_cdim\_comoving\_horizon\_scan\_fourier\_inversion}
在上述设定下：
\begin{enumerate}
...
\leanverified{paper\_cdim\_comoving\_horizon\_scan\_first\_layer\_extraction}
...
\leanverified{paper\_cdim\_defect\_measure\_fourier\_laplace\_holographic}
\end{proposition}
\begin{proof}
...
\leanverified{paper\_cdim\_defect\_measure\_recursive\_layer\_peeling}
...
\leanverified{paper\_cdim\_atomic\_defect\_hankel\_prony}
\end{proof}
...
\leanverified{paper\_cdim\_atomic\_defect\_two\_frequency\_4kappa\_recovery}
...
\leanverified{paper\_cdim\_basepoint\_scan\_finite\_rank\_rkhs}
定义核
\[
