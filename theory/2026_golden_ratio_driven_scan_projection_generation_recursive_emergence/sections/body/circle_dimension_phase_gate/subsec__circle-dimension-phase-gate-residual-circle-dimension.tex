...
\end{definition}
\input{def__circle-dimension-phase-gate-gap-ledger}

\begin{proposition}[单调性与乘积次可加]\label{prop:cdim-residual-circle-dimension-laws}
\leanverified{paper\_cdim\_residual\_circle\_dimension\_laws}
...
\leanverified{paper\_cdim\_phase\_residual\_budget\_lower\_bound}
\end{theorem}
\begin{proof}
...
\end{proof}
\input{cor__circle-dimension-phase-gate-bare-circle-not-complete}
...
\)。
整理即得结论。证毕。
\leanverified{paper\_cdim\_residual\_entropy\_lower\_bound}
\end{proof}
...
\]
\leanverified{paper\_cdim\_residual\_quotient\_probe}
