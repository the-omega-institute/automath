...
\leanverified{paper\_foldbin\_groupoid\_aut0\_pi1\_torsion\_exponent}
令
\[
...
\leanverified{paper\_foldbin\_groupoid\_aut0\_cyclic\_injection\_criterion}
取整数 \(n\ge 1\)。
...
\leanverified{paper\_foldbin6\_no\_u1\_in\_aut0\_groupoid\_algebra}
\end{corollary}
\begin{proof}
...
\end{proof}
\leanverified{paper\_foldbin6\_boundary\_clifford\_subalgebra}
