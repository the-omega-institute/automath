...
\leanpartial{paper\_fold\_hypercube\_h1\_prime\_budget\_minimal}{Current Lean signature assumes only an arbitrary injective set map between infinite lattices, so the lower bound is false without extra linear structure.}
