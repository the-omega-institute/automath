...
\leanpartial{paper\_op\_algebra\_common\_unitary\_dilation\_criterion}{the requested new-file Lean signature takes a \texttt{HzomCommonUnitaryDilationData} shell parameter, which violates this round's explicit anti-shell rule for new declarations}
