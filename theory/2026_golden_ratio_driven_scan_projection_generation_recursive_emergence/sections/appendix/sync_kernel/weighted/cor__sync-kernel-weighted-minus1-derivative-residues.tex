...
\leanpartial{paper\_witt\_minus1\_padic\_derivative\_residues}{the current Lean signature lacks the base divisibility seed at \(k=r+1\); the stated recurrence alone does not imply \(p^{k-r}\mid f(k)\)}
