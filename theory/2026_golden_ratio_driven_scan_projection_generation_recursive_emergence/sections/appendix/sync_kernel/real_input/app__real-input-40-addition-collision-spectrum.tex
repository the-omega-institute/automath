...
\leanverified{paper\_addition\_collision\_real\_hoelder\_lb}
...
\]
\leanverified{paper\_addition\_collision\_spectrum\_sync10\_vs\_real40}
\end{proposition}
...
\end{theorem}
\leanverified{paper\_addition\_collision\_real\_input40\_q2\_minpoly}
...
\leanverified{paper\_addition\_collision\_sync10\_q2\_minpoly}
...
\end{proof}
\leanverified{paper\_addition\_collision\_q2\_full\_symmetric\_galois}

\begin{corollary}[不可根式化与二阶投影熵率的超越性]\label{cor:addition-collision-q2-nonradical-transcendental}
\leanverified{paper\_addition\_collision\_q2\_nonradical\_transcendental}
