...
\leanverified{paper\_gm\_trace3\_truncated\_moment\_rank2}
...
\leanverified{paper\_gm\_trace3\_gap\_optimal\_spectralization}
...
\leanverified{paper\_gm\_trace3\_delta3\_stability}
...
\leanverified{paper\_gm\_trace3\_near\_extremal\_clustering}
...
\leanverified{paper\_gm\_affine\_average\_rank1\_residual}
...
\leanverified{paper\_gm\_trace3\_poisson\_collision\_energy}
...
\leanverified{paper\_gm\_zeck\_sofic\_additive\_energy}
...
\leanverified{paper\_gm\_energy\_rate\_tunable}
...
\leanverified{paper\_gm\_sofic\_zeck\_linear\_constraints\_pf}
...
\end{enumerate}
\end{corollary}
\leanverified{paper\_gm\_linear\_constraints\_special\_cases}

\begin{theorem}[非平凡有理仿射自同态的指数谱隙：结构化集合的近闭包不可能性]\label{thm:gm-affine-selfmap-spectral-gap}
\leanverified{paper\_gm\_affine\_selfmap\_spectral\_gap}
...
\leanverified{paper\_gm\_multi\_affine\_closure\_decay}
...
\leanverified{paper\_gm\_energy\_sumset\_exponent}
...
\leanverified{paper\_gm\_twisted\_perron\_fourier\_decay}
...
\leanverified{paper\_gm\_pw\_bandlimited\_sampling\_toeplitz}
...
\leanverified{paper\_gm\_affine\_gap\_improves\_trace3}
...
\leanverified{paper\_gm\_energy\_affine\_complementarity}
...
\leanverified{paper\_gm\_dual\_spectral\_certificates}
