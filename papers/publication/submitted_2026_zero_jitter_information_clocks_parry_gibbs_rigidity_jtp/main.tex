...
\leanverified{paper_zero_jitter_exact_clock}
\end{theorem}
...
\leanverified{paper_zero_jitter_finite_time_law}
Let
\[
D_n:=\tau_n-n\log\phi.
\]
...
\leanverified{paper_zero_jitter_normal_form}
...
\leanverified{paper_zero_jitter_markov_zero_variance}
...
\leanverified{paper_zero_jitter_parry_rigidity}
...
\leanverified{paper_zero_jitter_tilted_free_energy}
...
\leanverified{paper_zero_jitter_tilt_dynamics}
...
\leanverified{paper_zero_jitter_free_energy_composition}
...
\leanverified{paper_zero_jitter_variance_transfer}
...
\leanverified{paper_zero_jitter_tilted_ldp}
Let
\[
...
\leanverified{paper_zero_jitter_general_normal_form}
...
\leanverified{paper_zero_jitter_general_rigidity}
...
\leanverified{paper_zero_jitter_gibbs}
...
\leanverified{paper_zero_jitter_second_order}
Let
\[
\Delta h(p):=\log\phi-h(p).
\]
...
\leanverified{paper_zero_jitter_universal_quadratic_coefficient}
