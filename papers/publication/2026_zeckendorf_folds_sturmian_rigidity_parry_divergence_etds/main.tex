...
$$
uniformly in $q$. For arbitrary slopes we determine the logarithmic correction
at every R\'enyi order in terms of the irrationality exponent, revealing a
phase transition at order one. We further show that this finite-\(m\) formula
calibrates
...
\input{sec5a_diophantine_spectrum}
