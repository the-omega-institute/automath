...
\input{sec2_fold_language}
\input{sec3_sturmian_rigidity}
\input{sec4_parry_divergence}
\input{sec5_injective_placement}
\input{sec5b_primitive_sft}
\input{sec6_conjugacy}
\input{sec7_concluding}

\appendix
\input{appA_discrepancy}
\input{appB_fiber}
\input{appC_normalization}
