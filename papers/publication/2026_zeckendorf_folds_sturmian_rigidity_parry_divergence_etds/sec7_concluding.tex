...
The bounded-type hypothesis is not merely a source of uniform constants.
Theorem~\ref{thm:diophantine-renyi-spectrum} identifies the exact logarithmic
correction for every irrational slope and every R\'enyi order. Its coefficient
is governed by the irrationality exponent and changes regime at order one. In
particular, irrationality exponent two is sufficient for the full logarithmic
coefficient at all orders, while Liouville slopes exhibit a discontinuity
between support entropy and every positive R\'enyi order.
