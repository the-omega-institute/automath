...
def dispatch_direct(task_name: str, prompt_text: str, pdf_path: Path | None = None,
                    model: str = "chatgpt-5.4-pro-extended") -> str:
...
def main():
    ...
    parser.add_argument("--model", type=str, default="chatgpt-5.4-pro-extended",
                        help="ChatGPT model (default: chatgpt-5.4-pro-extended)")
