...
We have isolated the sharp coefficient-supremum constant for the radial
homotopy on coordinate-monomial differential forms over boxes. The sharp
case is governed by the anisotropic perimeter calibration, which also yields
the boundary deficit identity, trace rigidity, and the corresponding stability
estimate. The same structure identifies the minimizer kernel, gives the sliced
active-coordinate consequence with inactive face components left invisible,
and has a one-cell cubical counterpart through Whitney integration and the
cubical coboundary.
