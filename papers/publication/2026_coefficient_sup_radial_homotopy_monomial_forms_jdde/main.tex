...
% JDDE/Springer accepts LaTeX source files and recommends the Springer Nature
% template. This initial-submission source keeps the generic article class with
% standard AMS theorem styles, numeric references, MSC/keywords, and required
% statements/declarations; conversion to the Springer Nature template is reserved
% for a journal request or final production formatting.
