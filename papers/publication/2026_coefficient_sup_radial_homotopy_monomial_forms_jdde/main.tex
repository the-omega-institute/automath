...
See \cite[Proposition~2.6]{MaZhangCubicalStokes2026}.
\end{proposition}
...
See \cite[Lemma~4.1]{MaZhangCubicalStokes2026}.
\end{lemma}
...
See \cite[Proposition~5.1]{MaZhangCubicalStokes2026}.
\end{proposition}
...
\begin{remark}
Proposition~\ref{prop:cubical-whitney}, cited from
\cite{MaZhangCubicalStokes2026}, gives the Whitney formula and the norm-one
bounds. The increment here is the support characterization used below: the
sharp continuous estimate applies to $W\theta$ precisely when the nonzero
$k$-cell coefficients of $\theta$ are parallel to one coordinate $k$-plane.
\end{remark}
