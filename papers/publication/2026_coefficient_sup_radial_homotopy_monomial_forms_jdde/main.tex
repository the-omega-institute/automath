...
finite-dimensional one-cell cubical analogue has the same linear stability:
sharp cell-norm saturation for a primitive of the top cochain fixes all oriented
boundary-face values.  The midpoint radial homotopy estimate for
