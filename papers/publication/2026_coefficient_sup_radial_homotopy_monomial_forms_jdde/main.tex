...
$k$-forms. The additional point used in this paper is that no linearity
hypothesis is needed: if
...
\begin{proof}
The cited theorem proves \eqref{eq:radial-homotopy-identity},
\eqref{eq:sharp-homotopy-bound}, and sharpness for linear right inverses. It
remains only to remove the linearity assumption in the lower bound. Take
\[
\omega_0:=\dd x_1\wedge\cdots\wedge\dd x_k.
\]
