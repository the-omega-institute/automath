...
We have isolated a rectangular-box primitive equality and stability theorem
for coordinate-monomial differential forms, with sharp coefficient-$L^\infty$
constant. The sharp case is governed by the anisotropic perimeter calibration,
which yields the boundary deficit identity, boundary trace rigidity, and the
corresponding trace-stability estimate. The same structure identifies the
minimizer kernel, gives the sliced active-coordinate consequence with inactive
face components left invisible, and has a one-cell cubical counterpart through
Whitney integration and the cubical coboundary.
