...
results in this section are one-cell statements. Extending them to a multi-cell
...
\]
where both sides are $(r+1)$-cochains. Also,
\[
\Int W\theta=\theta
\qquad
(\theta\in C^k(I^n;\RR)).
...
\]
Applying $\Int$ and using $\Int W=\mathrm{id}$ proves the
decomposition.
...
sharp lower bound $1/(2(k+1))$ from Theorem~\ref{thm:cubical-boundary-readout},
a contradiction. Therefore the constant is sharp.
\end{proof}
