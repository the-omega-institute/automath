...
boundary readout theorem, the resulting local interface-stability certificate,
and the sliced extension to higher-dimensional boxes. Section~5 gives the
one-cube Whitney counterpart and records the
