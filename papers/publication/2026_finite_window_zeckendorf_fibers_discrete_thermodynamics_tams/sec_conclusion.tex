...
The derivative jump leaves open the large-deviation lower bound for slopes in
the interval between the two one-sided derivatives; the G\"artner--Ellis
theorem alone does not settle this coexistence regime.  No transducer-based
collision kernel, algebraicity statement for \(\lambda_q\), arithmetic-window
