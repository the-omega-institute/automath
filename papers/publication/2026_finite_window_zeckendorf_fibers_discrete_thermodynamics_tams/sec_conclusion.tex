...
\(\beta_*=2.2705594539\ldots\).  On the intervening strip, the weighted
free-generator renewal equation proves existence and strict positivity of the
pressure.  Consequently
\[
 \{t:P(t)\text{ exists and }P(t)=0\}=(-\infty,-\sigma_0].
\]

Existence of \(P(t)\) for general noninteger \(t>-\beta_*\), and its
differentiability and analytic strict convexity on the positive-pressure
phase, remain open.  The full real-tilt large deviation principle is therefore
