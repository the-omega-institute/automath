...
| 目录 | 目标期刊 | 状态 | 改投记录 |
|------|---------|------|---------|
| `submitted_2026_finite_window_rigidity_fibonacci_numeration_fq` | Fibonacci Q. | 拒稿 04-20, 转投 FQ | ETDS→JNT→FQ |
| `submitted_2026_folded_histograms_sampling_certificates_parry_mismatch_siads` | SIADS | 已投 04-07 | — |
...
| `submitted_2026_upper_fibers_witness_covers_fibonacci_apparition_rj` | Ramanujan J. | 拒稿 04-20, 转投 RJ | RNT→RJ |
| `submitted_2026_sharp_three_window_threshold_fibonacci_conjugacy_nonlinearity` | Nonlinearity | 已投 04-07 | — |
| `submitted_2026_tilt_dynamics_cylinder_information_parry_measure_qtds` | QTDS | 已投 04-07 | — |
| `submitted_2026_quartic_cover_37a1_regular_s4_closure_jnt` | JNT | 已投 04-07 | — |
| `submitted_2026_shell_geometry_detector_thermality_kms_grg` | GRG | 已投 04-07 | — |
| `2026_finite_window_zeckendorf_fibers_discrete_thermodynamics_tams` | Trans. AMS | P7 可投 | — |
| `2026_finite_observation_escape_rates_cyclotomic_resonances_etds` | ETDS | P7 待投 | — |
