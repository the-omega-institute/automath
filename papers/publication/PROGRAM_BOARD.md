...
| `2026_sharp_three_window_threshold_fibonacci_conjugacy_dcds` | DCDS-A | C-DONE (Oracle+Claude: pass, 6 rounds) | Nonlinearity→DCDS-A | fallback: J. Diff. Eqs. Apps. (IF 1.1), Dynamical Systems |
...
| `2026_finite_window_zeckendorf_fibers_discrete_thermodynamics_tams` | Trans. AMS | A-BLOCKED (max Stage A rounds exhausted; final audit failed (score=7)) | — |
| `2026_finite_observation_escape_rates_cyclotomic_resonances_etds` | ETDS | A-BLOCKED (max Stage A rounds exhausted; final audit real block (score=6)) | — |
...
| `2026_gluing_failure_visible_quotients_pure_ext_blind_spots_apal` | APAL | A-BLOCKED (max Stage A rounds exhausted; final audit real block (score=6)) | — |
...
| `2026_fredholm_determinants_cyclic_block_spectral_rigidity_jst` | J. Spectral Theory | B-PAUSED (Oracle infra retry needed at B14) | — |
