...
radii. Section~\ref{sec:finite-part} uses only the primitive matrix
formalism. Sections~\ref{sec:chebotarev} and~\ref{sec:shadows} then
return to the graph and cocycle picture for finite-group extensions.
