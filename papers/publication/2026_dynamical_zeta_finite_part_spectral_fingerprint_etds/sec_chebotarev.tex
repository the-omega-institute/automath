...
\cite{Serre1977LinearRepresentations}. All arguments in this section
remain within the finite-dimensional twisted-matrix setting; the new
point is not a broader periodic orbit theorem, but the extraction of
primitive-channel information from the classical periodic determinant
data.
