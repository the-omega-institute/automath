...
We now pass to finite-group extensions. The root-of-unity formulas of
\Cref{sec:finite-part} are replaced by Fourier analysis in the space of
class functions, that is, by the Peter--Weyl decomposition. At the
...
What is needed here is a primitive counterpart to those periodic
