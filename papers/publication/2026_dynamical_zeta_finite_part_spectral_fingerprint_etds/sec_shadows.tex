...
This section has a deliberately modest role. First, the primitive class
functions behave naturally under passage to quotient groups, which
isolates the one-dimensional information already visible from cyclic
data. Second, an explicit \(S_3\)-example shows that a genuinely
non-abelian primitive contribution may remain even when the
...
orthogonal projection formalism and the exact cyclic-detection
boundary.
