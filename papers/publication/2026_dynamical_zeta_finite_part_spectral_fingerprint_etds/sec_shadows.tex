...
We record two diagnostic consequences of the preceding analysis. First,
the primitive class functions behave naturally under passage to quotient
groups, which isolates the abelian shadow already visible from cyclic
data. Second, we work out an explicit \(S_3\)-example showing that a
genuinely non-abelian primitive contribution may remain even when the
