...
\begin{proof}
  ...
  values of \(\psi^m\rho\) are
  \[
    (2,0,-1),\ (2,2,-1),\ (2,0,2),\ (2,2,2)
  \]
  according as \(m\equiv \pm 1,\pm 2,3,0 \pmod 6\). Decomposing these
  four class functions in the basis
...
\begin{proof}
  ...
  \Cref{prop:class-mertens-deviations} and
