...
This section records two further consequences of the preceding
analysis. First, the primitive class functions behave naturally under
passage to quotient groups, which isolates the abelian information
already visible from cyclic data. Second, an explicit \(S_3\)-example
shows that a genuinely non-abelian primitive contribution may remain
even when the corresponding periodic trace data vanish. The orthogonal
decomposition used for cyclic detection is collected in the appendix.
