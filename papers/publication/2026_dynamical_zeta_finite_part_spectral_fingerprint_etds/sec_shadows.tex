...
We record two consequences of the preceding analysis. First, the
primitive class functions behave naturally under passage to quotient
groups, which identifies the part of the primitive profile already
visible from cyclic quotients. Second, we work out an explicit
\(S_3\)-example showing that a genuinely non-abelian primitive
contribution may remain even when the corresponding periodic trace data
vanish. The orthogonal decomposition used for cyclic detection is
