...
In this section we record two consequences of the preceding formalism:
its behaviour under quotients and an explicit \(S_3\)-example. The
orthogonal decomposition underlying cyclic detection is collected in
the appendix.
