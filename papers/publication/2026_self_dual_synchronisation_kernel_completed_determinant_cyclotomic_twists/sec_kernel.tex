...
not the factorisation of its characteristic polynomial and not the
locations of the reciprocal roots of the remaining factors. Inspecting
the transition table at \(u=1\), every row of \(B=B(1)\) has sum \(3\), and
hence
\[
  B\mathbf 1=3\mathbf 1,\qquad
...
shows that every eigenvalue has modulus at most \(3\). Therefore
