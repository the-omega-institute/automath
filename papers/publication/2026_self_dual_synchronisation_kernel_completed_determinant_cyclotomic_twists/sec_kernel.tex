...
\]
The first displayed equality shows that \(3\) is itself an eigenvalue,
while the row-sum bound shows that no eigenvalue has modulus larger than
...
any comparison of the reciprocal zeros of the non-Perron determinant
factors. Only after this row-sum/Perron--Frobenius
argument do we use the determinant factorisation. Setting \(u=1\) in
