...
\((\deg f_1,\dots,\deg f_r)\); this is Dedekind's theorem in
\cite[I, \S{}6, Proposition~25]{Serre1979}, in the Frobenius form used
in \cite[\S{}4.3]{Serre2008Topics}. The exact mod-\(p\) factorisation data are
...
genus formula for smooth plane curves
...
\Cref{sec:appendix-computation}\,\textup{(f)}.
\end{proof}
