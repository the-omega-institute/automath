...
coordinate change.
Throughout, such a factor is the conjugate product itself, with the
resultant convention of \Cref{lem:ordered-cyclotomic-resultant}.
...
certificate runner follows standard practice for reproducible computer
algebra in mathematical writing \cite{CICM2024}; it verifies the printed
determinant, smoothness, Galois, and endpoint checks for the finite
kernel, and it supplies no additional theorem beyond those computations.
