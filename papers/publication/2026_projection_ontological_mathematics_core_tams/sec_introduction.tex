...
density.  Exact root isolation in this window also singles out a negative real
subdominant root of each displayed recurrence polynomial.  Conditional on the
