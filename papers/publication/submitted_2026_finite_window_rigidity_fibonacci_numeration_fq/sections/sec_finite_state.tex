...
\]
\leanverified{paper_resolution_folding_phi_m_entropy}
\end{corollary}
...
\leanverified{paper_resolution_folding_alternating_single_symbol_synchronizing}
\end{theorem}
...
\leanverified{paper_resolution_folding_y_m_synchronized}
\end{corollary}
