...
\]
\end{proof}
\leanverified{paper_resolution_folding_signed_fibonacci_gap_shift}
...
\qquad (1\le j\le m).
\]
\leanverified{paper_resolution_folding_length_m_block_unique_lift}
\end{theorem}
...
\leanverified{paper_resolution_folding_uniform_synchronizing_length}
\end{corollary}
...
\leanverified{paper_resolution_folding_block_bijection_threshold}
\end{theorem}
...
\]
\leanverified{paper_resolution_folding_block_counts_threshold}
\end{corollary}
...
\leanverified{paper_resolution_folding_higher_block_identification}
\end{proof}
...
stored.
\end{proof}
\leanverified{paper_resolution_folding_linear_time_block_decoding}
...
\leanverified{paper_resolution_folding_y_m_exact_sft_order}
\end{theorem}
...
\leanverified{paper_resolution_folding_phi_m_conjugacy_threshold}
\end{theorem}
...
\leanverified{paper_resolution_folding_phi_m_memory_threshold_exact}
\end{corollary}
