\section{A second-moment recurrence}\label{sec:fiber-spectrum}

The threshold and conjugacy theorems do not require the full fiber spectrum.  One statistic, however, is useful and has a closed recurrence: the second moment
\[
\Sigma_m:=\sum_{x\in X_m}d_m(x)^2,
\]
equivalently the collision probability of the stabilized law under uniform raw input, up to the factor $2^{-2m}$.
