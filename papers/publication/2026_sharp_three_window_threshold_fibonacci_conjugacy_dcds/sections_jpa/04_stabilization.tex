...
\begin{proposition}[Supporting basic properties of $\Fold_m$]\label{thm:fold-suite}
...
\begin{proposition}[Supporting exact residue characterization of fibers]\label{thm:fiber-residue}
