...
\begin{proof}
By Proposition~\ref{thm:fiber-residue},
\[
d_m(x)
=
\sum_{\omega\in\{0,1\}^m}
...
\end{align*}
where the third equality uses that $\tau_m$ is a bijection and the last equality is Proposition~\ref{thm:fiber-residue} written in residue coordinates. This proves the theorem.
\end{proof}
...
\]
Thus the uniform visible law is invariant under the same affine reflection of residue coordinates.
\end{corollary}
