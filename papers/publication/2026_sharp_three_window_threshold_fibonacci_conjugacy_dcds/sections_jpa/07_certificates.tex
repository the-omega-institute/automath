...
Assume that the blurred readout has a depth-$(m+n-1)$ atom partition by at most
$m+n$ intervals, so its empirical raw-word law differs from its limiting
raw-word law in total variation by at most $(m+n)D_N^*(\alpha;x_0)$. Then, for
the empirical blurred stabilized law $\hat{\eta}_{m,n,N}^{(\rho)}$,
\[
