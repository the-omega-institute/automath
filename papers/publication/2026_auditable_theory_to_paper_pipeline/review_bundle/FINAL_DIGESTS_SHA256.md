...
Support mode: conditional exact supplemental inclusion of `theorem_inventory.json`, `theorem_inventory.md`, and the selected `review_bundle/` file table below, or the automath public branch/path locator when the referenced bytes match this table at a pinned commit or same-state refreshed branch head; no venue-upload receipt, DOI, Lean/BEDC rebuild, marker-existence audit, axiom-purity audit, daemon execution, artifact semantic-validation claim, completed submission pack, public byte-equality certification, public source reachability certification, or venue acceptance is made by this digest table.

Regenerated after theorem-inventory and verifier-log refresh: 2026-06-08T00:11:14+08:00.
...
| `e3a87c1b991f0bbc543c6c2a7ac4679266c55dd3dd2ffdb3179f98545bec819f` | `main.tex` |
| `9a8afa7fa932d6ac4b696f3e51b1b8e93c26c4c38eff12e86682471a0d82ecd8` | `references.bib` |
...
| `5f8f42bcf6d744bedda30184946b230dbe18b2b8694bf949579d758f60510fbd` | `review_bundle/certificate_verification_run.log` |
...
| `2105446c3adc0097ba6ad73bfa77874f4fd44ff7d76ccd18b772c0301f7b7516` | `review_bundle/primary_claim_inventory_freshness_2026-06-07.log` |
...
| `78ed677f3b1400eeb37446242f9c20bb60e4dd2f394fe9a258a2c0e128044498` | `review_bundle/source_interface_verification_run.log` |
...
| `02458c0394a717617d070085a2f926837263756b36d83760dfbf9d22fed7a403` | `review_bundle/theorem_environment_extraction_run.log` |
...
| `a4ae2e06e23e6a47c8f286513d4c2677a483500a86832c43670028a3ce178b4b` | `theorem_inventory.json` |
| `b23ab064deee244b07400c151d2acdfb45c9d47c81c440debe7f5344170c9240` | `theorem_inventory.md` |
| `d9021de3e7d5e72ac23ff82b0f16a01c9980e23471622f1bec3dc56e86f0b53a` | `review_bundle/final_digest_generation_run.log` |
