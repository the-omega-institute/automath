...
\subsection{Transfer-matrix consequences}
...
Theorem~\ref{thm:microcanonical-output} identifies the weighted theory with an entropy maximization problem on the pair shift. Thus the transfer matrix governing \(Z_m(y)\) and the variational description of the free energy are two descriptions of the same finite-state model.
