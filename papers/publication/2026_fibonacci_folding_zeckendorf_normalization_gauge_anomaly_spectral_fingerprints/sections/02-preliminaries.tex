...
Zeckendorf's theorem states that every \(N\in \NN\) admits a unique representation as a sum of non-consecutive Fibonacci numbers \(\Fib_{k+1}\) (\(k\ge 1\)). Equivalently, there exists a unique binary sequence \(z=(z_k)_{k\ge 1}\in \set{0,1}^{\NN}\) such that
