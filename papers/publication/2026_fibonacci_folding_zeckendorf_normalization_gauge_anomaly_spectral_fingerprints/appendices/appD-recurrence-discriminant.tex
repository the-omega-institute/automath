...
This appendix collects the transfer-matrix calculations used in Section~\ref{sec:partition}. Nothing essentially new happens here once the four-state presentation from Appendix~\ref{app:pressure} is available; the point is simply to keep the linear algebra and symbolic algebra out of the main argument.
