...
This appendix collects the transfer-matrix calculations used in Section~\ref{sec:partition}. Once the four-state presentation from Appendix~\ref{app:pressure} is fixed, the remaining arguments are linear algebra and symbolic elimination; we place them here to keep the main argument focused on the structural results.
