...
> **TICK 65 — 重算档位账:我在 tick 35 给的悲观结论已被事实推翻,须更正**。池子 1/6(A3 回验 `6c70283d` 在飞);无 agent、无孤儿、内存 1.35 GB、无可收割。
>
> tick 35 我写过"八篇七篇被拒,tier-1 一篇没有,勉强够 tier-2 的只有两篇",并说"要上 tier-2 以上需要换问题,不是改稿"。**换问法之后,这个结论有一半不成立了。**
>
> | 篇 | tick 35 时 | 现在(审稿人原话) |
> |---|---|---|
> | **A2** | 拒稿,"强专门期刊" | **JFA "a defensible target"** |
> | **A6** | 拒稿,"即使完全修复 TAMS 仍拒" | **优先权异议撤销;"不会仅因更正前人文献就预先降档"** → Transactions |
> | **A8** | 拒稿,改投 MCAP | **"Bernoulli is a defensible ambitious submission"**(若围绕 F–G 重构);EJS / SPA / SISP |
> | **A4** | 材料不全则拒稿重投 | **minor revision, publishable thereafter** |
> | **A9** | 拒稿 | 更正被接受(**档位未变,他明说不实质提升**)|
>
> **诚实的重算**:tier-1 仍然一篇没有,这一条不变。但 **tier-2 的候选从"勉强两篇"变成三篇有审稿人明确背书**(A2 JFA、A6 Transactions、A8 Bernoulli),且都不是我们自封的,是他在看过新结果后写下的。A3 待裁。
>
> **我当时错在哪**:我把"审稿人不主动提升档路径"当成了"不存在升档路径"。实际是**我没问**——老问法第 3 问直接请他推荐更低的期刊。换问法之后,同一批稿件、同一位专家,给出的是具名可达目标和数字概率。
