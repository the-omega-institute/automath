...
\begin{theorem}[Finite-state error resolvent and cyclotomic lift]
...
and poles in this theorem are those of finite matrices.
\end{theorem}
...
The introduction records the finite-state pole statement as a headline
consequence.  Its hypotheses, lifted matrix, possible-pole set, and
non-cancellation criterion are exactly those proved in
