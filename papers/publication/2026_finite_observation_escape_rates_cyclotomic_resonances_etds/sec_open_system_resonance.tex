...
\]
because \(u_i=\pi_i>0\) on \(\mathcal S_\infty\), the vector \(\ell\)
is strictly positive there, and
Lemma~\ref{lem:automatic-recurrent-residues} gives \(b_a(i)>0\) there
for every \(a\).  Since \(1\) is a simple eigenvalue of \(S_q\) and
