...
records a finite-dimensional consequence of the same killed-matrix path
...
\subsection{Finite-state resolvent reformulations}

\begin{proposition}[Finite-state error resolvent and cyclotomic lift]
...
\begin{proof}[Proof of Proposition~\ref{thm:main-resonance}]
The introduction records the finite-state pole statement as a proposition
of the killed path-sum formula.  Its hypotheses, lifted matrix,
possible-pole set, and non-cancellation criterion are exactly those
proved in Proposition~\ref{thm:error-resolvent-cyclotomic}.
\end{proof}
