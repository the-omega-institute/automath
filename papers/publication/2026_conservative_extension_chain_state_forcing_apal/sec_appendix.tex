...
The appendix collects material that is independent of the proofs in the main text. We record the finite-state complexity bounds attached to the refinement-dynamic extension, the formal refinement-dynamic development itself, and the GHZ/Mermin amplitude lift mentioned in the introduction.
