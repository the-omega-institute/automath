...
We record the finite-state upper bounds for the support notions summarized in \Cref{sec:refinement-dynamics-overview}.
...
This appendix contains the formal dynamic material corresponding to the overview in Section~\ref{sec:refinement-dynamics-overview}.
