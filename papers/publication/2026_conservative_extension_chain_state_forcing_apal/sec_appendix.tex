...
This appendix collects supplementary material that is not used in the proofs of the main theorems. We record the finite-state complexity bounds attached to the refinement-dynamic extension, the formal refinement-dynamic development itself, and the GHZ/Mermin amplitude lift mentioned in the introduction.
...
\section{Supplementary: A GHZ/Mermin Amplitude Lift}\label{sec:appendix-ghz}
