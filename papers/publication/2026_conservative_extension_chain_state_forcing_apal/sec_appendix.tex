...
This appendix is supplementary to the main proof chain. It records only routine finite-state upper bounds for the support notions summarized in \Cref{sec:refinement-dynamics-overview}.
...
This appendix records the formal dynamical material corresponding to the overview in Section~\ref{sec:refinement-dynamics-overview}. The definitions and proofs do not interact with the obstruction-theoretic core of the paper but are kept here for reference.
