...
\section{Supplementary: Refinement Dynamics}\label{sec:appendix-dynamics}

This appendix records the dynamical material previously located in Section~\ref{sec:multiaxis-refinement}. The definitions and proofs do not interact with the obstruction-theoretic core of the paper but are kept here for reference.

\subsection{Refinement Dynamics and Support}\label{sec:multiaxis-refinement}
