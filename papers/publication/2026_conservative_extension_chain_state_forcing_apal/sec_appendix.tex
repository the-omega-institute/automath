...
The appendix contains two supplementary topics. The first concerns the refinement-dynamic extension, together with finite-state complexity bounds for the associated support notions. The second gives the GHZ/Mermin amplitude lift mentioned in the introduction.
