...
The unique-branch case $|\Vis_{p,s}(r)|=1$ deserves separate attention because it connects the present theory to the sheaf-theoretic analysis of contextuality. The comparison in this subsection is deliberately formal: it assumes from the outset that the local object functor has been identified with the support presheaf of an Abramsky--Brandenburger measurement scenario and that the extra realization hypotheses of the present paper have been verified. We do not claim that arbitrary empirical models automatically satisfy the unique-branch, realization-prestack, or global-conservativity hypotheses. This subsection records only what follows once those hypotheses have been fixed. The relevant contextuality background is the support-presheaf framework of \cite{AbramskyBrandenburger2011}, its cohomological refinements \cite{AbramskyMansfieldSoaresBarbosa2012,AbramskyBarbosaKishidaLalMansfield2015,Caru2018,Montanhano2021}, the team-semantics comparison of \cite{AbramskyPuljujarviVaananen2025}, the topological and resource-theoretic perspectives of \cite{OkayRobertsBartlettRaussendorf2017,OkayTyhurstRaussendorf2018}, and the blind-case analysis of \cite{Caru2017}.
