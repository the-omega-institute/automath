...
Throughout the section we work with a fixed finite cover and a fixed finite nerve presentation. All cochain groups are computed on that presentation, and the only comparison maps used are the explicit identification of \v{C}ech cochains with simplicial cochains on the finite nerve and the resulting universal coefficient sequence for that simplicial model.
