...
This appendix records two elementary consequences of the finite fiber
measure
\[
  \nu_m=\sum_{x\in X_m}\delta_{d_m(x)} .
\]
They are included only as reader support for the certificate viewpoint;
none of the proofs of the \(L0/L1/L2\) hierarchy or of its separations
uses the results in this section.
