...
one-orbit model, \Cref{thm:one-orbit-faithful-cyclic-classification} is sharp:
only a single cyclic multiplicative ray can remain faithful.  The prime-coordinate
case is \Cref{thm:one-orbit-faithful-submonoid-classification}.  No finite-rank
