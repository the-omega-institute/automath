...
\begin{theorem}[Finite-rank product-readout lower bound]
...
\(\NN_{\ge1}\).  The one-orbit obstruction is the rank-one case.
\end{theorem}
...
positive weight, which recovers \Cref{thm:one-orbit-faithful-submonoid-classification}.
\end{proof}
...
prime-power ray can remain faithful.  More generally,
