...
\begin{corollary}[Classification of one-orbit readouts]
...
\begin{proof}
This is the first half of \Cref{thm:level-zero-obstruction}.
\end{proof}

\begin{corollary}[Sharp faithful coordinate submonoids for one-orbit readouts]
...
\begin{corollary}[Extremal faithful restrictions for one-orbit readouts]
...
\begin{proof}
This is the extremal submonoid clause and the final positive-replacement clause
of \Cref{thm:level-zero-obstruction}.
\end{proof}
...
orbit case \(\Cref{thm:level-zero-obstruction}\), and no proof of
\(\Cref{thm:main-hierarchy}\) depends on the finite-rank refinement.
\end{theorem}
...
finite-rank skeleton that contains the rank-one proof as its first case.  Thus it
is a sharpness certificate for the boundary of \Cref{thm:level-zero-obstruction},
not an additional hypothesis in the hierarchy theorem.
\end{proof}
