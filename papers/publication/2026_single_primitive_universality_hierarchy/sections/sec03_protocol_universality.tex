...
\Cref{thm:one-orbit-faithful-submonoid-classification}.  No finite-rank
product-readout classification is used in this paper.
\end{corollary}
...
prime-coordinate case is the faithful-submonoid classification.  This is the
full rigidity input needed for the hierarchy theorem.
\end{proof}
