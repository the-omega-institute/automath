...
\Cref{prop:finite-fiber-certificate-taxonomy}: Hankel positivity, finite Prony
reconstruction, moment data, and the star-kernel certificate are functions of
\(\mathcal D_m\), hence are unchanged by replacing a datum with another datum
having the same fibre-size multiset.  If a fixed finite-state transfer formula
