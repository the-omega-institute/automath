...
The only mathematical input in this theorem not proved inside the manuscript is
the positive-index ordinary interval maximum formula \((E)\) isolated and cited in
\Cref{thm:source-audited-ordinary-maximum-import}; after that imported formula,
the passage to the shifted half-intervals defining \(H_n\) is the internal
conversion proved below.
\end{theorem}
