...
\Cref{thm:source-audited-ordinary-maximum-import}.  The new in-paper step here is
only the normalization and shifted half-interval conversion from \((E)\) to the
quantities \(H_n\).
\end{theorem}
