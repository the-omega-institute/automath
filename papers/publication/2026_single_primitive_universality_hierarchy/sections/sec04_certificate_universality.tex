...
\((E_{\mathrm{KMP}})\).  Once this conversion is made, all subsequent assertions
...
article: it is exactly the positive-index formula \((E)\), equivalently
\((E_{\mathrm{KMP}})\), isolated and cited in
...
The only imported enumerative input is the index-locked ordinary interval maximum
\([F_k,F_{k+1})\) of \Cref{thm:source-audited-ordinary-maximum-import,prop:kmp-indexing-lock-intrinsic-height}; the shifted
