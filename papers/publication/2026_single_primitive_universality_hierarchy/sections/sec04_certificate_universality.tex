...
classification of \Cref{lem:scalar-signed-fibonacci-exit-classification}, packaged
coordinate by coordinate in \Cref{lem:coordinatewise-signed-fibonacci-exit-deletion}.
...
\cite[Thm.~4.7]{KocabovaMasakovaPelantova2005}.  The imported interval convention
is exactly
\[
  F_k\le N<F_{k+1}
\]
...
The only imported enumerative input is the ordinary interval maximum
\([F_k,F_{k+1})\) of \Cref{thm:source-audited-ordinary-maximum-import}; the shifted
