...
\begin{proposition}[Height-squeeze firewall]
...
\]
Thus the height-squeeze endpoint is compatible with incompatible histograms and
different fixed-degree growth envelopes.  Consequently the endpoint theorems
carry exactly the maximal-height information stated in them and no full pressure,
histogram, or large-deviation assertion.
\end{proof}
