...
\begin{theorem}[Imported ordinary maximum formula with normalization]
...
independent maximum theorem proved in this manuscript.
\end{theorem}
...
maximizing integers is imported into the intrinsic fold-height theorem.
\end{corollary}
