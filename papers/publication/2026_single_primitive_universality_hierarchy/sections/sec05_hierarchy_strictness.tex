...
\((\mathsf P,\mathsf S,\mathsf A)\), meaning a triple whose three displayed
real-domain identities have already been proved or assumed as hypotheses.  In
particular the internally proved punctured row \(\Abs(u)=|u|\) from
...
the unconditional part of the theorem.
