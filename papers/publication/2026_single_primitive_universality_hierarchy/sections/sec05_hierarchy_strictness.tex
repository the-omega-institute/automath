...
\(D_{B_n}\) and no value of \(\mu(0)\) is queried.  Hence a decision procedure for
the displayed punctured identity problem would be a decision procedure for the
problem Richardson proves undecidable, and the manuscript's \(D_E\) formulation
is a conservative explicit-domain restatement of the cited theorem.
\end{proof}
...
\]
have been proved or assumed.  Without those identities the reader-facing theorem
...
intrinsic height law of \Cref{thm:intrinsic-fold-fibre-height}.  More sharply, over the same
