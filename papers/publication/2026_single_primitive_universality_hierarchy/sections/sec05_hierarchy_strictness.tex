...
principal-branch EML semantics.  The finite catalogue and parser certificate
...
not a semantic verification of these two printed strings.  Consequently every
theorem, corollary, or proof in this paper that names the concrete pair
