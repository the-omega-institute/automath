...
package of \Cref{thm:intrinsic-fold-moment-transfer,thm:intrinsic-second-moment-recurrence,cor:polynomial-intrinsic-fiber-statistics}.
No intrinsic nonrecurrence, finite-state-failure, or asymptotic classification
theorem beyond that positive package is used in the cover strictness chain.
\end{theorem}
...
additional comparison theorem.  The intrinsic fold moment is handled directly by
\Cref{thm:intrinsic-fold-moment-transfer}; the cover strictness proof supplies no
separate intrinsic asymptotic classification.
\end{proof}
...
finite-fibre covers, so no intrinsic nonrecurrence, finite-state-failure, or
growth-classification theorem for \(\Fold_m\) fibre multiplicities follows from
\Cref{thm:finite-state-strictness}.  The positive intrinsic recurrence and
finite-state-transfer statements used in the article are exactly those proved in
