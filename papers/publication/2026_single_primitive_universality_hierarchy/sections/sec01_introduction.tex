...
two rows are exactly the hypotheses of the abstract verified-pair and
replacement-triple interface in
\Cref{thm:verified-pair-richardson-instantiation,thm:replacement-triple-richardson-interface,cor:unconditional-richardson-replacement-interface,thm:richardson-witness-row-rigidity,thm:proc-ams-relative-richardson-theorem,thm:unconditional-submission-richardson-closure}.
