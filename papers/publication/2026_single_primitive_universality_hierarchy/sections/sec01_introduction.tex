...
absolute-value witness for Richardson's condition (2).  Equivalently, the
unconditional theorem is a replacement-triple interface, not a theorem about the
particular printed names.
\end{theorem}
