...
value, a source-indexed pure EML Richardson fragment whose identity-to-zero
problem is undecidable on the transported partial real domains.  It follows that
...
compiler into finite decidable protocol objects.  The endpoint square-root string
\(U_{126}\) is not part of this punctured obstruction.
...
identities are proved separately, every Richardson obstruction in the submission
manuscript factors through the finite verified-triple interface of
\Cref{thm:separation}; in particular the main hierarchy does not use the printed
...
\item The primary strictness statements are the two obstructions of
  ...
  value have been proved, the translated source-indexed fragment has the stated
  identity-to-zero and equality-reflecting normalizer obstructions.  The paper
  proves the punctured absolute-value row
...
problem.  The endpoint-root string \(U_{126}\) is not part of this input.
\end{theorem}
