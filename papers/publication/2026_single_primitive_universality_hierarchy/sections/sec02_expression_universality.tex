...
serving only as external support cited by that public record.  It is not a
row-by-row verification performed in this article.
...
only the stated source assertion and the external support materials cited by that
source.
