...
\emph{intrinsic hidden subgroup} and the \emph{intrinsic visible quotient} by
\[
...
We write
\[
q_{\omega}:A\longrightarrow A_{\mathrm{vis}}^{\omega}
\]
for the quotient map. Thus $K_{\omega}$ is exactly the part of the coefficient
group seen by the homological evaluation of $\omega$, while
$A_{\mathrm{vis}}^{\omega}$ is the residual quotient through which every
homologically invisible coefficient collapse factors.
\end{definition}
