...
Since a finite nerve presentation chooses a visible branch, $\Vis_{p,s}(r)\neq\varnothing$; if moreover $|\Vis_{p,s}(r)|=1$, then the unique branch is non-neutral, so \Cref{thm:gerbe-null-semantics} yields
\[
M,p\Vdash \Null^{\mathrm{glue}}_s(r).
\]
\end{proof}
