...
See \cite[Definition~4.66]{HomologicalVisibilityGluingObstructions2026}.
\end{definition}
...
See \cite[Theorem~4.106]{HomologicalVisibilityGluingObstructions2026}.
\end{theorem}

\begin{remark}[Car\`u-type blind cases as pure $\operatorname{Ext}$-residuals]\label{rem:caru-ext-residual}
The pure-$\operatorname{Ext}$ characterization cited in
