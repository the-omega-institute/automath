...
The Fourier-support calculation proving this classical splitting is in
\texttt{sec\_strip\_10\_hardy\_aux\_lattice.tex}, subsection ``Hardy splitting
and the integer-orbit projection,'' in
\texttt{supplement\_relocated\_support.tex}.
\else
\begin{proof}
...
\ifdefined\JFAArticleMain
The periodization, alias-cancellation, norm, and quotient-rigidity
calculation proving this lemma is in
\texttt{sec\_strip\_10\_hardy\_aux\_lattice.tex}, subsection ``Hardy splitting
and the integer-orbit projection,'' in
\texttt{supplement\_relocated\_support.tex}.
\else
