...
This subsection supplies the supporting RKHS bookkeeping used by the
coefficient calculus.  It is not an additional entropy principle: for the
kernel under consideration, the multilinear integrals appearing in the
entropy expansion from Section~\ref{sec:precision-potential} can be
organized as derivatives of explicit multilinear kernels built from the
same secant family.
