...
\subsection{The classical algebraic interface}
...
novelty.  Apart from the operational bit-depth estimate at the end, the
...
\cite{Hungerford1974,Folland1995}.  We include the proofs to fix the
