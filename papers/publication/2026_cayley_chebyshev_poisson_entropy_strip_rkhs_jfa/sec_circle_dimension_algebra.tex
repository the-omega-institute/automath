% sec_circle_dimension_algebra.tex -- finite phase sampling
...
finite material retained here is only the root-of-unity sampling interface
used later to recover Cayley Fourier coefficients and to verify the finite
mode integrals in the entropy expansion.
