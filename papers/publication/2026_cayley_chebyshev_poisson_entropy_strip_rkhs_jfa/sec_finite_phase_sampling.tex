...
finite phase results below give the root-of-unity sampling mechanism used
later to recover Cayley Fourier coefficients and to verify the finite mode
integrals in the entropy expansion.
They are used as exact root-of-unity averaging and finite Fourier extraction
tools for analytic Cayley modes.  The only point needed here is the exact
agreement between Haar averaging and averaging over a sufficiently fine finite
phase grid for trigonometric polynomials below the aliasing barrier.
