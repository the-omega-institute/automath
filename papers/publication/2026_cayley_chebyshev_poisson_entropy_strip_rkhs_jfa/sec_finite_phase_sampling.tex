...
=\frac1N\sum_{\zeta\in\mu_N}Q(\zeta)=a_0.
\]
...
grid~$\mu_N$ for all $N>K$.  In particular, this alias-free extraction is
...
\[
\frac1N\sum_{\zeta\in\mu_N}Q(\zeta)=\widehat Q_N(0)=\widehat Q(0)=a_0.
\]
...
$\mu_N$ whenever the displayed support bound is below the grid scale.  The
