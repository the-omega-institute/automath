...
section is auxiliary to the finite-moment entropy and eighth-order defect
packages.  It records the root-of-unity averaging mechanism used later to
recover Cayley Fourier coefficients and to verify finite mode integrals in the
printed low-order expansion.  No entropy asymptotic theorem is proved here:
the only point needed later is the exact agreement between Haar averaging and
averaging over a sufficiently fine finite phase grid for trigonometric
polynomials below the aliasing barrier.
