...
They are used only as finite quadrature and aliasing tools for analytic
Cayley modes.  No finite-abelian-group phase-spectrum reconstruction,
...
\begin{corollary}[Alias-free Cayley mode-product quadrature]%
...
grid~$\mu_N$ for all $N>K$.  In particular, this alias-free quadrature is
