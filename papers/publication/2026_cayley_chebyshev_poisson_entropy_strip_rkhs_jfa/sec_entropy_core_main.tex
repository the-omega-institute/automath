...
The appendices contain only related-work context and optional
coefficient-calculus or tail-verification notes.
...
not asserted here as separate submitted model-class theorems.  The statement
...
additional tail-class verification outside the submitted claims.
\end{corollary}
