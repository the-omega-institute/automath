...
See \cite[Theorem~6.10]{HomologicalVisibilityGluingObstructions2026}.
\end{proposition}
...
\]
for every abelian group $B$. Thus the pure-extension condition in \cite[Theorem~6.10(i)]{HomologicalVisibilityGluingObstructions2026} is equivalent to $q_*(\omega)=0$, and \cite[Theorem~6.10]{HomologicalVisibilityGluingObstructions2026} gives the stated factorization criterion.
\end{proof}
