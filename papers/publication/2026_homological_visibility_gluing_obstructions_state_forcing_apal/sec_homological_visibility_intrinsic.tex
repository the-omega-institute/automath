...
\]
on each triple overlap. This is the single-label instance of the cocycle-to-prestack construction later isolated in \Cref{lem:twisted-branch-prestack-model}; equivalently, it is the standard local-trivialization construction for gerbes \cite[Chap.~IV]{Giraud1971}, \cite[Sec.~5]{Breen2006}, \cite{Murray1996}. It yields a prestack presentation $\mathfrak P_r$ on $\mathcal C_a$ with the following properties:
\begin{enumerate}[label=(\roman*),nosep]
