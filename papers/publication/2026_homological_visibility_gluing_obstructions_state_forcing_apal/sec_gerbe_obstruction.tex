...
Thus \Cref{prop:finite-site-semantic-interface}(i) supplies the strict
matching representative using separatedness on the overlap objects
\(U_{ij}\), not merely injectivity at \(a\).  The
injectivity of \(u_a\), and the equivalence between its bijectivity and unique
strict amalgamation, are completed in the preceding final part of this
theorem.
