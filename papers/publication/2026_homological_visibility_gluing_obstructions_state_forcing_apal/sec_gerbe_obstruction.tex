...
\Cref{thm:marked-terminal-torsor-form}.  If one keeps
\[
...
When \(\Lambda_0\ne\varnothing\), there is no third formulation retaining
all three conditions
\[
 \pi_0^{\mathrm{pre}}(\mathfrak P)(a)\cong\Lambda_0,
 \qquad
 \mathfrak P(a)\to\mathfrak L(a)\text{ essentially surjective},
 \qquad
