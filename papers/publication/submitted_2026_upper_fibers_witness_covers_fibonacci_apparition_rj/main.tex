...
Let $q,u,v\ge2$ and let $a,b\ge1$. Then
...
integer from $B_n$. Since every proper divisor of $m$ is obtained by a sequence
of such lowerings, no proper divisor of $m$ lies in $B_n$, and $m$ is minimal.
