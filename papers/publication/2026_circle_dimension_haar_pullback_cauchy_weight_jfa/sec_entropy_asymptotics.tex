...
reduced to the rational kernel $R_\varepsilon(y)$, whose Cayley image
has a finite Fourier expansion.  This is the mechanism behind the even
parity of the entropy expansion.  Only the explicit weighted integrals
needed for the coefficients of orders $t^{-6}$ and $t^{-8}$ are
...
\begin{remark}
The preceding facts are standard; we record them only to fix the
normalization of the Poisson kernel and of the generator $-|D|$ used
below.
\end{remark}
