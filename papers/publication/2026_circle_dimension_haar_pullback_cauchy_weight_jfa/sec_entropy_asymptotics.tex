...
Fisher-information rate for Cauchy smoothing.  The sixth- and
eighth-order coefficients are the genuinely new content:
the $t^{-6}$ coefficient $C_6$ already involves the skewness and
excess-kurtosis of $\nu$, while the $t^{-8}$ coefficient $C_8$ brings
in moments through order six and is where the defect-ladder structure
emerges.  In the entropic CLT literature
...
$\Delta_8\ge(13\sigma^2/8)\Delta_6$ is the paper's strongest structural
result.  It says that any departure from the symmetric two-point law
measured by the sixth-order defect is strictly magnified at eighth order,
with the amplification factor $13\sigma^2/8$ being explicit and
universal (depending only on the variance).  This is a genuinely
higher-order phenomenon: it cannot be seen at the level of the
fourth-order coefficient alone.
\end{remark}
