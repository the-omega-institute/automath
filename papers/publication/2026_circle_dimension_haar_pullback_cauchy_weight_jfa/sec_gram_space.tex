...
We now place the mode calculus in a concrete Hilbert-space model.  The
underlying framework is standard for translation-invariant
positive-definite kernels; the point of the section is to record the
closed formulas specific to the kernel~$K$ and to connect them with the
centered Poisson observation channels.
...
\cite{Aronszajn1950}.  Theorem~\ref{thm:mode-space-rkhs} identifies that
abstract space, in the present model, with the concrete weighted space
