...
We now turn the mode calculus into a Hilbert-space statement.  The
secant family has a translation-invariant Cauchy-type Gram kernel, and
its closed span admits a concrete reproducing-kernel description.  This
same model also leads to a reconstruction theorem from centered Poisson
data.
