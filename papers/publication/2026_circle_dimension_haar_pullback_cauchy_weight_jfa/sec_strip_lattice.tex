...
shift-invariant spaces and RKHS sampling.  The Poisson strip kernel
$K(a,b) = \pi P_2(a-b)$ carries a completely explicit lattice symbol
$\sigma(\theta) = \pi\cosh(2(\pi - |\theta|))/\sinh(2\pi)$,
which admits both stable sampling inequalities and an exact cardinal
interpolation formula.  In this respect the present kernel is a
Poisson/Cauchy analogue of the Gaussian shift-invariant spaces studied
in \cite{RomeroUlanovskiiZlotnikov2024,BaranovBelovGrochenig2022},
with the advantage that the lattice symbol, cardinal kernel, and
norm formula are all given in closed form.
\end{remark}
