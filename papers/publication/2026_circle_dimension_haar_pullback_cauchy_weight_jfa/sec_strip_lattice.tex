...
In this paper, the genuinely new structural content is the Poisson-strip
reinterpretation, the closed-form lattice symbol
...
\cite{KiselevMininNovikov2016,KiselevMininNovikov2019}.
Our additional contribution is therefore the explicit Poisson-strip
representation, which gives an exact closed symbolic formula for $\sigma$ and
an explicit cardinal norm identity \eqref{eq:cardinal-norm-formula}.
\end{remark}
