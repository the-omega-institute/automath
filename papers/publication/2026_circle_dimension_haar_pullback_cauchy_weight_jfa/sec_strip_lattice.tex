...
then to record the resulting explicit projection and cardinal
interpolation formulas on uniform lattices.  The underlying
shift-invariant theory is standard; the point here is that for the
present kernel every fiber quantity can be summed in closed form.
