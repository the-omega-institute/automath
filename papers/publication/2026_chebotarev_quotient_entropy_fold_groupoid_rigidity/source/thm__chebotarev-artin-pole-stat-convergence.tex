...
\begin{theorem}[Auxiliary abstract statistical convergence]\label{thm:kernel-chebotarev-statistical-convergence}
...
For the converse statement, fix a subset \(A\subseteq G\) as in the hypothesis and choose \(\Gamma_+\) with \(\max\{\Gamma(u),\Theta(u)\}<\Gamma_+<\eta(u)\). By Theorem \ref{thm:kernel-chebotarev-second-main-term-witness},
\[
B_{n,A}(u)
=
