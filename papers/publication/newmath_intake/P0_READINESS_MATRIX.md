...
|---|---|---:|---|---|
| `bedc_automation_pipeline` | promoted active paper `2026_auditable_theory_to_paper_pipeline`; CICM packet, discovery-gate theorem spine, case evidence, gate table, and source decision note carried forward | already promoted | live venue page re-check; related-work pass; P1 draft strengthening | Continue in `../2026_auditable_theory_to_paper_pipeline`; seed is archive/source packet |
