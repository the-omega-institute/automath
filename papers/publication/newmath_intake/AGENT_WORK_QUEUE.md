...
| `bedc_finite_kernel_calculus` | Refine exact theorem-spine summaries; maintain `current_declaration_map.md`; keep `groundcompiler_placement_decision.md`, `blocker_ledger.md`, `bibliography_scope_seed.md`, and `short_note_route_memo.md` aligned with the theorem spine; source-update note shell is prepared as `source_update_note_shell.md` without changing source commit | Source-side work in `D:/omega/newmath`; later journal/workshop promotion | Stop before editing Lean/source files, claiming a packaging theorem exists, or choosing the short-note route for the human |
| `bedc_rule110_finite_witness` | Refine rerun result tables; maintain `current_static_status_map.md`, `evidence_separation_note.md`, `trust_chain_template.md`, and `diagnostic_route_memo.md`; record toolchain prerequisites | Installing/using build toolchain; running Rule110 dynamic suite; later promotion | Stop before treating static evidence as artifact validation or choosing diagnostic/full route without rerun evidence |
