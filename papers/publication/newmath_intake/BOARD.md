...
|---|---:|---|---|---|
| `bedc_automation_pipeline` | P0 | systems / automation paper | CICM brief ready for promotion decision; not promoted | Decide source-gate rerun vs narrowed claim, then ask human whether to promote for CICM presentation-only |
