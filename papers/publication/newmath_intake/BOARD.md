...
|---|---:|---|---|---|
| `bedc_automation_pipeline` | P0 | systems / automation paper | source paths and CICM route verified; not promoted | Re-run source gates or explicitly narrow evidence claims; then ask human whether to promote for CICM presentation-only |
