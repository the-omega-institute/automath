...
|---|---:|---|---|---|
| `bedc_automation_pipeline` | P0 | systems / automation paper | promoted on 2026-05-31 to active track `2026_auditable_theory_to_paper_pipeline`; seed remains archive/source packet | Continue active-paper work in `../2026_auditable_theory_to_paper_pipeline`; do not rerun this seed as an active paper |
