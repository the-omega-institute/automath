...
\begin{remark}[recovery analogy stops at the orthogonality step]
  ...
  shape as the root-of-unity calculations that motivate the excluded
  fixed-matrix cyclic-lift reconstruction package.  In the separate
  canonical cyclic-lift comparison case, ordinary Fourier inversion acts
  on root-of-unity layers of the single matrix \(A\).
