...
\begin{proof}
  The proof is the appendix proof of this theorem. It combines the
  cyclic-lift determinant identity, M\"obius inversion on multiples,
  Newton's identities, and the finite exponential-sum limsup lemma; see
...
\begin{proof}
  The proof is the appendix proof of this corollary, namely the
  fixed-layer discrete Fourier inversion recorded in
  \Cref{app:cyclic-lift-package}.
\end{proof}
