...
\begin{remark}[Fixed-matrix scalar data and the trivial channel]
...
the scalar normalisation used here.  Here the cyclic-lift material has the
structural role proved above: scalar records identify a fixed scalar comparison
model, while the non-trivial branch-compatible product coordinates are the
fixed-label Peter--Weyl values studied in the finite-group sections.  The
