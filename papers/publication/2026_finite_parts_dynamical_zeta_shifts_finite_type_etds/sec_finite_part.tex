...
inversion, holomorphic scalar variation, and reusable truncation certificates
require hypotheses beyond the scalar normalisation used here.  Here the
cyclic-lift material has the structural role proved above: scalar records
identify a fixed scalar comparison model, while the non-trivial
