...
supporting proofs are deferred to \Cref{app:cyclic-lift-comparison}.

\subsection{Finite parts and reduced determinants}

This subsection is classical scalar infrastructure rather than a new
contribution.  It collections the Perron-pole normalisation of the SFT zeta
...
\Cref{app:cyclic-lift-comparison}. They identify the scalar comparison
