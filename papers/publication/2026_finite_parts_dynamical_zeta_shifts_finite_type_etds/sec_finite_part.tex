...
\begin{theorem}[Auxiliary appendix comparison: fixed-matrix cyclic-lift recovery of the
  reduced spectrum]
...
\begin{theorem}[Auxiliary classical scalar normalisation: fixed-layer Fourier recovery]
