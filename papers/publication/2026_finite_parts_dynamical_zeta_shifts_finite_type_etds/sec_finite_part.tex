...
comparison records. No reconstruction or cross-cocycle descent theorem is
asserted from them. The following boundary
...
\noindent
  ...
  variation, finite scalar truncation, descent, or reconstruction from lift data
  are not part of this article and require additional hypotheses beyond this
  scalar normalisation.  The product-side finite-state consequence used here is
  recorded in
