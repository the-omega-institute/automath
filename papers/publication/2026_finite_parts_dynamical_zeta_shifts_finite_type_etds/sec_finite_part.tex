...
\begin{proof}
  ...
  \Cref{thm:class-mertens-explicit,thm:assembled-adams-frobenius-product-package,%
  thm:class-product-stability-scalar-independence}; see
...
\Cref{thm:class-product-stability-scalar-independence} records the
