...
inversion, holomorphic scalar variation, and reusable truncation estimates
require hypotheses beyond the scalar normalisation used here and are not part
of this article's invariant content.  Here the cyclic-lift material has only
the role proved above: scalar comparison data identify a fixed scalar model,
while the non-trivial
