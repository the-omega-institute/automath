...
\begin{proof}
  ...
  \Cref{thm:class-mertens-explicit,cor:assembled-adams-frobenius-product-formula,cor:class-product-hyperplane-stability}; see
  \cite{Sharp1991Mertens,ParryPollicott1990Zeta} for the classical orbit
  product context.  The following calculation fixes the exact constant in
  the finite one-sided SFT convention used in this paper.
...
\begin{corollary}[Only the trivial channel descends from fixed-matrix
  ...
  scalar finite-part formula or canonical cyclic-lift scalar record that
