...
projection boundary needed for that normalization. Broader cyclic-lift recovery
and finite-observation scalar questions are separate fixed-matrix problems and
are not part of the Adams--M\"obius primitive-inversion proof.
