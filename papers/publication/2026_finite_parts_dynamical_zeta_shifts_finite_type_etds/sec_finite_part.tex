...
\Cref{thm:perron-boundary-determinant-product}, specifically its additive
and product components, and after \Cref{cor:strict-gap-specialization}, in the
strict-gap constants.
...
The scalar material supplies the projection data described in
\Cref{subsec:scope-normalizations-support}.  By
\Cref{thm:class-product-determinant-rigidity}, the non-trivial class-product
coordinates are the fixed-label Peter--Weyl Perron values.  The canonical cyclic lift
...
The following statement isolates their normalisation role for
\Cref{thm:perron-boundary-determinant-product}, specifically its additive
and product components, and for the strict-gap specialization: they give the
constant class-function component exactly.
...
\begin{remark}[Fixed-matrix scalar comparison data and the trivial channel]
  ...
  cyclic-lift scalar quantities contribute the trivial-channel normalisation
  \(\mathcal M(A)\), in the sense fixed in
  \Cref{subsec:scope-normalizations-support}.  The non-trivial class profile on a family
...
\noindent
The product-side finite-state consequence is recorded in
