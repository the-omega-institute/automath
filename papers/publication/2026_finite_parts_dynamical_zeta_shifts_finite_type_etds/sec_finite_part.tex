...
\noindent
  ...
  above: scalar data identify a fixed scalar model and are constant as the
  finite-group cocycle varies over a fixed base matrix, while the non-trivial
  ...
  variation, finite scalar truncation, spectrum identifiability, descent, or
  reconstruction from lift data belong to a separate problem and need
