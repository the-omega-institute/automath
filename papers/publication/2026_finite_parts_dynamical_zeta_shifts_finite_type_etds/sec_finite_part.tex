...
\begin{proposition}[Fixed-matrix recovery of the reduced spectrum from the
  ...
  non-Perron spectrum of \(A\) with algebraic multiplicity. In
...
\begin{proof}
  ...
  \(d-1-\deg F_A\). This reconstructs the non-Perron spectrum with
  algebraic multiplicity. The argument is purely fixed-record: it
  recovers one polynomial \(F_A\) from the one sequence attached to the
  same matrix \(A\).
