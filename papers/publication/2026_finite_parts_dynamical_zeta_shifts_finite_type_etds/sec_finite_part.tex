...
This section records the finite-part formula and the scalar projection
boundary needed for that normalisation.  Fixed-matrix cyclic-lift and
root-of-unity records provide comparison records for this scalar layer.
...
The remaining scalar material supplies the support boundary for the
finite-group determinant and product results.  By
...
root-of-unity layers of \(F_A\) are fixed-matrix scalar comparison records. The
following boundary statement isolates their scalar normalisation role for
\Cref{thm:renormalized-class-mertens,thm:renormalized-frobenius-product} and
...
\noindent
  The cyclic-lift quantities used here have the comparison role proved above:
  scalar data identify a fixed scalar model and are constant as the
