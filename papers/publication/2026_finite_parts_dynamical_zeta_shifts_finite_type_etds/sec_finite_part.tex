...
body-level scalar projection boundary, but do not develop the broader
cyclic-lift recovery or scalar-certificate packages in this article. Those
fixed-matrix calculations are companion material and are not part of the
...
inversion package is not developed here.  Its role in this article is only the
structural warning already proved above: scalar records identify a fixed scalar
