...
through a scalar reconstruction, DFT-recovery, or descent theorem.
...
\noindent
Questions about fixed-matrix cyclic-lift reconstruction and one-layer Fourier
inversion require hypotheses beyond the scalar normalisation used here.  In this
article the cyclic-lift material has only the structural role proved above:
scalar records identify a fixed scalar comparison model, not the non-trivial
branch-compatible class-product coordinates.  The product-side finite-state obstruction is recorded in
