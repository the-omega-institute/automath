\section{Conditional tail refinement at an isolated secondary edge}
\label{sec:secondary-term}

This appendix records a conditional finite-dimensional refinement of the
remainder in \Cref{thm:class-mertens-explicit}. It is subordinate to the
class-Mertens theorem: it changes neither the constants
...
\begin{theorem}[Conditional finite edge skeleton under
...
\begin{theorem}[Conditional secondary term above the
  square-root barrier]
...
\begin{theorem}[Conditional secondary edge is a tail-only refinement of Main
  Theorem~II]
  \label{thm:secondary-tail-only-refinement}
