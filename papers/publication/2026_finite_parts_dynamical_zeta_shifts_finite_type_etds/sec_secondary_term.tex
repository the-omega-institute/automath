...
This section is an optional refinement and is not used in Main
Theorem~I, Main Theorem~II, or the quotient-shadow results.
...
\begin{theorem}[Optional refinement: secondary term above the square-root
  barrier]
