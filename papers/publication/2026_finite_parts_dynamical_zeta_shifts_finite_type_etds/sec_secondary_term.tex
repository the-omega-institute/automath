...
This optional appendix has one supporting role: when a non-Perron
spectral edge is isolated above the square-root contribution from
repeated primitive orbits, it records the corresponding first oscillating
tail in the remainder of \Cref{thm:class-mertens-explicit}. It does not
alter the constants \(\mathcal M_C(A,\tau;G)\), the Euler-product
constants \(K_C\), or the Adams--M\"obius determinant spine.  Under the
