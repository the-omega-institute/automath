...
This appendix records the finite-tail refinement that is available when a
non-Perron spectral edge is isolated above the square-root contribution
from repeated primitive orbits. Its support role is precise: under the
...
Perron-point constants already defined in the main text. Without these
separation hypotheses, no secondary expansion or spectral readout is
asserted. Thus the appendix is not a general secondary spectral-edge
theory; it only records the compact refinement needed to verify that such
tails do not change the primary Adams-corrected constants.
...
\begin{proposition}[Secondary refinement above the square-root barrier]
...
\begin{proposition}[Secondary edge refines only the product tail]
