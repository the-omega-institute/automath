...
\begin{theorem}[Appendix-only proof of the secondary-tail interface]
  ...
  following appendix interface: it gives a pointwise first remainder and the
...
\begin{proposition}[Appendix-only secondary edge refines only the
  product tail]
