\section{Appendix: secondary spectral-edge tail refinement}
...
\begin{proposition}[Conditional appendix finite edge skeleton under
...
\begin{proposition}[Conditional appendix refinement above the square-root
  barrier]
...
\begin{proposition}[Conditional secondary edge refines only the appendix
  product tail]
