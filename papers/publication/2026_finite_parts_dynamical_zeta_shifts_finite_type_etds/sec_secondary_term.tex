...
\begin{proposition}[Conditional finite edge skeleton under
  ...
  \begin{equation}\label{eq:secondary-edge-inverse}
    ...
    \quad(\pi\neq\mathbf 1).
  \end{equation}
  Hence this secondary correction, only under the conditional
...
\begin{proposition}[Conditional refinement above the square-root
  barrier]
...
\begin{proposition}[Conditional secondary edge refines only the
  product tail]
...
\begin{corollary}[Conditional detection of the dominant
  secondary modulus]
