...
\begin{theorem}[Secondary edge is a tail-only refinement of Main
  Theorem~II]
  ...
  \end{aligned}
  \end{equation}
  In particular the isolated secondary spectral edge changes neither the
  class Mertens constant \(\mathcal M_C(A,\tau;G)\) nor the
  Adams-corrected Euler-product constant \(K_C\); it only accelerates the
  finite-length remainder in the main theorem chain.
\end{theorem}
