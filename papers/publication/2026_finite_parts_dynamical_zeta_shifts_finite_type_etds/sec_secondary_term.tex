\section{Optional secondary spectral-edge refinement}
...
This appendix-level section is an optional refinement and is not used in Main
Theorem~I, Main Theorem~II, the Adams-obstruction criterion, or the
quotient-shadow results.  It is retained only to show that the same
finite-state machinery can read a first non-Perron spectral edge when an
additional separation hypothesis places that edge above the repeated-orbit
square-root barrier.
...
\begin{theorem}[Appendix refinement: secondary term above the square-root
  barrier]
