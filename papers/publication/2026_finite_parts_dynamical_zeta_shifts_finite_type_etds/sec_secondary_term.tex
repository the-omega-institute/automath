...
\begin{theorem}[Appendix-only conditional tail refinement above the
  square-root barrier]
  ...
  constants in Main Theorems~II--III, the tail series
...
\begin{proposition}[Appendix-only secondary edge refines only the
  ...
  without adding any determinant coordinate to the main theorem spine. For every conjugacy class
