...
This appendix is not part of the two-block main theorem spine.  It records a
...
\begin{proposition}[Appendix secondary term above the
  square-root barrier]
...
\begin{proposition}[Appendix secondary edge is a tail-only refinement of Main
  Theorem~II]
  ...
  \(K_C\) as in Main Theorem~II(b), with finite-length secondary
