...
This appendix is an optional sharpening, not a third main theorem. It
proves a conditional finite-dimensional refinement of the error term in
\Cref{thm:class-mertens-explicit}. Main Theorem~I supplies the
Adams--M\"obius primitive-channel recovery, and Main Theorem~II supplies
the class Mertens and Adams-corrected Euler-product constants.
...
expansion and contributes no Euler-product constant. The connection with
the main theorem chain is only the already-proved Peter--Weyl primitive
trace formula: the edge skeleton below records exactly what that formula
sees when a secondary spectral edge is isolated.
