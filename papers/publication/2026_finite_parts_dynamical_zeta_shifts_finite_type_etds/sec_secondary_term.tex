...
This appendix-level refinement is not part of the two-block theorem spine.  Main
...
product constants.  The refinement below is retained as a conditional
...
Without this separation hypothesis, this section asserts no additional
main theorem.  It may be omitted from a shorter symbolic-dynamics version
without changing Main Theorems~I--II, the quotient/shadow boundary, the
eta-gap rigidity statements, or the \(S_3\) obstruction certificates.  The
sole interface with the main theorem chain is the already-proved
...
\begin{theorem}[Optional appendix refinement: finite edge skeleton under
...
\begin{corollary}[Optional appendix refinement: detection of the dominant
  secondary modulus]
