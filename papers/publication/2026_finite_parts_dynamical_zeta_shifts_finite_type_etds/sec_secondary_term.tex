...
\begin{theorem}[Appendix edge skeleton under secondary separation]
...
\begin{theorem}[Appendix refinement: secondary term above the
  square-root barrier]
...
\begin{corollary}[Appendix detection of the dominant secondary modulus]
