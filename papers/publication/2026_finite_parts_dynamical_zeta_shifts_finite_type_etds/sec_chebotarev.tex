...
\begin{proof}
  ...
  determinant side, the finitely many \(rm=1\) non-trivial logarithms are
  regular by the twisted gap, and the tail \(rm\ge2\) is dominated by a
  constant multiple of
  \(\sum_{r,m\ge1,\,rm\ge2}\lambda^{1-rm}/(rm)\), which converges. Thus
  dominated convergence from \(z=t\lambda^{-1}\), \(0<t<1\), gives the
