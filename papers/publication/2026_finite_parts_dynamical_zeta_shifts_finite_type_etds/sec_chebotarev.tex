...
section all refer to the same finite construction rather than to an informal
chain of aliases.
...
decomposition of the regular representation; the point here is only its
application to the labelled adjacency operator.
