...
Detailed scalar questions such as holomorphic variation of \(\FP(A)\),
effective finite-observation certificates for its truncations, arithmetic
refinements of root-of-unity records, and growing-family estimates form a
separate scalar package.  They are not used as hidden inputs for
Main Theorems~I--III.
...
Consequently the present article does not promote scalar variation,
truncation, finite-IO, arithmetic, or growing-family statements to theorem
obligations.  The finite-group information in Main Theorems~I--III comes from
