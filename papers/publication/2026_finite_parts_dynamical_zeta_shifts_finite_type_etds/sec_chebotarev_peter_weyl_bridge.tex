...
\begin{corollary}[Main Theorem I(c): irreducible-channel determinant
  ...
  At Perron-boundary points in Main Theorems~II--III the determinant
  polynomials alone are not the data.  The branch-sensitive data tuple is
  ...
  coefficients and \(\mathfrak b\) records, for every boundary determinant
  summand, whether its logarithm is an Abel boundary branch, an interior-disc
  value, or the deleted scalar Perron branch.  All later assertions that
  constants are determined by determinant data mean this tuple, including the
  scalar normalisation and the verified strict gap.
