...
\begin{corollary}[Irreducible-channel determinant
  ...
  data.  The branch-sensitive renormalized boundary tuple is
  ...
  coefficients, \(\{B_{k,\pi}^{\mathrm{ren}}\}_{k\ge1,\pi}\) records the
  reduced Abel determinant finite parts at \(k=1\) and the ordinary interior
  determinant logarithms at \(k\ge2\), \(\Log_0\) is the determinant-logarithm
  germ normalized at \(0\) and continued along the stated Abel path or
  evaluated at interior points, and \(n_\partial\) records the
  scalar/product logarithm normalization.  The auxiliary quantities
  ...
  logarithm entries of \(\mathfrak D_{\partial}^{\mathrm{ren}}\).  The
  strict-gap record with \(\eta<\lambda\) is the specialization recovered in
