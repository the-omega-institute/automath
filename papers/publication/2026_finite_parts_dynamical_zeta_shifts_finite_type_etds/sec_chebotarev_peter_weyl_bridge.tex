...
Theorem~I.  The next theorem is the coefficient readout from the same
...
twisted trace, or determinant, package is exactly the input needed to use it.
...
\begin{corollary}[Finite trace interface for Main Theorem I(d)]
