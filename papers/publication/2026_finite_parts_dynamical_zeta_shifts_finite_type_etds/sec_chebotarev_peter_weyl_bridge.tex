...
\noindent
This is the coefficient-level form of Main Theorem~I, not an auxiliary
...
\begin{theorem}[Main Theorem I(e): class-count trace readout]
...
\begin{proof}
  By \Cref{thm:class-primitive-decomposition},
  \[
    p_{n,C}
    =
    \frac{|C|}{|G|}
...
and \Cref{thm:class-count-trace-readout} is the direct class-count
readout that feeds the class-Mertens constants of Main Theorem~II.
...
cor:primitive-peter-weyl-determinant,thm:primitive-peter-weyl-trace,%
