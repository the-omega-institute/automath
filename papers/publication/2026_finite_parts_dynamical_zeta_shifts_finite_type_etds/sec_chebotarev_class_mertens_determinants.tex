...
\begin{remark}[Classical leading terms]
  ...
  been separated.  The certificate and observation-budget corollaries are
  finite-coordinate rigidity statements for that already normalised constant
  vector, not additional Chebotarev asymptotic theorems.
\end{remark}
