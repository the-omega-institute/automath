...
\begin{proposition}[Auxiliary finite-tail scope control]
  \label{prop:main-chain-secondary-noninterference}
  Assume the hypotheses of \Cref{thm:class-mertens-explicit}.  Main
  Theorems~II--III depend only on the Perron-boundary determinant coordinates:
  adjoining any auxiliary finite lower-order tail satisfying the vanishing
  condition below leaves the class-Mertens constants, class-product constants,
...
\begin{remark}[Comparison with classical Mertens and Chebotarev
  ...
  The comparison with the classical and recent literature is summarized in
  \Cref{tab:novelty-calibration}.
\end{remark}
