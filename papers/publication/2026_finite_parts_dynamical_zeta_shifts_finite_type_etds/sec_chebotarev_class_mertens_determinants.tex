...
\begin{corollary}[Certificate-level audit of the product constants]
  ...
  \Cref{prop:fixed-label-perron-finite-algorithm}.  This is a certificate-support
  corollary for the finite fixed-label certificate interface, not an additional
  hypothesis in the main product spine.  The following finite audit is necessary
  and sufficient for the certificate records used in this paper.
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
