...
\begin{remark}[Branch conventions in the product formula]
  \label{cor:main-iii-branch-conventions}
...
\begin{proof}
  ...
  \Cref{cor:fixed-label-five-field-certificate-schema}: the appendix records the
  same finite rational fields in journal-facing form.  The concrete \(S_3\)
  obstruction in
