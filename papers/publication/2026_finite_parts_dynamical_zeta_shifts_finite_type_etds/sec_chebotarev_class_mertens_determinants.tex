...
\begin{corollary}[Finite verification of the product constants]
  ...
  \Cref{prop:fixed-label-perron-finite-algorithm}.  This is a finite-verification corollary for the fixed-label determinant interface, not an additional hypothesis in the main product spine.  The following finite checks are necessary and sufficient for the certificate records used in this paper.
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
...
\begin{proof}
  ...
  product-level verification statement and its equivalence with the appendix finite records.
\end{proof}
