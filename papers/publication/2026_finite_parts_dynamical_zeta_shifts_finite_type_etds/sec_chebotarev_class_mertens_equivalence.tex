...
\begin{proof}
  ...
  the product theorem.  In particular, it is not an evaluation of the singular
...
\begin{lemma}[Sign and normalisation conventions for \texorpdfstring{$K_C$}{KC}]
  ...
  the product bracket, and the scalar reduced-determinant term enters as
  \(+\log C(A)\) only after the scalar product tail has been combined with
  the additive normalisation \(\mathcal M(A)=\gamma+\FP(A)\).  The outer sign
  is the single minus sign coming from
