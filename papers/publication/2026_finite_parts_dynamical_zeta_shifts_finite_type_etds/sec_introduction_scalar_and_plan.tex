...
\Cref{sec:finite-part} isolates the scalar finite part needed for the
trivial-channel normalization.  The canonical cyclic-lift and scalar boundary
material is kept in the appendices as fixed-matrix comparison only, not as an
input to the finite-group determinant inversion.
...
article.  \Cref{app:cyclic-lift-comparison,app:scalar-boundaries} contain only
scalar normalization and comparison material.  The \(S_3\) appendices
