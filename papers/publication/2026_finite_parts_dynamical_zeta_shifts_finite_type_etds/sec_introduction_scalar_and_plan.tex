...
described once in the dependency table.  The final appendix records conditional
secondary-edge material after the main constants have been proved; its only
connection with the theorem spine is the non-interference statement
\Cref{prop:main-chain-secondary-noninterference}, and it is not used in the
