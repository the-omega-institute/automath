...
\begin{proposition}[Finite determinant recovery of primitive class counts]
  \label{prop:main-theorem-i-assembly-map}
  The following implications prove the primitive determinant recovery without any use of
