...
Secondary-edge asymptotics are likewise downstream from the three main theorems
and are not used to identify any constant; the body records the
non-interference gate \Cref{prop:main-chain-secondary-noninterference}, while
the sharper tail expansion is presented only as auxiliary conditional material.
