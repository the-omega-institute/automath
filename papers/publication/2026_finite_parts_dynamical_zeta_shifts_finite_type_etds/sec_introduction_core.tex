...
\begin{proposition}[Finite-dimensionality of the main transfer data]
  ...
  chain does not require an infinite-dimensional transfer-operator extension,
  completed-zeta normalisation, functional equation, secondary spectral-tail
  theorem, formalisation layer, or sibling universality/certificate result.
\end{proposition}
\begin{proof}
  ...
  proposition.  None invokes an infinite-dimensional transfer operator, a
  completed zeta function, a functional equation, a secondary spectral-tail
  theorem, or a sibling universality/certificate construction, so no such
  theorem is a hidden input to Main Theorems~I--III.
\end{proof}
