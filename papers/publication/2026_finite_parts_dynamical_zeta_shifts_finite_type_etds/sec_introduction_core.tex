...
requires no infinite-dimensional transfer-operator extension, completed-zeta
  ...
  non-abelian root-layer reconstruction, sibling universality result, or
  general certificate infrastructure.
...
The same firewall applies to sibling projects.  Cyclic-block Fredholm
realisation, synchronisation-kernel completed determinants, endpoint-jet or
large-parameter expansions, and automata-prime zeta dichotomies are not local
theorems of this manuscript.  When scalar determinant identities are used below,
they are used only in the fixed-matrix normalisation needed for the finite-group
