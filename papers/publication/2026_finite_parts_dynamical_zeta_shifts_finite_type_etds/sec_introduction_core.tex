...
cyclic-block, synchronisation-kernel, completed-determinant, automata-density,
and prime-language results are not locally reproved; secondary spectral-edge
asymptotics enter only through the noninterference firewall
\Cref{prop:main-chain-secondary-noninterference}; and scalar cyclic-lift
reconstruction remains an appendix comparison tool for the fixed matrix \(A\),
not a second main theorem chain.
\end{proposition}
\begin{proof}
