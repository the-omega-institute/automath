...
calculations, and the finite rational verifications in the appendices are support
...
comparison model.  The retained finite-tail non-interference statement
\Cref{prop:main-chain-secondary-noninterference} is likewise auxiliary: it
only records that later lower-order refinements cannot change the constants.
None of these packages provides another route to the finite-group product
constants or adds a hypothesis to Main Theorems~I--III.  Thus the proofs of Main
...
follows.  Main Theorem~I is proved by the trace identity, finite Peter--Weyl
linearisation, and Adams--M\"obius primitive inversion summarized in
