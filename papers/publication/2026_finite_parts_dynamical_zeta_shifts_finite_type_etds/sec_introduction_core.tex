...
calculations, the finite certificates in the appendices, and the optional
secondary-edge refinement are support material only.  The scalar calculation
supplies the trivial-channel value \(\mathcal M(A)\); the canonical cyclic lift
is a fixed-matrix comparison model; the secondary appendix concerns
finite-length remainders after the constants have been identified.  None of
these packages provides another route to the finite-group product constants or
