...
comparison model.  Conditional secondary-edge refinements are split out of the
...
Secondary-edge asymptotics are treated only as a split refinement of the tail
after the constants have been identified; the retained finite-length
comparison is not a fourth main theorem.
