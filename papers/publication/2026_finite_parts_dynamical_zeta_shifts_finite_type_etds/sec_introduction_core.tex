...
\paragraph{Proof guide.}
  ...
  are not part of the main theorem chain; in particular, no secondary-edge
  skeleton, isolation theorem, or dominant-modulus detection statement is used
  below.  The core protection against leakage is the finite-tail
