...
\(F_\varrho(\lambda^{-1})\), or \(K_C\). Thus the proofs of Main
Theorems~I--III use only finite-matrix determinant identities, finite-group
character orthogonality, Adams--M\"obius inversion, and Perron--Frobenius
theory for finite non-negative matrices.  Infinite-dimensional transfer
operators, completed determinant normalisations, and broader strict-gap or
inverse-spectral classification problems require additional hypotheses and are
not premises of the finite-state theorem chain proved here.
