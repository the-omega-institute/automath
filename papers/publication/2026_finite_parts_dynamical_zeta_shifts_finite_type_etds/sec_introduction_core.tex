...
\begin{proposition}[Finite-dimensional transfer split]
  ...
  equation, or a spectral-window continuation theorem.  Those possible
  extensions are deliberately not used as citations, hypotheses, or auxiliary
  theorem packages in this paper.
\end{proposition}
\begin{proof}
...
This is only a firewall around the main constants, not a fourth main theorem
