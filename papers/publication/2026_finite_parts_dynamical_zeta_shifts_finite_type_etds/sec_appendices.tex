...
the normalisation and comparison statements in the main text.  The
determinant identities, M\"obius inversion on multiples, and one-layer
Fourier calculations are useful fixed-matrix tools, while the main
finite-group results rely on the scalar reduced constant, the multiple-sum
identity, and the branch-lifted comparison record.

The remaining appendices are organized as follows.
\begin{center}
\begin{tabular}{@{}L{0.30\textwidth}L{0.25\textwidth}L{0.35\textwidth}@{}}
\toprule
Appendix material & Topic & Use in the paper \\
\midrule
\Cref{app:cyclic-lift-package}
& Scalar normalisation and fixed-matrix comparison
& Supplies reduced-determinant and cyclic-lift calculations. \\
\Cref{app:scalar-boundaries}
& No-descent boundaries
...
& Conditional secondary edge
& Refines remainders under extra secondary-edge separation, without
changing the constants of Main Theorems~I--III. \\
\bottomrule
\end{tabular}
\end{center}
