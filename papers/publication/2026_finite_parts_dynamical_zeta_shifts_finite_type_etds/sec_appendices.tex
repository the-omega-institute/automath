...
Holomorphic variation formulas for \(A_\theta\) and effective
truncation bounds for \(\FP(A)\) are scalar computational refinements;
they are not used in the finite-group Adams--M\"obius theorem chain and
are left to a separate scalar finite-part treatment. No inverse theorem
on an ambient parameter space is claimed here.
