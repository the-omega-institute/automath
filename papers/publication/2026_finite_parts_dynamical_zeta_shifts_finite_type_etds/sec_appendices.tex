...
the normalisation and comparison statements in the main text.  It is retained
as appendix-only support; its reconstruction statements are fixed-matrix scalar
facts, not additional finite-group class-product theorems.  Its
...
records.  A broader cyclic-lift inverse-spectral theory would require a
separate paper.  In particular, a shortened submission may split this appendix
off after citing only the scalar normalisation, the canonical cyclic-lift
multiple-sum identity, and the fixed-matrix branch comparison; no proof of
Main Theorems~I--III below uses the appendix as an independent source of
non-trivial class-product coordinates.
...
\begin{corollary}[Appendix support does not descend to class-product
  coordinates]
  \label{cor:cyclic-lift-fixed-matrix-no-class-descent}
