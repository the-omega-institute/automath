...
The following scalar variation theorem records what is actually needed
if the trivial-channel normalisation is evaluated in a local parameter
family. It is a local holomorphic dependence statement for the same
finite part \(\FP(A)\), not an inverse theorem on an ambient parameter
space.
