...
The appendix does not assert cyclic-block Fredholm, synchronisation-kernel,
completed-determinant, endpoint-jet, large-parameter, or automata-zeta theorem
families; it retains only the finite scalar identities needed for comparison
and fixed-matrix normalisation in this article.
