...
the final finite-sum windows. The short script
\texttt{certificates/s3\_log\_certificates.py} reproduces the same
rational interval arithmetic; it is a reproducibility aid, while the
