...
role.  The cyclic-lift checks, scalar boundary records, and \(S_3\)
certificates are therefore local support for the finite-state
Adams--M\"obius argument, not a parameter-family, inverse-problem, or
computational-catalogue article nested inside this one.
\begin{center}
