...
\begin{proposition}[Auxiliary fixed-matrix formula for the reduced
...
\begin{proposition}[Auxiliary fixed-matrix multiple-sum expansion for
...
\begin{lemma}[Auxiliary fixed-matrix absolute convergence for multiples
  inversion]
...
\begin{proposition}[Auxiliary fixed-matrix M\"obius inversion on multiples]
...
\begin{lemma}[Auxiliary fixed-matrix branch ambiguity in multiples
  inversion]
...
\begin{lemma}[Auxiliary fixed-matrix limsup of a finite exponential sum]
...
\begin{theorem}[Auxiliary classical fixed-matrix scalar normalisation:
  fixed-layer Fourier recovery]
