...
for non-abelian primitive class data, cross-resolution invariants, or
fold-stable scalar records; that information would require extra
structure not present in this paper.  The non-trivial class information
used here comes only from the finite-group determinant and
Adams--M\"obius machinery in the main text.
...
Adams--M\"obius argument, not a parameter-family, inverse-problem,
reduced-spectrum identifiability, or computational-catalogue article nested
inside this one.
\begin{center}
