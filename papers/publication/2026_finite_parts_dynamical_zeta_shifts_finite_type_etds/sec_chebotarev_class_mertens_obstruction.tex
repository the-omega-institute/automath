...
\begin{theorem}[Finite determinant readout for Main Theorem III]
  ...
  proof spine is lossless and exhaustive for the non-classical part of
  the product theorem.
  ...
  \end{enumerate}
  Thus the Main Theorem~III proof spine is a single finite coordinate readout rather than a
  collection of independent invariants: fixed-label determinant coordinates
  ...
  and scalar context; the new lossless coordinate readout is the internal
...
\begin{proof}
  ...
  product branch, while all non-trivial coordinates are left to the internal
  fixed-label calculation.  This separation is part of the assertion: changing
