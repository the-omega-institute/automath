...
\begin{theorem}[Finite determinant certificate chain for Main Theorem III]
  ...
  dependency chain is lossless and exhaustive for the non-classical part of
  the product theorem.
  ...
  \end{enumerate}
  Thus the Main Theorem~III chain is a single finite certificate rather than a
  collection of independent ledgers: fixed-label determinant coordinates
  ...
  and scalar context; the new lossless coordinate certificate is the internal
