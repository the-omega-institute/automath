...
class-Mertens spine.  The appendix verifies one finite obstruction witness,
...
not a theorem-level main result; all source references use the label
\Cref{prop:quadratic-adams-obstruction} accordingly.
