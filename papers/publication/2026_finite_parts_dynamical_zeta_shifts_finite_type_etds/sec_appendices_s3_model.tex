...
\begin{equation}\label{eq:s3-character-table}
  ...
  \end{array}
\end{equation}
where \(\varepsilon\) is the sign character and \(\varrho_{\mathrm{std}}\) the standard
two-dimensional representation. In this \(S_3\) example only, \(\varrho_{\mathrm{std}}\)
...
\begin{corollary}[Primitive profile and deviations for the
  ...
  \begin{equation}\label{eq:s3-example-primitive-classes}
    \begin{aligned}
      p_{n,e}
      &=\frac{p_n(A)+\pi_{n,\varepsilon}(A,\tau)+2\pi_{n,\varrho_{\mathrm{std}}}(A,\tau)}{6}, \\
      p_{n,T}
      &=\frac{p_n(A)-\pi_{n,\varepsilon}(A,\tau)}{2}, \\
      p_{n,K}
      &=\frac{p_n(A)+\pi_{n,\varepsilon}(A,\tau)-\pi_{n,\varrho_{\mathrm{std}}}(A,\tau)}{3}.
    \end{aligned}
  \end{equation}
  where
  ...
  \[
    ...
    p_{n,e}
      &=\frac{1}{6}\bigl(p_n(A)+\pi_{n,\varepsilon}(A,\tau)
        +2\pi_{n,\varrho_{\mathrm{std}}}(A,\tau)\bigr),\\
    p_{n,T}
      &=\frac{3}{6}\bigl(p_n(A)-\pi_{n,\varepsilon}(A,\tau)
        +0\cdot\pi_{n,\varrho_{\mathrm{std}}}(A,\tau)\bigr),\\
    p_{n,K}
      &=\frac{2}{6}\bigl(p_n(A)+\pi_{n,\varepsilon}(A,\tau)
        -\pi_{n,\varrho_{\mathrm{std}}}(A,\tau)\bigr),
    \end{aligned}
  \]
