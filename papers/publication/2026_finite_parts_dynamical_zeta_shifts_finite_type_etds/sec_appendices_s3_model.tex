...
keep the quotient-shadow package from obscuring the Adams--M\"obius
...
not a theorem-level main result; all references use the label
\Cref{prop:quadratic-adams-obstruction} accordingly.  The theorem-style
label is retained only as a stable alias for earlier synopsis tables.
