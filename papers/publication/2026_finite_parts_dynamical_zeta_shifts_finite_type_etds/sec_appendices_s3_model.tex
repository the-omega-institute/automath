...
not a catalogue or classification of small non-abelian examples.  This is the
paper\'s chosen certificate policy: exhaustive rational details remain here
for reproducibility, while the main text imports only the resulting windows.
