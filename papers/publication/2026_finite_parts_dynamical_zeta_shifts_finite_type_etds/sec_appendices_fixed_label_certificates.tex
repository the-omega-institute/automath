\section{Finite fixed-label certificate records}

This appendix records the protocol-level finite certificate formats used by
...
\(S_3\) certificate auditable without adding a fourth main theorem chain.
