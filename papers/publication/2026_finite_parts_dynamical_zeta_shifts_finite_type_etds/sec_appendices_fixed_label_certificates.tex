...
They follow the same exhaustive-appendix policy as the \(S_3\) logarithm
certificates: reproducibility details are retained here, while the main text
uses only the stated finite windows.
