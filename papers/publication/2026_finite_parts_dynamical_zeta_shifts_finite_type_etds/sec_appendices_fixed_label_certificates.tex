...
main theorem chain or to a general certified-computation framework for arbitrary
finite groups.  In particular, the records support the fixed \(S_3\)
Adams-obstruction certificate and do not define an inverse spectral invariant.
...
\begin{proposition}[Finite record for certified Perron enclosures]
...
\begin{corollary}[Five-field \texorpdfstring{\(S_3\)}{S3} rational record]
  ...
  assumptions or a general certificate theory.
\end{corollary}
