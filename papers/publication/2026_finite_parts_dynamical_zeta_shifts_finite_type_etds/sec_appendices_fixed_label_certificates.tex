\section{Appendix: local finite certificate records for the \texorpdfstring{\(S_3\)}{S3} witness}

This appendix records the local finite certificate formats used by
...
\(S_3\) certificate auditable.  They are not promoted to a fourth main
theorem chain or to a general certification framework for arbitrary finite
groups.
