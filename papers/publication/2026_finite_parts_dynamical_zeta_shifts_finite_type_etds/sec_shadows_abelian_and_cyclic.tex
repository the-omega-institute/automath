...
\begin{corollary}[Cyclic quotient observables]
  ...
  In particular, under the hypotheses of \Cref{thm:class-mertens-explicit}, the
  full primitive class profile at the Perron point is generated by cyclic
  quotient shadows if and only if
