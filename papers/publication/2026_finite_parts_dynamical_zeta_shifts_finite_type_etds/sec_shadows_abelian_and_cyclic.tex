...
\Cref{sec:finite-part}; no root-of-unity arithmetic, cyclic sampling, or
reconstruction theorem for fixed-matrix scalar records or non-abelian sectors
is being asserted here.  Any higher-dimensional replacement for cyclic
observables is therefore treated as separate shadow theory, not as part of the
present detection boundary.
