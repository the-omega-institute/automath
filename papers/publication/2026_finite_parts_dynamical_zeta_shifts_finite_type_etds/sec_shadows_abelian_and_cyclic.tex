...
\Cref{sec:finite-part} instead supplies only the scalar root-of-unity
comparison model.  No enriched non-abelian root-layer record or
higher-dimensional sampling theorem is used in this article.
