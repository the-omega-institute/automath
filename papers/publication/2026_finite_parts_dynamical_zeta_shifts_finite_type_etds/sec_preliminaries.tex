...
This short subsection fixes only the canonical fixed-matrix comparison notation
used later in the scalar/no-descent boundary; it is not a reconstruction
theme of the article.  For \(q\ge 1\) let \(P_q\) be the \(q\)-cycle permutation matrix and
