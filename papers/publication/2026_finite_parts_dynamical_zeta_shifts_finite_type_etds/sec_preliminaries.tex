...
\(\chi_\sigma(C)\). We do not identify \(\chi(C)\) with \(\chi^\ast(C)\)
...
\begin{definition}[Fixed-matrix cyclic-lift records]
  ...
  cocycle unless additional descent information is supplied.
\end{definition}
