...
\(\overline{\chi_\varrho(C)}\). By unitarity,
\(\overline{\chi_\varrho(C)}=\chi_\varrho(C^{-1})\), so any inverse-class
notation below is only a restatement of this conjugation. We do not
collapse the unconjugated class value to its inverse-class value unless
