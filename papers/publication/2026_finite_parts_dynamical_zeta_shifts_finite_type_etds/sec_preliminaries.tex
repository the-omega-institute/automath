...
\begin{definition}[Fixed-matrix cyclic-lift records]
  ...
  In the auxiliary fixed-matrix cyclic-lift comparison, the
  ...
  particular, the label records fixed-matrix data only; it does not name
  a fold-aware, stable, or cross-resolution invariant obtained by naive
  truncation.
\end{definition}
