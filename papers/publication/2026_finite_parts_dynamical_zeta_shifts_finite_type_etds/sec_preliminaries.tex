...
as \(0\).  The primary boundary data in the paper do not require this
strict exclusion of non-trivial Perron-boundary channels.  Instead
...
and the finite semisimplicity certificate for the twisted boundary blocks.
...
\begin{proposition}[Preliminary finite-state determinant support data]
...
The following objects form the preliminary finite-state support data used
  ...
  \(\Lambda_\perp\), \(\Lambda_\partial\), the finite semisimplicity
  certificate, reduced determinant finite-part branch tags, and scalar
  ...
  \Cref{thm:renormalized-finite-data-determination}.  The old
...
\begin{proof}
  ...
  they require the peripheral lists, semisimplicity certificate, reduced
  finite-part branch tags, and scalar normalization recorded in
  \(\mathfrak D_{\partial}^{\mathrm{ren}}(A,\tau;G)\).  With those
  additions, \Cref{thm:renormalized-finite-data-determination} determines
