...
cocycle.  The optional secondary spectral-edge appendix is downstream from the
main finite-group spine; its only role in the body is the non-interference gate
\Cref{prop:main-chain-secondary-noninterference}, which says that auxiliary
compensated tails satisfying the stated vanishing condition cannot change
...
theorems and are not used to identify any constant; the body records only the
non-interference gate \Cref{prop:main-chain-secondary-noninterference}, while
any sharper tail expansion is confined to the optional appendix.
...
\paragraph{Proof guide.}
  ...
  isolation statement, or dominant-modulus detection result remains confined to
  the optional appendix and supplies no hypothesis or constant used by Main
  Theorems~I--III.
