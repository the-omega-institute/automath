...
from \Cref{thm:class-euler-product-mertens,prop:fixed-label-determinant-perron,prop:fixed-label-certificate-manuscript-scope,prop:class-product-comparison,thm:adams-obstruction-class-product}; the concrete \(S_3\) obstruction is
certified by \Cref{prop:s3-naive-artin-obstruction,lem:s3-example-perron-certificates,lem:appendix-s3-f-level-certificates} through the same manuscript-level finite interface and
...
\begin{proof}
  ...
  transform.  \Cref{prop:fixed-label-determinant-perron,prop:fixed-label-certificate-manuscript-scope,thm:class-product-determinant-rigidity,prop:class-product-comparison,cor:class-product-hyperplane-stability,cor:class-product-artin-obstruction-recovery,cor:assembled-adams-frobenius-product-formula,thm:adams-obstruction-class-product} prove, respectively, determinant
  recovery at the Perron point, the manuscript-level finite certificate
  interface, finite product-constant recovery, comparison with the classical
  Frobenius-class product input, hyperplane stability, scalar-baseline and Artin-coordinate
