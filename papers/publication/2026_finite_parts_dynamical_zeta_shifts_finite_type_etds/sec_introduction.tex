...
cocycle.  Secondary spectral-edge refinements are deliberately split from
this article: the retained finite-state statement
\Cref{prop:main-chain-secondary-noninterference} proves that any such
compensated tail with vanishing contribution cannot change
...
chain.  Secondary-edge asymptotics are likewise downstream material for a
separate refinement paper; here they appear only through the non-interference
gate \Cref{prop:main-chain-secondary-noninterference}.
...
described once in the dependency table.  Full secondary-edge refinements are
not part of these appendices; the main text retains only the scope-control
statement \Cref{prop:main-chain-secondary-noninterference}.
