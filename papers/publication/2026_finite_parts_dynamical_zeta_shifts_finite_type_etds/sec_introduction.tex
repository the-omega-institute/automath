...
\end{theorem}
\begin{proof}
  This synopsis statement is proved in the body by
  ...
  the present paragraph only assembles those labelled statements.  More
  precisely, it is the conjunction of the finite trace identity, determinant
...
\begin{proof}
  ...
  the present paragraph records the assembly from those body statements.  The
  asymptotic and the displayed constant are proved in
