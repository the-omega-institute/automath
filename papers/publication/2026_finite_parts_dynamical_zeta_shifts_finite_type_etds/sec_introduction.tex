...
material rather than a second route to the product constants.  The scalar calculation
...
is not an invariant of arbitrary cyclic quotients of the cocycle.  The
  secondary spectral-edge refinement in \Cref{sec:secondary-term} is
  not used in Main Theorems~I--III: it assumes additional spectral separation
...
paper.  Nor do we use completed zeta functions, functional equations,
Fredholm/Witt cyclic-block packages, or synchronisation-kernel determinants;
those belong to separate determinant-normalisation problems.
...
\begin{proof}
  ...
  and the quantitative zero-mean obstruction.  These results prove
