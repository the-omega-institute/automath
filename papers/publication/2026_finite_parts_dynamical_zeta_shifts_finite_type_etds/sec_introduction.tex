...
described once in the dependency table.  The final appendix is optional
conditional secondary-edge material after the main constants have been proved;
its only connection with the theorem spine is the non-interference statement
\Cref{prop:main-chain-secondary-noninterference}, so it can be omitted without
changing Main Theorems~I--III.
