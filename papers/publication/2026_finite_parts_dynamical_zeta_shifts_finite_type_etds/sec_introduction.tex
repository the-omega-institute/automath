...
cor:class-product-hyperplane-stability,%
  ...
  thm:adams-obstruction-class-product}; the
following paragraph assembles exactly those body results and no appendix
refinement.
...
\begin{proof}
  ...
  These results prove
  the displayed formula and its classwise Artin-substitution obstruction.
\end{proof}
