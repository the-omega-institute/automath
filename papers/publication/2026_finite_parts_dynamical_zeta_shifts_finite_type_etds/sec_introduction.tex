...
\Cref{thm:main-spine-secondary-noninterference} records that any finite
...
\Cref{sec:secondary-term} is an application of that non-interference remark,
...
\paragraph{Proof guide.}
  ...
  protection against leakage is the finite-tail non-interference remark
