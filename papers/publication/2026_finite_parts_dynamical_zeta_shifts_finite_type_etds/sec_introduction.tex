...
is not an invariant of arbitrary cyclic quotients of the cocycle.  Possible
secondary spectral-edge refinements are not used here: they would assume
additional spectral separation and would refine only post-constant error
terms, not \(\Pi_\varrho(\lambda^{-1})\),
...
\Cref{app:s3-model-computations,app:s3-log-certificates} give the finite
  ...
  obstruction.  Conditional secondary-edge tail refinements are recorded as a
  split candidate rather than included in the theorem chain of this article.
