...
\Cref{thm:secondary-edge-isolation,cor:secondary-only-exported-consequence,cor:class-secondary-term-detects-spectrum},
...
package through
\Cref{thm:class-mertens-secondary-term,thm:secondary-edge-isolation,cor:secondary-only-exported-consequence,cor:class-secondary-term-detects-spectrum}
...
\end{theorem}
\begin{proof}
  This is precisely \Cref{prop:main-theorem-i-assembly-map}, which proves that the listed trace,
...
\end{theorem}
\begin{proof}
  The body results \Cref{thm:class-mertens-explicit,prop:class-mertens-deviations,thm:class-mertens-fourier} prove the displayed asymptotic, the class constants, and the Hermitian
...
\end{theorem}
\begin{proof}
  The body package headed by \Cref{thm:class-euler-product-mertens,thm:class-product-determinant-rigidity,thm:adams-obstruction-class-product} proves the displayed fixed-label product formula, determinant recovery of
...
\paragraph{Proof guide.}
  ...
  and no new Euler-product constant.  The conditional appendix proves the corresponding secondary-tail expansion, isolation theorem, and dominant modulus detection corollary; \Cref{cor:secondary-only-exported-consequence} records that these results supply no hypothesis or constant used by Main Theorems~I--III.
