...
thm:primitive-peter-weyl-trace,thm:class-count-trace-recovery}.  Main
Theorem~II adds the strict Perron-point gap, whose finite certificate and
Perron-disc analytic separation are
...
\begin{proposition}[Finite-dimensional transfer split]
  ...
  \item The passage from periodic determinant data to primitive
    ...
    thm:class-count-trace-recovery}.
...
\begin{proof}
  ...
  trace recoverys in Main Theorem~I are precisely
  \Cref{cor:primitive-peter-weyl-determinant,cor:primitive-peter-weyl-trace,%
  thm:class-count-trace-recovery}, all of which use only the finite character
...
The following table summarizes how the three headline results use the
classical dynamical-zeta and symbolic-dynamics background cited above, and
where the finite-state contribution of this paper begins.
  \begin{center}
  ...
  & The secondary appendix is conditional support material; it supplies no
    input to Main Theorems~I--III and contributes no additional product
    constant. \\
  \bottomrule
  \end{tabular}
  \end{center}
...
the classical kind.  Its new contribution is the finite-state
...
The first row uses the cited literature in the following way.  The
  ...
  For the second row, the leading density term is
  \((|C|/|G|)\lambda^n/n\); the present argument then isolates the constant
  term by subtracting the scalar harmonic contribution and inserting the
  non-trivial primitive channels at \(z=\lambda^{-1}\).  Parry--Pollicott and Noorani--Parry are
  ...
  prop:secondary-refinement-supporting-classification} show that the conditional
...
\Cref{lem:twisted-trace-identity,thm:class-function-linearisation,%
cor:class-function-adams-mobius,cor:primitive-peter-weyl-determinant,%
thm:primitive-peter-weyl-trace,thm:class-count-trace-recovery}; the following
...
\begin{proof}
  ...
  \Cref{lem:twisted-trace-identity,thm:class-function-linearisation,%
  cor:class-function-adams-mobius,cor:primitive-peter-weyl-determinant,%
  thm:primitive-peter-weyl-trace,thm:class-count-trace-recovery}.
...
\Cref{prop:main-chain-secondary-noninterference} records that any finite
...
cor:class-product-hyperplane-stability,%
  cor:class-product-artin-obstruction-recovery,%
  cor:assembled-adams-frobenius-product-formula,%
...
Peter--Weyl skeleton and a Parseval obstruction bound.  They are used below
...
\paragraph{Proof guide.}
  ...
  thm:class-count-trace-recovery}.  Main Theorem~II is proved by
  \Cref{thm:class-mertens-explicit,prop:class-mertens-deviations,%
  ...
  \Cref{prop:main-chain-secondary-noninterference}.  Under the extra
  hypotheses \(R>\lambda^{1/2}\) and \(\Gamma_{\mathrm{sec}}<R\), the
  conditional refinement \Cref{prop:class-mertens-secondary-term,prop:secondary-edge-isolation,%
...
\begin{proof}
  ...
  needed later in
\Cref{thm:class-mertens-explicit,cor:assembled-adams-frobenius-product-formula,%
...
described once in the dependency table.  \Cref{app:cyclic-lift-comparison,app:scalar-boundaries}
support the scalar finite-part and cyclic-lift comparisons used around the
finite-part normalisation.  \Cref{app:s3-model-computations,%
