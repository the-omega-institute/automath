...
Theorem~II adds the strict Perron-point gap, whose finite certificate and
Perron-disc analytic firewall are
\Cref{prop:eta-gap-finite-state-certificate,prop:eta-gap-perron-firewall},
and is proved by
...
from \Cref{thm:class-euler-product-mertens,prop:fixed-label-determinant-perron,%
    prop:class-product-comparison,thm:adams-obstruction-class-product}; the concrete \(S_3\) obstruction is
...
\begin{proof}
  ...
  trace readouts in Main Theorem~I are precisely
  \Cref{cor:primitive-peter-weyl-determinant,cor:primitive-peter-weyl-trace,%
  thm:class-count-trace-readout}, all of which use only the finite character
  ...
  hypothesis, \Cref{thm:class-mertens-explicit,prop:class-mertens-deviations,%
  thm:class-mertens-fourier} give the additive class constants from the same
  determinant logarithms, while
  \Cref{thm:class-euler-product-mertens,prop:fixed-label-determinant-perron,%
  prop:class-product-comparison,thm:adams-obstruction-class-product} give the
...
\begin{proof}
  ...
  product constants, and supplies the obstruction criterion; the formal
  classical/new separation is the scalar-normalised comparison theorem
  \Cref{prop:class-product-comparison}.  Finally, Coles,
...
\begin{theorem}[Main Theorem III: Adams-corrected Frobenius-class Euler-product constants]
  ...
  Peter--Weyl boundary is a minimal coordinate skeleton only for the
  scalar-normalised product constants in fixed determinant coordinates:
...
The product constants are unaffected by later secondary-edge refinements:
\Cref{prop:main-spine-secondary-noninterference} records that any finite
...
\Cref{sec:secondary-term} is an application of that non-interference proposition,
...
\Cref{cor:class-product-minimal-obstruction-skeleton,cor:adams-obstruction-budget}
then package the already proved constants into a fixed-coordinate
Peter--Weyl skeleton and a Parseval obstruction budget.  They are used below
only as structural readouts and finite-witness interfaces for the
scalar-normalised product constants, not as observation-system minimality
claims or as additional members of the locked Main Theorem~III label set.
...
\paragraph{Proof guide.}
  ...
  strict-gap hypothesis fails; its one-dimensional loop-character and
  ...
  mechanisms for product constants.

  The conditional secondary refinement in
  \Cref{sec:secondary-term} is downstream from this proof guide.  The core
  protection against leakage is the finite-tail non-interference proposition
  \Cref{prop:main-spine-secondary-noninterference}.  Under the extra
  hypotheses \(R>\lambda^{1/2}\) and \(\Gamma_{\mathrm{sec}}<R\), the
  appendix-only refinement \Cref{thm:class-mertens-secondary-term,thm:secondary-edge-isolation,%
  ...
  statements are presented as a conditional appendix refinement, not as
  coequal novelty with the finite-group product theorem, and do not supply any
