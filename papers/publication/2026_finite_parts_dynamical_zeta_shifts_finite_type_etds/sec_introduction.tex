...
cocycle.  Secondary spectral-edge refinements are deliberately not part of the
theorem spine: \Cref{prop:main-chain-secondary-noninterference} proves that
any such compensated tail with vanishing contribution cannot change
...
\(F_\varrho(\lambda^{-1})\) unchanged.  Such refinements are therefore
split-paper material rather than a fourth main theorem in this article.
...
\paragraph{Proof guide.}
  ...
  Secondary spectral-edge refinements are downstream from this proof guide.
  ...
  and no new Euler-product constant.  A detailed secondary-edge asymptotic
  theory is consequently split-paper material and supplies no hypothesis or
...
Artin-substitution obstruction in Main Theorem~III.  Secondary-edge tail
refinements are intentionally excluded from the compiled appendix package;
their only retained interface is the non-interference statement in
