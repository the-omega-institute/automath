...
\paragraph{Proof guide.}
  ...
  \Cref{sec:secondary-term} is downstream from this proof guide.  Under the
  extra hypotheses \(R>\lambda^{1/2}\) and
  \(\Gamma_{\mathrm{sec}}<R\),
  \Cref{thm:class-mertens-secondary-term,thm:secondary-edge-isolation,%
  cor:class-secondary-term-detects-spectrum} isolate the first finite
  spectral edge below \(\lambda\), identify its vanishing product tail, and
  show how the classwise pointwise remainders detect its modulus.  These
