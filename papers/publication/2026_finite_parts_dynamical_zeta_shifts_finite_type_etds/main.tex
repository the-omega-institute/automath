...
\(\eta<\lambda\), the channels have Perron-point values and give
  ...
  asymptotic form, including the exponent \(|C|/|G|\), is classical; the
  contribution here is the branch-compatible Adams-corrected determinant
  readout of the constant after the scalar Perron channel has been separated.
