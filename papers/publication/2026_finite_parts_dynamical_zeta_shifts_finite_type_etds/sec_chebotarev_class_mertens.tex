...
recovery format and the classical
...
\Cref{cor:class-product-artin-obstruction-recovery,%
thm:adams-obstruction-class-product,cor:adams-obstruction-bound,%
...
\begin{proof}
  ...
  thm:class-count-trace-recovery} recover all primitive Peter--Weyl
...
prop:s3-two-coordinate-product-obstruction-vector,%
...
\begin{proposition}[Finite certificate protocol for Perron recovery]
