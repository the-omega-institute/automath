...
fixed-label Perron values from the twisted determinant package.  The
finite-determinant readout is isolated in
\Cref{thm:class-product-determinant-rigidity}.  Its hyperplane/stability
classification and Artin-substitution consequences are separated into
\Cref{cor:class-product-hyperplane-stability,%
cor:class-product-artin-obstruction-readout}; quotient-shadow statements
then use these readouts rather than introducing additional constants.
...
\begin{theorem}[Finite-determinant readout for Adams-corrected constants]
  ...
  \Cref{prop:fixed-label-determinant-perron}.  More concretely, for
  \(M\ge1\) set
...
\begin{proposition}[Finite-data readout for the main theorem spine]
  ...
  readout statement from the determinant and branch-audited formulas already
