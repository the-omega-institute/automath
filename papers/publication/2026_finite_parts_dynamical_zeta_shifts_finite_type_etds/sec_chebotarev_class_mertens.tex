...
\Cref{prop:fixed-label-perron-finite-algorithm,prop:class-product-q-minus-one-observation-rigidity,thm:class-product-comparison} then separates the certified finite
...
\begin{proposition}[Sharp class-observation budget for the product vector]
  ...
  \end{equation}
  the following extremal statement holds.
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
  ...
  \end{enumerate}
  Thus the classwise constant vector has an exact finite observation budget:
