...
\begin{theorem}[Main Theorem III: Adams-corrected Frobenius-class
  ...
  exponent and existence statement, while identifying the paper's new
  contribution: the Adams-corrected determinant recovery of the constant
  from primitive-label fixed-Euler transforms and not from the periodic
  Artin logarithm.
\end{theorem}
...
\begin{proposition}[Adams correction to Frobenius-class Mertens products]
  ...
  have been separated, the following assertions hold.
