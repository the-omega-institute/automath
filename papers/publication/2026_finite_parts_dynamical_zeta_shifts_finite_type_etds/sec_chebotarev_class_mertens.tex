...
\begin{proposition}[Finite rational certificate for Perron recovery]
  ...
  \Cref{prop:fixed-label-perron-finite-algorithm} is certified by the following
  printed finite data.  A certificate consists only of finite algebraic model
  data and rational inequalities of the following four kinds:
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
