...
\begin{theorem}[Main Theorem III: Adams-corrected Frobenius-class
  ...
  and its exponential is taken in the ordinary positive real branch.  The
...
\begin{proposition}[Adams correction to Frobenius-class Mertens products]
  ...
  \begin{enumerate}[label=\textup{(\roman*)}]
    ...
    constant.
    \item The same separation calibrates the retained theorem packages
...
\begin{proof}
  ...
  cited theorem packages; their statements show respectively that they are
  ...
  non-Artin product constant.  This proves the theorem-package comparison and
...
\begin{proposition}[Finite algorithm for fixed-label Perron evaluation]
  ...
  \begin{enumerate}[label=\textup{(\alph*)},leftmargin=*]
    ...
    \item For each \(m\ge1\), compute the Adams coefficients
      ...
      \end{equation}
      by the finite character-table inner product.
