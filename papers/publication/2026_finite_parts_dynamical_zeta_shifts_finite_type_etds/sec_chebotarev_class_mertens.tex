...
\begin{theorem}[Finite-determinant recovery of Adams-corrected constants]
  ...
  \end{equation}
  Conversely, after the scalar value \(\alpha_A\) is fixed, these identities
...
\begin{proof}
  ...
  The same orthogonality proves the converse classification.  If
  \(H\in\mathcal H_G\), then the product of the entries in
  ...
  inverse by direct substitution.  Fourier inversion on the orthogonal
  complement of the trivial character gives
