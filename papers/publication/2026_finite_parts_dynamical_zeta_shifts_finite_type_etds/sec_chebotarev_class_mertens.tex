...
\Cref{prop:finite-data-main-chain-closure,rem:assembled-recovery-dependency-order,cor:main-iii-refinement-roadmap}
record the finite determinant dependence, recovery order, and downstream status
of the product-constant refinements for the three main theorems.  These are
...
\begin{corollary}[Roadmap status of product-constant refinements]
  \label{cor:main-iii-refinement-roadmap}
  ...
  \Cref{cor:assembled-adams-frobenius-product-formula}, the minimal skeleton
  of \Cref{cor:class-product-minimal-obstruction-skeleton}, and the Parseval
  ...
  the scalar-normalised product skeleton, or equality of the positive product
...
\begin{proof}
  ...
  For the skeleton statement, set
  ...
  that already determined vector.  These verifications use no determinant
  channel, asymptotic input, or product constant beyond those in Main
  Theorem~III, proving the roadmap claim.
\end{proof}
...
\begin{corollary}[Organisational fixed-coordinate skeleton subordinate to Main Theorem III]
  ...
  is an organisational skeleton subordinate to Main Theorem~III and to the
  Adams-obstruction theorem: it identifies the smallest fixed-coordinate chart
  in which the already-proved scalar-normalised product constants can be
  compared.  It is not a minimality statement for arbitrary observation
  systems, for all cocycles, for unnormalised determinant data, or for any
  theorem chain independent of Main Theorem~III.  Let
...
\begin{proposition}[Finite determinant-to-product certificate]
  ...
  The displayed label
  \verb|prop:fixed-label-perron-finite-algorithm| is the reader-facing label
  for this proposition.  The additional theorem, proposition, and corollary
  labels above are compatibility aliases retained for earlier internal cross
  references to the same certificate interface; they do not mark separate
...
\begin{proposition}[Finite rational certificate record]
...
\begin{corollary}[Five-field finite certificate schema]
...
\begin{proof}
  ...
  finite arithmetic transcripts for the same five fields.  The
