...
formula, and \(K_C\)-formula are assembled as the single proof path
\Cref{prop:main-iii-fixed-label-proof-spine}.  The determinant formula and
...
\begin{proposition}[Three-step proof spine for Main Theorem III]
  ...
  following three-step chain, and each arrow is reversible once the scalar
  ...
  determinant Perron formula, and \(K_C\)-formula are one theorem chain rather
  than three independent computational layers.
\end{proposition}
...
\begin{proof}
  ...
  the constants from that vector.  This proves the claimed closed proof spine.
\end{proof}
...
\noindent\textit{Appendix-level certificate records.}
  The protocol-level rational certificate record and five-field schema are
