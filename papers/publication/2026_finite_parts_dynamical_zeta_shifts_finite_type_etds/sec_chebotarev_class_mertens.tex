...
\begin{theorem}[Assembled Adams-corrected Frobenius-class zeta-product
  package]
  ...
  Frobenius-class zeta-product formulation in the introduction.
\end{theorem}

\begin{proof}
  \Cref{thm:class-euler-product-mertens} gives the positive constants
  \(K_C\) and the formula
  \[
    K_C=
    \exp\!\left(
  ...
  equivalences and the advertised assembly of the theorem package.
\end{proof}
