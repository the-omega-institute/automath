...
\Cref{prop:fixed-label-certificate-protocol,thm:class-product-comparison} then separates the certified finite
...
\begin{proof}
  ...
  \Cref{lem:class-euler-product-tail-budget} is uniform over the finite set of
...
\begin{proposition}[Finite certificate protocol for Perron readout]
  \label{prop:fixed-label-certificate-protocol}
  ...
  additional hypothesis: it is an optional
...
\begin{corollary}[Finite bookkeeping schema for the fixed-label Perron readout]
  ...
  \Cref{prop:fixed-label-certificate-protocol}, the preceding
  ...
  \Cref{prop:fixed-label-certificate-protocol} determines the five
...
\begin{proof}
  ...
  \Cref{prop:fixed-label-certificate-protocol}, put the base matrix,
  ...
  of \Cref{prop:fixed-label-certificate-protocol}: finite character
...
\begin{corollary}[Main-theorem status of the obstruction refinements]
  ...
  Theorem~III rather than independent members of its statement.
\end{corollary}
...
\begin{corollary}[Determinant coordinates after scalar normalisation]
  ...
  coordinates read from the finite determinant data.  No cocycle-level
  ...
  \[
    ...
    \qquad(\varrho\ne\mathbf1).
  \]
  Consequently the finite twisted determinant data, with the branch
...
\begin{proof}
  ...
  coordinates from the finite twisted determinant data in the stated
  logarithm branches.  Thus the determinant data determine a unique
