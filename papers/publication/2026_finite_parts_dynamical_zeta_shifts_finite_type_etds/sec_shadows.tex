...
\Cref{sec:finite-part}. None of these quotient-shadow results supplies a
new product constant; they read out and test the constants already fixed
by the main theorem spine.
...
\begin{proposition}[Canonical cyclic-lift root-of-unity layer and gap
  ...
  theorem and not a descent invariant across presentations or resolutions.
