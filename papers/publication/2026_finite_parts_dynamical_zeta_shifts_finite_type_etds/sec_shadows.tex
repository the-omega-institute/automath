...
\begin{proposition}[Primitive channels for the \(S_3\)-example]
  ...
  \end{equation}
  and the certified non-zero window is recorded in
...
\begin{proof}
  ...
  \eqref{eq:s3-example-pi-eps-value}. The certified non-zero interval
  is established in \Cref{lem:s3-example-perron-certificates}.
  ...
  value in \eqref{eq:s3-example-pi-rho-value}. The certified non-zero
  interval is established in \Cref{lem:s3-example-perron-certificates}.
\end{proof}
...
\begin{proof}
  Appendix~\ref{app:s3-log-certificates} proves the sharper rational
  bounds
  \[
