...
sums the resulting rational intervals. The exact row-by-row enclosures
for \(\log q\) and \(c\log q\) are printed in
...
\begin{proof}
  ...
  are listed in the term ledger above. The exact rational intervals
  used here are printed in \Cref{app:s3-log-certificates}. Summing the
  displayed weighted bounds there yields the following finite-sum and
  total certificates.
  \begin{center}
  \small
