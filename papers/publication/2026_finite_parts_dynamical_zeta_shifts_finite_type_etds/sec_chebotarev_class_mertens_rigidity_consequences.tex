...
branch-compatible fixed-label coordinates are determined by the Adams-corrected
positive class constants and record the finite-rank obstruction when too few
class coordinates are observed.  These are finite Fourier consequences inside
the scalar-normalised product-coordinate chart, not inverse spectral theorems
and not classification statements for extensions or cocycles.
...
\begin{remark}[Theorem-by-theorem comparison calibration]
  ...
  The proposition-style label is retained only for compatibility with earlier
  cross-references; the statement is a comparison remark.
