...
\begin{corollary}[Finite-rank lower bound from partial class data]
  ...
  is a rank lower bound inside the scalar-normalised, branch-compatible
  ...
  concrete ambiguity family: for every non-zero \(V\in\ker R\), the whole affine
