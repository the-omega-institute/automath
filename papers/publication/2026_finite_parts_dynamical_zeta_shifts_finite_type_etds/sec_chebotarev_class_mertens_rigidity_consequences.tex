...
\begin{theorem}[Rank-sharp obstruction skeleton for partial class data]
  ...
  theorem classifies the worst possible obstruction to recovering the
  scalar-normalised class-product vector from partial fixed-coordinate data
  inside the branch-compatible determinant-coordinate chart used in Main
  Theorem~III and in the Adams-obstruction theorem.  It compares only
