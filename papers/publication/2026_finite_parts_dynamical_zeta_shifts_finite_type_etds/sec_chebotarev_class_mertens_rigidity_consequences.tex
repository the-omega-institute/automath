...
\begin{proposition}[Adams correction to Frobenius-class Mertens products]
  ...
  Frobenius-class Mertens asymptotic itself as new.  If the cited homogeneous
  extension convention records the return element by the opposite action, this
  identification replaces \(C\) by \(C^{-1}\); the class size and classical
  product layer are unchanged, and the Hermitian coefficient
  \(\chi_\varrho^\ast(C)\) fixes the orientation of the internal determinant
  constant.  The finite-state assertion of this
