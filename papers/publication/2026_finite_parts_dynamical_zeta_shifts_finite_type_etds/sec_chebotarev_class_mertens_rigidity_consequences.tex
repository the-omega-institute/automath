...
\begin{proposition}[Adams correction to Frobenius-class Mertens products]
  ...
  base constant have been separated.  The asymptotic shape
  \(P_C(N)=K_CN^{-|C|/|G|}(1+O(N^{-1}))\), the leading exponent
  \(|C|/|G|\), and the existence of a Frobenius-class product constant are the
  classical layer
  calibrated by
  \cite{Sharp1991Mertens,ParryPollicott1986Chebotarev,NooraniParry1992ChebotarevShifts,MeslizaNoorani1999FrobeniusMertens};
  they are not asserted here as new.  The finite-state assertion of this
...
\begin{proof}
  ...
  of the product theorem.  The exponent and product scale are those already
  stated in \Cref{thm:class-euler-product-mertens} and compared with the cited
  Frobenius-class Mertens literature immediately before the proposition.  No
  step in the proof reclaims that classical layer.  What remains to prove is
