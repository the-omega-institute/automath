...
\begin{theorem}[Line-field rigidity at the Perron boundary]
  ...
  theorem is a conditional boundary criterion for the fixed finite-state cocycle just
...
\begin{proposition}[Finite-state role of the eta-gap hypothesis]
  ...
  in the paper, exactly the following conditional criterion and no stronger
  ...
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
    ...
    \item The only structural sufficient conditions for the strict inequality
      ...
      \(\eta<\lambda\) for general cocycle classes is not part of this article.
  \end{enumerate}
\end{proposition}
