...
\begin{proposition}[Conditional scope of the eta-gap input]
  \label{prop:eta-gap-conditional-scope}
  The eta-gap results in this section are equivalent, for the finite edge
  cocycle fixed in the paper, to the following conditional interface and to no
  stronger structural criterion.
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
...
\begin{proof}
  ...
  boundary-obstruction eliminations as sufficient conditions.  This proves
  (iii).
\end{proof}
...
\begin{remark}[Strict-gap criteria split]
  ...
  finite line-field test and provide only the verification interface needed for
  ...
  chain.  A general theory of structural criteria for strict twisted spectral
  gaps is therefore left as a separate problem.
\end{remark}
