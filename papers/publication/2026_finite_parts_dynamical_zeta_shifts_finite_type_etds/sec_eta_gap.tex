...
\begin{corollary}[Line fields are the only Perron-boundary obstruction]
  ...
  they eliminate every possible boundary line field.
\end{corollary}
...
\begin{proof}
  ...
  precisely in the first alternative.  The displayed line-field equations are
  the only obstruction data exported from this section to the product-constant
  theorem chain.
\end{proof}
