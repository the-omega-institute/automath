...
\begin{theorem}[Line-field rigidity at the Perron boundary]
  ...
  condition on a variable cocycle beyond the stated finite equations.
\end{theorem}
...
\begin{corollary}[Line fields are the only Perron-boundary obstruction]
  ...
  section are criterion-level consequences of the boundary alternative.  They are
...
\begin{remark}[Strict-gap criteria boundary]
  ...
  \(\eta<\lambda\).  A general theory of structural criteria for strict
  twisted spectral gaps is therefore not part of the present theorem chain.
\end{remark}
