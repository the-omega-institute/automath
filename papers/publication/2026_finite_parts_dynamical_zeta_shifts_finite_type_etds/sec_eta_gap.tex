...
\begin{remark}[Strict-gap criteria split]
  ...
  Main Theorems~II--III.  We do not attempt here to classify broad
  structural hypotheses on the cocycle \(\tau\) which force
  \(\eta<\lambda\).  Such criteria would require a separate analysis of
  loop-label subgroups, holonomy obstructions, and one-dimensional
  coboundary equations, and are left outside the present finite-determinant
