...
\begin{corollary}[Finite-state eta-gap gate for the main constants]
  ...
  classes are therefore split material, except for the explicit line-field
  exclusions proved in this section.
\end{corollary}
...
\begin{proof}
  ...
  then obstructed.  The final split-scope sentence follows because
