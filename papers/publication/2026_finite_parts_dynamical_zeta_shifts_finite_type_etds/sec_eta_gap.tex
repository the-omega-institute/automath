...
\begin{proposition}[Fixed-cocycle scope of the eta-gap certificate]
  ...
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
    ...
    \item The only structural sufficient conditions for the strict inequality
      proved here are fixed-cocycle eliminations of the classified boundary
      line fields, such as the loop-character obstruction and the
      perfect-loop-group consequence.  A broad sufficient-condition theory
      forcing \(\eta<\lambda\) for general cocycle classes is not part of
      this article.
  \end{enumerate}
\end{proposition}
