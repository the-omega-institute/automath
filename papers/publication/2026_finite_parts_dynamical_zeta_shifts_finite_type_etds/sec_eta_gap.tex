...
\begin{proposition}[Finite-state diagnostic certificate for the Perron-point
  ...
  \item The Perron-circle certificate returns \(\mathsf{Pass}\).  This
    certificate is stated first in the integral skew-product model.  It
    ...
    of the primary pass certificate.
  \end{enumerate}
...
\begin{proof}
  ...
  inclusion and rank/eigenspace tests exactly.  This optional refinement is
