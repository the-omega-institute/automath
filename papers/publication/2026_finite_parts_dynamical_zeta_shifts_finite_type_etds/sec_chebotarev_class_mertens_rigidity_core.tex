...
block identifies the finite coordinates those constants determine.  With the
scalar baseline fixed, the theorem below is the determinant-coordinate form of
Main Theorem~III: it identifies the zero-mean class vector with the
non-trivial fixed-label coordinates, gives the inverse readout formula, and
describes the finite coordinate fibre of the positive product vector.  The
supporting corollaries remain consequences inside this fixed coordinate chart,
not additional main theorems or new hypotheses for the class-product asymptotic.
