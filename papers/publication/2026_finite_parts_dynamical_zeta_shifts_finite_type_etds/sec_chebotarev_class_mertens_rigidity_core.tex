...
After the product-tail reduction has produced the constants \(K_C\), this
block explains exactly what information those constants contain.  The theorem
below is the branch-compatible finite determinant-coordinate form of Main
Theorem~III after the scalar baseline has been fixed: it identifies the
zero-mean class vector with the non-trivial fixed-label coordinates, gives
the inverse readout formula, and classifies the finite coordinate fibre of the
positive product vector.  The supporting corollaries that follow are
finite-dimensional consequences of this theorem in the same fixed coordinate
chart; they are recorded for normalisation and reproducibility, not as
additional main theorems, universal observation-system minimality statements,
or new hypotheses for the class-product asymptotic.
