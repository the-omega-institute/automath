...
\Cref{prop:eta-gap-finite-state-certificate}.  A fourth is to sharpen
lower-order spectral tails; the present manuscript retains only the
finite-tail non-interference firewall
...
The explicit \(S_3\) calculation in this paper should be read only as a finite
