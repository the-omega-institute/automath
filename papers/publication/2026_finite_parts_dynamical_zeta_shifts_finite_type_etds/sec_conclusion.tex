...
used or partially proved here.  The scalar cyclic-lift appendices should
...
The retained secondary spectral-edge tail refinement in
\Cref{sec:secondary-term} is conditional finite-state support after those
constants have been fixed, not a second proof spine for the main theorem
chain.  Finally, the explicit \(S_3\) certificate is a witness for the Adams
