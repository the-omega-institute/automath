...
secondary spectral-tail refinements, finite-observation inverse problems,
address-semantics refinements, and universality-style families of examples.
The arguments above use only the finite interfaces proved in this article: the
eta-gap criterion, the finite-tail non-interference
