...
secondary spectral-edge asymptotics beyond the conditional appendix package
\Cref{sec:secondary-term}, whose non-interference with the main constants is
recorded in
\Cref{prop:main-chain-secondary-noninterference,cor:secondary-package-closure}.
