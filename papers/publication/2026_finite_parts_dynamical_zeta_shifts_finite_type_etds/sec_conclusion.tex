...
\Cref{prop:eta-gap-finite-state-certificate}.  A fourth is to develop the
  secondary spectral-edge asymptotics split out from this article.  The present
  manuscript retains only the finite tail-comparison firewall
  \Cref{prop:main-chain-secondary-noninterference}; it does not import the edge
  skeleton, isolation, or dominant-modulus detection theorem package.  The
  scalar cyclic-lift
