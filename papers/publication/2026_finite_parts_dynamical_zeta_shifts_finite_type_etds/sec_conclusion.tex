...
likewise be read only as finite-state comparison material around the constants
  already established in Main Theorems~I--III.  The retained secondary
  spectral-edge tail refinement in \Cref{sec:secondary-term} is conditional
  finite-state support after those constants have been fixed, not a second
  proof spine for the main theorem chain.
