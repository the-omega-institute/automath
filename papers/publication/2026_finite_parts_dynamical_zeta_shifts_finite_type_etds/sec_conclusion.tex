...
the cyclic-lift recovery and scalar certificate packages have been split out as
fixed-matrix companion material, while the scalar constant \(C(A)\), the finite
