...
The scalar cyclic-lift appendices should be read only as finite-state
comparison material around the constants already established in Main
Theorems~I--III, not as a non-abelian root-of-unity sampling theory, a
positive cross-resolution descent theorem, or a standalone reduced-spectrum
inverse problem.  The secondary spectral-edge tail refinement in
\Cref{sec:secondary-term} is conditional support after those constants have
been fixed, not a second proof of Main Theorems~I--III.  The explicit \(S_3\)
certificate is a witness for the Adams correction in this determinant model;
no general finite-group certificate taxonomy is claimed in this article.
