...
The certificate policy in this article is to keep only the rational windows
needed for the theorem statement in the main text, while retaining the
exhaustive finite rational arithmetic in the appendices for reproducibility.
No step of Main Theorems~I--III depends on those appendix certificates; they
certify the single displayed non-abelian witness.  For readability, the finite
verification chain is as follows.  The finite model,
