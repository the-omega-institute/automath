...
Verification files &
The three submitted ancillary files listed in
\Cref{app:s3-log-certificates}. &
The script recomputes the determinant logarithm brackets, finite truncations,
and rational tail comparisons used in
\Cref{lem:appendix-s3-sharp-certificates,lem:appendix-s3-f-level-certificates};
the certificate file records the resulting rational endpoints and
``verified'' checks, and the run file records the exact command used to
generate it.\\
\bottomrule
\end{tabular}
\end{center}
