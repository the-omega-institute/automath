...
abelian/cyclic support boundary.  Its purpose is not to develop a certificate theory,
...
For reference, the finite verification used here is the following exact
record.  The base is the full two-shift
...
Verification files &
The paper-local Python verification script and its printed certificate in the
