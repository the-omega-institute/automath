...
\begin{lemma}[Main-text ledger of imported \(S_3\) certificates]
  \label{lem:s3-main-text-certificate-ledger}
...
\begin{proof}
  By \Cref{lem:s3-main-text-certificate-ledger}, every numerical interval
...
\begin{proposition}[Two-coordinate closure of the certified \(S_3\)
  ...
  two-coordinate Peter--Weyl spine
  \begin{equation}\label{eq:s3-product-obstruction-spine}
    H(C)=\chi_\varepsilon(C)F_\varepsilon(1/2)
      +\chi_\rho(C)F_\rho(1/2),
  \end{equation}
...
\begin{proof}
  ...
  this proves \eqref{eq:s3-product-obstruction-spine}.  The certified
  ...
  \eqref{eq:s3-product-obstruction-spine}; there is no further irreducible
