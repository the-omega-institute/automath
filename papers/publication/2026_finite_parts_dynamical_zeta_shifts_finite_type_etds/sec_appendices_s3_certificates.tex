...
\begin{remark}[Ancillary exact-arithmetic transcript]
  ...
  comparisons.  The optional ancillary files with basename
  \texttt{s3\_log\_certificates} serialize the same rational transcript: the
  logarithm brackets, signed coefficients, four tail bounds, and final
  cleared-denominator comparisons.  They are reproducibility aids for readers
  who want to rerun the finite arithmetic, not additional mathematical inputs
  for the appendix; the proof above is self-contained from the displayed
  rational data.
\end{remark}
