...
\begin{proof}
  ...
  rational numbers. The following exact rational comparison, obtained by
  simplifying the displayed \(L_3/U_3\) expressions, is enough for the
  coarse windows. The certificate script prints the bit-exact
  numerators and denominators:
  \[
  \begin{array}{c|c}
    \text{endpoint} & \text{certified decimal enclosure} \\
    \hline
    E_7^- & -0.341079<E_7^-<-0.341078 \\
    E_7^+ & -0.341072<E_7^+<-0.341071 \\
    R_{15}^- & -0.718352<R_{15}^-<-0.718351 \\
    R_{15}^+ & -0.718352<R_{15}^+<-0.718351
  \end{array}
  \]
  Hence
