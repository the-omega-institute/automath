...
\begin{proof}
  ...
  are an exact rational interval certificate. Expanding them gives
  numerator--denominator pairs for the endpoints; the accompanying
  paper-local script
  \texttt{certificates/s3\_log\_certificates.py} prints those full
  fractions and verifies the following rational comparisons using
  integer arithmetic:
  Hence
