...
eeq2^{-31}\), their absolute value is at
  ...
  \[
  \begin{aligned}
    Q_8^- &:=-\frac12U_3(2)-\frac14U_3(4/3)
      -\frac18U_3(128/127)-\frac1{16}U_3(32768/32767),\\
    Q_8^+ &:=-\frac12L_3(2)-\frac14L_3(4/3)
  ...
  \]
  Clearing denominators in these rational expressions gives
  \[
  ...
  logarithms in \(S_{32}\) gives rational endpoints \(S_{32}^-<S_{32}<S_{32}^+\)
  and hence
  \[
    S_{32}^- -B_\rho < F_\rho(1/2)<S_{32}^+ +B_\rho.
  \]
  Clearing denominators in the displayed rational expressions gives
  \[
