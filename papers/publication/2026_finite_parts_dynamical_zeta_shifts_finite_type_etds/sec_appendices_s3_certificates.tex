...
\begin{proposition}[Exact machine-readable artifact for the \(S_3\)
  certificates]
  ...
  \]
  is a finite exact-arithmetic serialization of
  ...
  \begin{enumerate}[label=\textup{(\roman*)},leftmargin=*]
    ...
    \item verify the rational inclusions
      ...
      denominators.
  \end{enumerate}
  Therefore the printed \(S_3\) obstruction is reproducible as a finite
...
\begin{proof}
  ...
  machine-readable serialization of the appendix proof and, by
  \Cref{prop:fixed-label-certificate-artifact-interface}, of the finite
  Perron-readout certificate used by the class-product obstruction.
\end{proof}
