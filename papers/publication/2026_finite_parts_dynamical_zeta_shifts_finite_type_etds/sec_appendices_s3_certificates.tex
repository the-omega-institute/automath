...
\begin{remark}[Finite exact-arithmetic check]
  \label{rem:s3-certificate-artifact-interface}
  ...
  comparisons.  These are finite operations over rational intervals; the proof
  above is self-contained from the displayed rational data, and those printed
  rational inequalities are the complete proof artifact.

  The ancillary exact-arithmetic mirror used to generate and check the printed
  entries is the following stable file set in \path{certificates/}; it is a
  reproducibility aid and not an additional mathematical hypothesis:
  \begin{enumerate}[label=\textup{(\alph*)},leftmargin=*]
    \item \path{s3_log_certificates.py}.
      \begin{quote}\footnotesize
      SHA--256:
      \texttt{301737d892108d115f6f70128d03ebf6}\par
      \texttt{291f9e91d5811306e7d8a49f915d510c}.
      \end{quote}
    \item \path{s3_log_certificates.cert}.
      \begin{quote}\footnotesize
      SHA--256:
      \texttt{22c4a0f015f8c579680b87b378bfac19}\par
      \texttt{351ca66421c3988a025fea9b433cff62}.
      \end{quote}
    \item \path{s3_log_certificates.out}.
      \begin{quote}\footnotesize
      SHA--256:
      \texttt{ecc2f9b589781195417952602cf782a2}\par
      \texttt{09db513b3c3012df2603a3c736a5e18b}.
      \end{quote}
    \item \path{s3_log_certificates.run.txt}.
      \begin{quote}\footnotesize
      SHA--256:
      \texttt{f4f7ce4bb0d3265d4ce4e38b50fa03aa}\par
      \texttt{03ab73bf87cbab6cabd90efb54ecafa1}.
      \end{quote}
  \end{enumerate}
\end{remark}
