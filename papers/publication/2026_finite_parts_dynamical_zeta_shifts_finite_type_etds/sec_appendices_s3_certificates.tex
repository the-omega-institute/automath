...
\begin{proof}
  ...
  below.  No decimal approximation is used.  A script or machine-readable
  certificate may reproduce the same arithmetic as supplementary material,
  but the proof in the submitted source depends only on the displayed
  rational endpoints, coefficients, and inequalities.
