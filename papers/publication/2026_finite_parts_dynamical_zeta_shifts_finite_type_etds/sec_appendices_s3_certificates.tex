...
\begin{remark}[Exact-arithmetic reproducibility]
  ...
  certificate, output, and run note.  Running
  \texttt{python certificates/s3\_log\_certificates.py} recomputes the rational
  interval comparisons and terminates with the message that the fixed-label
  windows have been verified.  The stored certificate file records every
