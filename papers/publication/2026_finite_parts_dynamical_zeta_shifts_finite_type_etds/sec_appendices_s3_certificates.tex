...
general finite-verification theory for arbitrary finite groups.  For
reproducibility, every rational truncation, tail estimate, and interval
enclosure used by the example is displayed here, while the main text cites only
the coarse windows.
