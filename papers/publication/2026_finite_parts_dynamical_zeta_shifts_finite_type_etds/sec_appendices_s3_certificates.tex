...
\begin{remark}[Exact-arithmetic reproducibility]
  ...
  optional serializations of this exact-arithmetic transcript, including the
  script, certificate, output, and run note.  They are not additional
  mathematical inputs for the appendix, and none of the inequalities above
  depends on independently validating those external serializations.
\end{remark}
