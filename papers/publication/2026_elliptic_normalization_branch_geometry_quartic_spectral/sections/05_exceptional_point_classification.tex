...
Corollary~\ref{cor:real-phase-diagram} retains the component source of the calculation.  Thus each clause of Theorem~B follows from the fixed-member criterion applied to the canonical member and the finite canonical comparison supplied by Corollary~\ref{cor:quartic-real-projection-framework}.
\end{proof}
