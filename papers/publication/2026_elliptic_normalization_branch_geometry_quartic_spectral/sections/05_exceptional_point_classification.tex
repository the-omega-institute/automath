...
\]
Theorem~\ref{thm:theorem-b-real-projection-criterion} is then obtained from the fixed-member criterion by adding the two-to-one covering count on the interiors of these two intervals; dominance is handled separately in Theorem~\ref{thm:canonical-branch-dominance}.
\end{proposition}
