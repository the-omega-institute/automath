...
\endgroup
\end{center}
Consequently Theorem~\ref{thm:theorem-b-real-projection-criterion} is obtained from the fixed-member criterion by this finite skeleton alone: no parameter-space chamber comparison and no additional dominance assertion enter the proof of Theorem~B.
\end{proposition}
...
Thus the compact and noncompact component images are exactly \([y_{\mathrm{sub}},1]\) and \([0,\infty)\), with overlap because \(1>0\).
