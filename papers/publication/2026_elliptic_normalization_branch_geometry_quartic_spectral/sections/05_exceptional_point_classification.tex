...
\end{enumerate}
This is the canonical specialization of the reusable fixed-member criterion in Theorem~\ref{thm:balanced-real-projection}; no recurrence-theoretic or dominance input enters this package, and those inputs begin only with Theorem~\ref{thm:consolidated-branch-dominance-package}.
\end{theorem}
