...
\begin{theorem}[Canonical specialization of the fixed-member real-projection skeleton (Theorem B)]\label{thm:theorem-b-real-projection-package}
...
\begin{proof}
The first assertion is precisely the fixed-member skeleton of Theorem~\ref{thm:balanced-real-projection}, applied before specialization.
