...
\]
Then the real projection of the normalized canonical quartic is governed by the following finite criterion.
\begin{enumerate}
...
\]
\item Consequently the total real image is
\[
...
y(E_{\mathrm n}(\RR))=[0,\infty).
\]
Their union is \([y_{\mathrm{sub}},\infty)\), and their intersection is \([0,1]\), proving the asserted finite real-solvability criterion and the transition-value list.
