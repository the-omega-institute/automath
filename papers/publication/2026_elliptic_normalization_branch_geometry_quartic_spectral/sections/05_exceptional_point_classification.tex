...
The present paper does not derive such a model, so the comparison is only terminological: the point $y=0$ found here is a square-root endpoint of the maximal-modulus boundary for this quartic family, not a derived Yang--Lee edge in the original physical sense.
\end{remark}
