...
Proposition~\ref{prop:endpoint-puiseux} carries out this expansion via the equivalent parametrization $\lambda_{\mathrm{dom}}(y)$ and yields $A=1/\sqrt2$, $B=5/8$, $C=43/(64\sqrt2)$.
...
4AB-5A^3=0,
\]
hence \(A=1/\sqrt2\) and \(B=5/8\); the next coefficient comparison gives \(C=43/(64\sqrt2)\).
