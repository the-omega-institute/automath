...
This appendix verifies the hypotheses of Lemma~\ref{lem:two-branch-oscillation-law} for the quartic transfer family at the square-root endpoint $y_c=0$ and records the branch expansion predicted by Lemma~\ref{lem:generic-ep2-branching}.
Fix the disc
\[
