...
\begin{proposition}[Endpoint local input proposition]\label{prop:endpoint-expansion}
...
\]
uniformly for \(u\in K\).
These local expansions and the remainder estimate are precisely the proof inputs supplied to Proposition~\ref{prop:endpoint-cosine-hypotheses}; the compact-window cosine law and the endpoint zero quantization are proved later in Theorem~\ref{thm:endpoint-zero-quantization}.
\end{proposition}
