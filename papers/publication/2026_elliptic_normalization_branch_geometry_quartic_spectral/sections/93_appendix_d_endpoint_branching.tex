...
This appendix is a proof component for Theorem~\ref{thm:endpoint-zero-quantization}: Proposition~\ref{prop:endpoint-expansion-package} supplies the branch expansions, amplitudes, and compact-uniform remainder estimates used in Proposition~\ref{prop:endpoint-cosine-checklist}.
...
Since \(\lambda_c=1\), this is precisely the remainder estimate required by Lemma~\ref{lem:two-branch-oscillation-law}.
