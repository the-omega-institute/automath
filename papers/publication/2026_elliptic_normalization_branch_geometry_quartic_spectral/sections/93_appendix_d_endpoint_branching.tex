...
The coefficient comparisons below give the exact constants \(A=1/\sqrt2\), \(B=5/8\), \(A_*=1/2\), \(B_*=3\sqrt2/16\), and the compact-uniform estimate \(R_m(-u^2/m^2)=O_K(m^{-2})\) used in the endpoint zero theorem.
Fix the disc
\[
