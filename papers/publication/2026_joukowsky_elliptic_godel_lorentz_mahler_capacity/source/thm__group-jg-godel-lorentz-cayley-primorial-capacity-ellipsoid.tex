...
\begin{theorem}[A higher-dimensional ellipsoid functor for prime registers]\label{thm:godel-ellipsoid-volume}
...
\begin{proof}
The volume formula in Theorem \ref{thm:godel-ellipsoid-volume}, applied in the coordinate space of \(\operatorname{supp}(r_x)\), gives
\[
...
For the fixed ambient statement, Theorem \ref{thm:godel-ellipsoid-volume} gives
\[
