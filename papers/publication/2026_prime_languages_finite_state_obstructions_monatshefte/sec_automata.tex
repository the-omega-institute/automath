...
\begin{proof}
  ...
  harmless factor \(\tau_r^{-1}\) from one-step entrance terms. Since
  ...
  \[
    ...
    \qquad(m\ge N_r).
  \]
  The certificate records \(C_r,J_r,K_r,N_r,\tau_r,\theta_r\) and the
  explicit monotone-tail threshold. The finitely many powers in the
