...
\begin{proof}
  ...
  irreducible non-negative matrix of period \(d_N\), all sufficiently
  long paths in an admissible residue class occur between the same
  cyclic classes; equivalently, the corresponding block of
  \(B_N^{d_N}\) is primitive. Therefore
  \((B_N^{kd_N+r})_{q_N f}>0\) for all sufficiently large \(k\), and
  the limit
  \[
    (S_r)_{q_N f}
