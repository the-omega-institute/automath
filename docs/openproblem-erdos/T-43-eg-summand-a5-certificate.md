...
## Monitoring Update 2026-05-31 20:45 SGT — Primitive quartic K3 strict-zero obstruction

Oracle deep task `deep_problemsilike_02_t1780229601898` (2258 chars) provides
a source-backed exclusion of the primitive quartic K3 same-summand strict-zero
candidate.

Object: W = e_prim H^2_dR for the universal smooth quartic K3 family
(e_prim = hyperplane-orthogonal projector).

Argument: H^2_dR = L (+) W, where L = Q·h is the algebraic horizontal line
generated by the hyperplane class. p-curvature is functorial for horizontal
direct sums, and ψ_p(L) = 0 since L is generated by a global algebraic class.
If ψ_p(W) = 0 for almost all good primes, then ψ_p(H^2_dR) = 0 for the full
degree-2 Picard-Fuchs system at almost all good primes. Katz 1972 (Inv.Math.
18) then forces finite complex monodromy of the full system. But Beauville
1986 ("Le groupe de monodromie des familles universelles d'hypersurfaces et
d'intersections completes," Lecture Notes in Math 1194, pp. 8-18) computes
universal hypersurface family monodromy and gives the needed INFINITE
primitive monodromy for the quartic K3 case. Contradiction.

Conclusion: strict_zero_almost_all(W) = FALSE. The primitive quartic K3
summand is excluded as a strict-zero p-curvature candidate.

New source cite: Beauville 1986, Lecture Notes in Math 1194, pp. 8-18.

Status: this is a same-summand source obstruction (exclusion of one specific
route) complementing the prior T-43 closures (binary NEGATIVE memo + TERMINAL
artifact + verifier recipe). The T-43 outreach closure remains sealed at the
negative-boundary level.

Artifact: `tools/community-outreach/targets/problemsilike_02/deep_responses/oracle_T43_primitive_K3_strict_zero_obstruction_20260531_2030.md`.
