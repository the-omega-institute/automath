...
::: {.evidence}
**Lean:** [`topological_entropy_eq_log_phi`](https://github.com/the-omega-institute/automath/blob/dev/lean4/Omega/Folding/Entropy.lean#L265) — 熵结果，通过 Fibonacci 比率收敛、对数连续性和 Cesaro 平均证明
